...
public class EntityToxicCloud extends Entity {
   private static final DataParameter<Float> RADIUS = EntityDataManager.func_187226_a(EntityToxicCloud.class, DataSerializers.field_187193_c);
   private static final DataParameter<Float> HEIG = EntityDataManager.func_187226_a(EntityToxicCloud.class, DataSerializers.field_187193_c);
   private static final DataParameter<Byte> PART = EntityDataManager.func_187226_a(EntityToxicCloud.class, DataSerializers.field_187191_a);
   private static final DataParameter<Boolean> IGNORE_RADIUS = EntityDataManager.func_187226_a(EntityToxicCloud.class, DataSerializers.field_187198_h);
   private static final DataParameter<Integer> PARTICLE = EntityDataManager.func_187226_a(EntityToxicCloud.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> PARTICLE_PARAM_1 = EntityDataManager.func_187226_a(EntityToxicCloud.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> PARTICLE_PARAM_2 = EntityDataManager.func_187226_a(EntityToxicCloud.class, DataSerializers.field_187192_b);
   ...
   protected void func_70088_a() {
      this.func_184212_Q().func_187214_a(PART, (byte)0);
      this.func_184212_Q().func_187214_a(RADIUS, 0.5F);
      this.func_184212_Q().func_187214_a(HEIG, 0.5F);
      this.func_184212_Q().func_187214_a(IGNORE_RADIUS, Boolean.FALSE);
      this.func_184212_Q().func_187214_a(PARTICLE, EnumParticleTypes.SPELL_MOB.func_179348_c());
      this.func_184212_Q().func_187214_a(PARTICLE_PARAM_1, 0);
      this.func_184212_Q().func_187214_a(PARTICLE_PARAM_2, 0);
   }
   ...
   public void setRadius(float radiusIn, float heightIn) {
      ...
      if (!this.field_70170_p.field_72995_K) {
         ...
         this.func_184212_Q().func_187227_b(HEIG, heightIn);
      }
   }
   ...
   public float getHeight() {
      return (Float)this.func_184212_Q().func_187225_a(HEIG);
   }
   ...
   public void setColor(int colorIn) {
      this.func_184212_Q().func_187227_b(PART, (byte)colorIn);
   }

   public EnumParticleTypes getParticle() {
      return EnumParticleTypes.func_179342_a((Integer)this.func_184212_Q().func_187225_a(PARTICLE));
   }
   ...
   public void setParticleParam1(int particleParam) {
      this.func_184212_Q().func_187227_b(PARTICLE_PARAM_1, particleParam);
   }
   ...
   public void setParticleParam2(int particleParam) {
      this.func_184212_Q().func_187227_b(PARTICLE_PARAM_2, particleParam);
   }
            ...
            if (this.field_70146_Z.nextInt(3) != 0) {
               for (int i = 0; i < 2; i++) {
                  ...
                  if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
                     ...
                     this.field_70170_p
                        .func_190523_a(
                           EnumParticleTypes.SPELL_MOB.func_179348_c(),
                           this.field_70165_t + f3,
                           this.field_70163_u + this.field_70146_Z.nextFloat() * this.field_70131_O,
                           this.field_70161_v + f4,
                           k / 255.0F,
                           l / 255.0F,
                           i1 / 255.0F,
                           new int[0]
                     ...
                     this.field_70170_p
                        .func_190523_a(
                           enumparticletypes.func_179348_c(),
                           this.field_70165_t + f3,
                           this.field_70163_u + this.field_70146_Z.nextFloat() * this.field_70131_O,
                           this.field_70161_v + f4,
                           0.0,
            ...
            for (int k1 = 0; k1 < f5; k1++) {
               if (this.field_70146_Z.nextInt(3) == 0) {
                  ...
                  if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
                     ...
                     int j2 = l1 >> 8 & 0xFF;
                     int j1 = l1 & 0xFF;
                     double d11 = this.field_70165_t + f8 * 1.0;
                     double d22 = this.field_70163_u + this.field_70146_Z.nextFloat() * this.field_70131_O;
                     double d33 = this.field_70161_v + f9 * 1.0;
                     double d44 = i2 / 255.0F;
                     double d55 = j2 / 255.0F;
                     double d66 = j1 / 255.0F;
                     ...
                     this.field_70170_p
                        .func_190523_a(
                           enumparticletypes.func_179348_c(),
                           this.field_70165_t + f8,
                           this.field_70163_u + this.field_70146_Z.nextFloat() * this.field_70131_O,
                           this.field_70161_v + f9,
            ...
            for (PotionEffect potioneffect1 : this.potion.func_185170_a()) {
               potions.add(
                  new PotionEffect(
                     ...
                     potioneffect1.func_76458_c(),
                     potioneffect1.func_82720_e(),
                     potioneffect1.func_188418_e()
                  )
               );
            }
            ...
            if (potions.isEmpty()) {
               ...
               if (!list.isEmpty()) {
                  for (EntityLivingBase entitylivingbase : list) {
                     ...
                     if (!pb && !this.reapplicationDelayMap.containsKey(entitylivingbase) && entitylivingbase.func_184603_cC()) {
                        ...
                        if (d2 <= f * f) {
                           this.reapplicationDelayMap.put(entitylivingbase, this.field_70173_aa + this.reapplicationDelay);

                           for (PotionEffect potioneffect : potions) {
                              if (potioneffect.func_188419_a().func_76403_b()) {
                                 potioneffect.func_188419_a().func_180793_a(this, this.getOwner(), entitylivingbase, potioneffect.func_76458_c(), 0.5);
                              } else {
                                 SRPPotions.applyStackPotion(
                                    potioneffect.func_188419_a(), entitylivingbase, potioneffect.func_76459_b(), potioneffect.func_76458_c()
                                 );
                              }
                           }
   ...
   protected void func_70014_b(NBTTagCompound compound) {
      ...
      if (!this.effects.isEmpty()) {
         ...
         compound.func_74782_a("Effects", nbttaglist);
      }
   }
