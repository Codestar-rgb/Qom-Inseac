...
public class EntityRemain extends Entity {
      ...
      if (!this.field_70170_p.field_72995_K) {
         if (this.field_70173_aa % 20 == 0) {
            ...
            if (!this.getActive()
               ...
               && SRPSaveData.get(this.field_70170_p, 50).getCurrentCode(this.field_70170_p.field_73011_w.getDimension(), 20) >= 1) {
         ...
         if (this.active) {
            this.count = this.count + this.plus;
            if (this.count > this.goal) {
               ...
               EntityParasiteBase out = (EntityParasiteBase)EntityList.func_188429_b(new ResourceLocation(this.parasite), this.field_70170_p);
               if (out == null) {
                  return;
               }

               if (!out.field_70170_p.func_184144_a(out, out.func_174813_aQ()).isEmpty()) {
                  out.func_70106_y();
                  return;
               }
               ...
               this.field_70170_p.func_184133_a(null, this.func_180425_c(), SRPSounds.RESURRECT, SoundCategory.HOSTILE, 1.0F, 1.0F);
   ...
   public void spawnParticles(SRPEnumParticle particleType, int r, int g, int b) {
      ...
      ParticleSpawner.spawnParticle(
         ...
         this.field_70163_u + 0.5 + this.field_70146_Z.nextFloat() * (this.field_70131_O + 0.5),
