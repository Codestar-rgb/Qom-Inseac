...
EntityCanFly {
    ...
    public EntityAlafha(World worldIn) {
        ...
        if (SRPConfigMobs.alafhaMaxY != 256) {
            this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIFlightLimits(this, SRPConfigMobs.alafhaMaxY, true));
        }
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(5, (EntityAIBase)new EntityAIAirVomitSummon(this, SRPConfigMobs.alafhaSummoningCooldown, SRPConfigMobs.alafhaLimit, SRPConfigMobs.alafhaMobList));
