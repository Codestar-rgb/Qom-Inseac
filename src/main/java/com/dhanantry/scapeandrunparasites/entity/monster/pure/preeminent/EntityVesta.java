...
implements EntityBodyParts {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIGiveEffectsArea(this, SRPAttributes.VESTA_CD, SRPAttributes.VESTA_RANGE, SRPConfigMobs.vestaeffects));
    }
    ...
    public void func_70636_d() {
        ...
        if (this.srpTicks == 25) {
            ...
            for (EntityParasiteBase mob : moblist) {
                SRPPotions.applyStackPotion(SRPPotions.LINK_E, (EntityLivingBase)mob, 6666, 0);
                SRPPotions.applyStackPotion(SRPPotions.FOSTER_E, (EntityLivingBase)mob, 6666, 0);
            }
        }
    }
