...
public class EntityKirin extends EntityPDerived {
   ...
   private static final DataParameter<BlockPos> BLINK_POS = EntityDataManager.func_187226_a(EntityKirin.class, DataSerializers.field_187200_j);
   private static final DataParameter<Integer> BLINK_TICKS = EntityDataManager.func_187226_a(EntityKirin.class, DataSerializers.field_187192_b);
   private int limit;
   private int border;
   ...
   public EntityKirin(World worldIn) {
      super(worldIn);
      this.func_70105_a(2.1271334F, 8.85F);
      this.field_70138_W = 1.0F;
      this.field_70714_bg.func_85156_a(this.folow);
      this.voidCoolTotal = 5;
      this.voidCool = this.voidCoolTotal;
   }

   @Override
   protected void func_70088_a() {
      super.func_70088_a();
      this.field_70180_af.func_187214_a(BLINK_POS, BlockPos.field_177992_a);
      this.field_70180_af.func_187214_a(BLINK_TICKS, 0);
   }
   ...
   public void setBlinkCharge(BlockPos pos, int ticks) {
      ...
      this.field_70180_af.func_187227_b(BLINK_POS, pos);
      this.field_70180_af.func_187227_b(BLINK_TICKS, Math.max(0, ticks));
   }

   public void clearBlinkCharge() {
      this.field_70180_af.func_187227_b(BLINK_POS, BlockPos.field_177992_a);
      this.field_70180_af.func_187227_b(BLINK_TICKS, 0);
   }

   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.KIRIN_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.KIRIN_HURT;
   }
   ...
   public void func_70071_h_() {
      ...
      if (this.field_70170_p.field_72995_K) {
         int ticks = (Integer)this.field_70180_af.func_187225_a(BLINK_TICKS);
         if (ticks > 0) {
            BlockPos p = (BlockPos)this.field_70180_af.func_187225_a(BLINK_POS);
            if (p != null && !Objects.equals(p, BlockPos.field_177992_a)) {
               float t = 1.0F - ticks / 60.0F;
               double y = p.func_177956_o() + 1.5 + t;
               double cx = p.func_177958_n() + 0.5;
               double cz = p.func_177952_p() + 0.5;
               float sizeBig = 6.0F;
               float sizeSmall = 5.5F;
               double base = 0.35;
               double accel = 1.25;
               double spd = base + t * accel;
               float angSmall = (float)(this.field_70173_aa * spd % (Math.PI * 2));
               float angBig = (float)(this.field_70173_aa * -spd % (Math.PI * 2));
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(2, new EntityAIKirinBlink(this));
      this.field_70714_bg.func_75776_a(3, new EntityAIAttackMeleeStatus(this, 1.0, true, 0.0));
      this.field_70714_bg.func_75776_a(2, new EntityAISkill(this, 80, 35, true, 1));
   }
   ...
   private void summon() {
      ...
      if (this.field_70173_aa % 20 == 0) {
         ...
         if (this.border == 3) {
            ...
            double off = 10.0;
            orb.field_70163_u = orb.field_70163_u + (this.field_70131_O + off);
            orb.offsetOrb = off;
            this.field_70170_p.func_72838_d(orb);
            this.func_184185_a(
               SRPSounds.KIRIN_SHOOT, this.func_70599_aP() * 2.0F, (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2F + 1.0F
            );
         }
   ...
   private void updateFloating() {
      ...
      this.floatBob++;
      double bob = Math.sin((this.field_70173_aa + this.floatBob) * 0.12) * 0.06;
      ...
      for (int i = 0; i <= 24; i++) {
         ...
         if (this.field_70170_p.func_180495_p(p).func_185917_h()) {
            ground = p;
            break;
         }
      }
      ...
      if (ground == null) {
         ...
         this.noGroundTicks = 0;
         double targetY = ground.func_177956_o() + 1.0 + 0.35 + bob;
