...
implements EntityCanPullMobs {
            ...
            if (this.func_70638_az() != null) {
                if (!this.func_70638_az().func_70089_S()) {
                    ...
                    if (this.srpTicks == 10 && this.func_70638_az() instanceof EntityPlayerMP) {
                        SRPNetwork.CHANNEL.sendTo((IMessage)new MsgQlipShake(250, 0, true, false, 4.0f), (EntityPlayerMP)this.func_70638_az());
                    }
                    ++this.pulling;
                    if (this.pulling > 400) {
                        this.setTargetedEntity(0);
    ...
    protected SoundEvent func_184639_G() {
        ...
        return SRPSounds.ARANRAC_GROWL;
    }
