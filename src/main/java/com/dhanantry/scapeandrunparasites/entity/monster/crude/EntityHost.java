...
EntityCutomAttack {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAISkill(this, 40, (int)SRPConfig.primitiveFollow, 2, false, 1, true));
    }
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K && this.srpTicks == 10 && this.killcount > (double)SRPConfigMobs.hostHerd && ParasiteEventEntity.canSpawnNext) {
    ...
    public void func_70074_a(EntityLivingBase entityLivingIn) {
        ...
        if (!this.field_70170_p.field_72995_K && this.killcount > (double)SRPConfigMobs.hostHerd && !this.field_70128_L && ParasiteEventEntity.canSpawnNext) {
            ParasiteEventEntity.spawnNext(this, new EntityHostII(this.field_70170_p), true, true);
        }
    }
