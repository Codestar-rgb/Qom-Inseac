...
implements EntityCanShoot {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIAncientSummon(this, 20 * SRPConfigMobs.oroncoPodCooldown, SRPConfigMobs.oroncoPodNumber, new String[]{"srparasites:ancientpod;1;1"}));
