...
public class EntityWymo extends EntityPPrimitive implements EntityCanHaveBodies, EntityCutomAttack {
   ...
   private boolean up;
   private static final DataParameter<Byte> PART = EntityDataManager.func_187226_a(EntityWymo.class, DataSerializers.field_187191_a);
   private static final DataParameter<Boolean> TAIL = EntityDataManager.func_187226_a(EntityWymo.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> DIG = EntityDataManager.func_187226_a(EntityWymo.class, DataSerializers.field_187198_h);
   ...
   protected void func_184651_r() {
      this.field_70714_bg.func_75776_a(1, new EntityAIFollowBodies(this, 1.7F, 0.26, 10, SRPConfig.adaptedKills, 200));
      this.field_70715_bh.func_75776_a(2, new EntityAIHurtByTarget(this, true, new Class[0]));
      this.field_70714_bg.func_75776_a(0, new EntityAISwimming(this));
      this.field_70714_bg.func_75776_a(3, new EntityAIAttackMeleeStatusAOE(this, 1.3, false, 0.0, 3.0));
   }
   ...
   public void setDigging(boolean in) {
      if (in) {
         this.func_184185_a(SRPSounds.WYMO_DIG, 2.0F, this.func_70647_i());
      }
