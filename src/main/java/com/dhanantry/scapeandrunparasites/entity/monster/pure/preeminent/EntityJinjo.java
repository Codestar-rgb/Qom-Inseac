...
public class EntityJinjo extends EntityPPreeminent implements EntityCanFly {
   protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityJinjo.class, DataSerializers.field_187191_a);

   public EntityJinjo(World worldIn) {
      super(worldIn);
      this.field_70765_h = new EntityJinjo.AIMoveControl(this);
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(4, new EntityJinjo.AIChargeAttack());
      this.field_70714_bg.func_75776_a(6, new EntityJinjo.AIMoveRandom());
      this.field_70714_bg.func_75776_a(5, new EntityJinjo.AIBomb(this));
      this.field_70714_bg.func_75776_a(8, new EntityAILookIdle(this));
      this.field_70714_bg.func_75776_a(4, new EntityAIFlightLimits(this, 10, false));
   }

   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.JINJO_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.JINJO_HURT;
   }
   ...
   protected SoundEvent func_184615_bR() {
      return SRPSounds.JINJO_DEATH;
   }

   protected void func_110147_ax() {
      super.func_110147_ax();
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.JINJO_HEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SRPAttributes.JINJO_ARMOR);
      this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SRPAttributes.JINJO_KD_RESISTANCE);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.JINJO_ATTACK_DAMAGE);
   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (this.srpTicks == 10 && this.field_70146_Z.nextInt(7) == 0) {
   ...
   class AIBomb extends EntityAIBase {
      ...
      public void func_75246_d() {
         EntityBomb out = new EntityBomb(this.parent.field_70170_p, this.parent, SRPConfigMobs.jinjoGriefing);
         if (this.parent.func_70638_az() != null) {
            boolean flag = this.parent.func_70685_l(this.parent.func_70638_az()) || this.parent.field_70170_p.field_73012_v.nextInt(3) == 0;
            out.func_82149_j(this.parent);
            out.setFuse(80);
            out.setStren(flag ? 4.0F : 8.0F);
            out.setSkin(flag ? 2 : 3);
            out.setDamage((float)this.parent.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111126_e() * SRPConfigMobs.jinjoExplotionMult, 7);
   ...
   class AIChargeAttack extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         return EntityJinjo.this.func_70638_az() != null && EntityJinjo.this.field_70146_Z.nextInt(5) == 0
            ? EntityJinjo.this.func_70068_e(EntityJinjo.this.func_70638_az()) > 4.0
            : false;
      }

      public boolean func_75253_b() {
         return EntityJinjo.this.func_70605_aq().func_75640_a()
            && EntityJinjo.this.isCharging()
            && EntityJinjo.this.func_70638_az() != null
            && EntityJinjo.this.func_70638_az().func_70089_S();
      }
      ...
      public void func_75246_d() {
         ...
         if (entitylivingbase != null && entitylivingbase.func_70089_S()) {
            if (EntityJinjo.this.func_174813_aQ().func_72326_a(entitylivingbase.func_174813_aQ())) {
               EntityJinjo.this.func_70652_k(entitylivingbase);
               EntityJinjo.this.setCharging(false);
            } else {
               double d0 = EntityJinjo.this.func_70068_e(entitylivingbase);
               if (d0 < 9.0) {
                  Vec3d vec3d = entitylivingbase.func_174824_e(1.0F);
   ...
   class AIMoveControl extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         if (this.field_188491_h == Action.MOVE_TO) {
            ...
            if (d3 < EntityJinjo.this.func_174813_aQ().func_72320_b()) {
               ...
               EntityJinjo.this.field_70159_w = EntityJinjo.this.field_70159_w + d0 / d3 * 0.05 * this.field_75645_e;
               EntityJinjo.this.field_70181_x = EntityJinjo.this.field_70181_x + d1 / d3 * 0.05 * this.field_75645_e;
               EntityJinjo.this.field_70179_y = EntityJinjo.this.field_70179_y + d2 / d3 * 0.05 * this.field_75645_e;
               if (EntityJinjo.this.func_70638_az() == null) {
                  EntityJinjo.this.field_70177_z = -((float)MathHelper.func_181159_b(EntityJinjo.this.field_70159_w, EntityJinjo.this.field_70179_y))
                     * (180.0F / (float)Math.PI);
                  EntityJinjo.this.field_70761_aq = EntityJinjo.this.field_70177_z;
               } else {
                  ...
                  EntityJinjo.this.field_70177_z = -((float)MathHelper.func_181159_b(d4, d5)) * (180.0F / (float)Math.PI);
                  EntityJinjo.this.field_70761_aq = EntityJinjo.this.field_70177_z;
               }
            }
         }
   ...
   class AIMoveRandom extends EntityAIBase {
      ...
      public void func_75246_d() {
         BlockPos blockpos = new BlockPos(EntityJinjo.this);
         byte flag = 1;
         double speed = 0.1;
         if (EntityJinjo.this.func_70638_az() != null) {
            if (EntityJinjo.this.func_70068_e(EntityJinjo.this.func_70638_az()) > 100.0) {
               blockpos = new BlockPos(EntityJinjo.this.func_70638_az());
               flag = 2;
               speed += 0.05;
            } else if (EntityJinjo.this.func_70068_e(EntityJinjo.this.func_70638_az()) < 36.0) {
               blockpos = new BlockPos(EntityJinjo.this.func_70638_az());
               flag = 3;
               speed += 0.05;
            }
         ...
         for (int i = 0; i < 3; i++) {
            BlockPos blockpos1 = blockpos.func_177982_a(
               EntityJinjo.this.field_70146_Z.nextInt(15) - 7, EntityJinjo.this.field_70146_Z.nextInt(11) - 5, EntityJinjo.this.field_70146_Z.nextInt(15) - 7
            );
            if (flag == 2) {
               blockpos1 = blockpos.func_177982_a(
                  EntityJinjo.this.field_70146_Z.nextInt(6) - 2, EntityJinjo.this.field_70146_Z.nextInt(7) - 2, EntityJinjo.this.field_70146_Z.nextInt(6) - 2
               );
            } else if (flag == 3) {
               blockpos1 = blockpos.func_177982_a(
                  EntityJinjo.this.field_70146_Z.nextInt(4) + 3, EntityJinjo.this.field_70146_Z.nextInt(5) + 4, EntityJinjo.this.field_70146_Z.nextInt(4) + 3
               );
            }

            if (EntityJinjo.this.field_70170_p.func_175623_d(blockpos1)) {
               EntityJinjo.this.field_70765_h
                  .func_75642_a(blockpos1.func_177958_n() + 0.5, blockpos1.func_177956_o() + 1.0, blockpos1.func_177952_p() + 0.5, speed);
               if (EntityJinjo.this.func_70638_az() == null) {
                  EntityJinjo.this.func_70671_ap()
