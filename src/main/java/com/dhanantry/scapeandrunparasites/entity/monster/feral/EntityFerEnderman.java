...
public class EntityFerEnderman extends EntityPFeral {
   ...
   private static final AttributeModifier ATTACKING_SPEED_BOOST = new AttributeModifier(ATTACKING_SPEED_BOOST_ID, "Attacking speed boost", 0.15F, 0)
      .func_111168_a(false);
   private static final DataParameter<Boolean> SCREAMING = EntityDataManager.func_187226_a(EntityFerEnderman.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> CRAWLING = EntityDataManager.func_187226_a(EntityFerEnderman.class, DataSerializers.field_187198_h);
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.FERENDERMAN_HEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SRPAttributes.FERENDERMAN_ARMOR);
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.330000011920929);
      this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SRPAttributes.FERENDERMAN_KD_RESISTANCE);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.FERENDERMAN_ATTACK_DAMAGE);
   ...
   public void func_70636_d() {
      ...
      if (this.field_70170_p.field_72995_K) {
         ...
         && this.func_70068_e(this.func_70638_az()) > Math.pow(SRPAttributes.FERENDERMAN_TP_DIST / 2.0, 2.0)
         && this.field_70146_Z.nextInt(SRPConfigMobs.feralendermantelefreq) == 0
         && !this.teleportAllies()) {
      ...
      if (this.ally <= 0 && SRPConfigMobs.feralendermanteleally && this.toTeleCool <= 0 && this.spotCool <= 0) {
         ...
         if (target == null) {
            ...
            if (this.func_70644_a(SRPPotions.RAGE_E)) {
               for (EntityPAdapted mob : this.field_70170_p.func_72872_a(EntityPAdapted.class, axisalignedbb)) {
                  if (mob.func_70638_az() == null && !(mob.func_110143_aJ() - SRPConfigMobs.feralendermanTeleDamage < 2.0F) && this.teleportToEntity(mob, 1.0)) {
            ...
            for (EntityPPrimitive mobx : this.field_70170_p.func_72872_a(EntityPPrimitive.class, axisalignedbb)) {
               if (mobx.func_70638_az() == null && !(mobx.func_110143_aJ() - SRPConfigMobs.feralendermanTeleDamage < 2.0F) && this.teleportToEntity(mobx, 1.0)) {
                  this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
                  this.toTele = mobx;
                  this.setWorkTask(false);
                  this.ally = 1;
            ...
            for (EntityPFeral mobxx : this.field_70170_p.func_72872_a(EntityPFeral.class, axisalignedbb)) {
               if (mobxx.func_70638_az() == null
                  && !(mobxx.func_110143_aJ() - SRPConfigMobs.feralendermanTeleDamage < 2.0F)
                  && this.teleportToEntity(mobxx, 1.0)) {
                  this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
                  this.toTele = mobxx;
                  this.setWorkTask(false);
                  this.ally = 1;
            ...
            for (EntityPInfected mobxxx : this.field_70170_p.func_72872_a(EntityPInfected.class, axisalignedbb)) {
               if (mobxxx.func_70638_az() == null
                  && mobxxx.getParasiteType() <= 15
                  && (!(mobxxx instanceof EntityCanMelt) || !((EntityCanMelt)mobxxx).isMelting())
                  && !(mobxxx.func_110143_aJ() - SRPConfigMobs.feralendermanTeleDamage < 2.0F)
                  && this.teleportToEntity(mobxxx, 1.0)) {
                  this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
                  this.toTele = mobxxx;
                  this.setWorkTask(false);
                  this.ally = 1;
            ...
            for (EntityParasiteBase mobxxxx : this.field_70170_p.func_72872_a(EntityParasiteBase.class, axisalignedbb)) {
               if (mobxxxx instanceof EntityMudo
                  && mobxxxx.func_70638_az() == null
                  && !(mobxxxx.func_110143_aJ() - SRPConfigMobs.feralendermanTeleDamage < 2.0F)
                  && this.teleportToEntity(mobxxxx, 1.0)) {
                  this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
                  this.toTele = mobxxxx;
                  this.setWorkTask(false);
                  this.ally = 1;
         ...
         if (this.toTele != null) {
            ...
            if (flag1) {
               ...
               if (this.toTele.getParasiteIDRegister() != 59 && this.toTele.getParasiteIDRegister() != 69) {
                  this.toTele.func_70097_a(DamageSource.field_76379_h, SRPConfigMobs.feralendermanTeleDamage);
               }
   ...
   protected boolean teleportRandomly() {
      if (this.spotCool > 0) {
         ...
         return this.func_70638_az() != null && this.func_70638_az().func_70011_f(d0, d1, d2) < Math.pow(SRPAttributes.INFENDERMAN_TP_DIST, 2.0)
            ? false
   ...
   public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
      ...
      if (this.func_180431_b(source)) {
         ...
         if (source.func_76363_c() && this.field_70146_Z.nextInt(SRPConfigMobs.feralendermantelefreq) == 0 && !this.teleportAllies()) {
            this.teleportRandomly();
         }
   ...
   public boolean func_70652_k(@Nonnull Entity entityIn) {
      ...
      if (flag && this.field_70146_Z.nextInt(SRPConfigMobs.feralendermantelefreq) == 0 && !this.teleportAllies()) {
         this.teleportRandomly();
      }
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.INFECTEDENDERMAN_GROWL;
   }
