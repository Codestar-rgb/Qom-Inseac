...
public class EntityBano extends EntityPPrimitive {
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(3, new EntityAIGiveEffectsArea(this, SRPAttributes.ZETMO_CD, SRPAttributes.ZETMO_RANGE, SRPConfigMobs.zetmoEffects));
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.ZETMO_HEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SRPAttributes.ZETMO_ARMOR);
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.19);
      this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SRPAttributes.ZETMO_KD_RESISTANCE);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.ZETMO_ATTACK_DAMAGE);
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.ZETMO_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.ZETMO_HURT;
   }

   protected SoundEvent func_184615_bR() {
      return SRPSounds.ZETMO_DEATH;
   }
   ...
   static class AITentaclePull extends EntityAIBase {
      ...
      public void func_75246_d() {
         if (this.parentEntity.func_70638_az() == null) {
            ...
            if (entitylivingbase.func_70068_e(this.parentEntity) < 169.0 && this.parentEntity.func_70685_l(entitylivingbase)) {
               this.parentEntity.setParasiteStatus(15);
               if (entitylivingbase.func_70068_e(this.parentEntity) < 64.0
                  && entitylivingbase.func_70068_e(this.parentEntity) > 4.0
