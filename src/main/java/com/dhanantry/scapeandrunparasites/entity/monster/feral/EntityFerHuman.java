...
public class EntityFerHuman extends EntityPFeral {
   public EntityFerHuman(World worldIn) {
      super(worldIn);
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.FERHUMAN_HEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SRPAttributes.FERHUMAN_ARMOR);
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.260000004172325);
      this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SRPAttributes.FERHUMAN_KD_RESISTANCE);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.FERHUMAN_ATTACK_DAMAGE);
