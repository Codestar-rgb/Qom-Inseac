...
public class EntityWaveShock extends EntityParasiteBase {
   private int raaa;
            ...
            for (int i = 0; i < 35; i++) {
               this.field_70170_p
                  .func_175688_a(
                     ...
                     this.field_70165_t + this.field_70146_Z.nextFloat() * (this.field_70130_N * 1.2) * 2.0 - this.field_70130_N * 1.2,
                     this.field_70163_u,
                     this.field_70161_v + this.field_70146_Z.nextFloat() * (this.field_70130_N * 1.2) * 2.0 - this.field_70130_N * 1.2,
                     this.field_70146_Z.nextGaussian() * 0.02,
                     this.field_70146_Z.nextGaussian() + 140.0,
                     this.field_70146_Z.nextGaussian() * 0.02,
                     new int[]{id}
                  );
            }
