...
public class EntityIki extends EntityPPrimitive implements EntityCanShoot, EntityCanFly {
   private EntityHitbox back;
   protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityIki.class, DataSerializers.field_187191_a);
   private int count;

   public EntityIki(World worldIn) {
      super(worldIn);
      this.field_70765_h = new EntityIki.AIMoveControl(this);
      ...
      this.back = new EntityHitbox(this, -1.6F, 1.2F, -0.2F, 1.6F, 1.6F, 0.5F);
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.IKI_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.IKI_HURT;
   }
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(4, new EntityIki.AIChargeAttack());
      this.field_70714_bg.func_75776_a(5, new EntityIki.AIBomb(this));
      this.field_70714_bg.func_75776_a(7, new EntityIki.AIMoveRandom());
   }

   protected void func_110147_ax() {
      super.func_110147_ax();
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.IKI_HEALTH);
   ...
   class AIBomb extends EntityAIBase {
      ...
      public void func_75246_d() {
         ...
         for (int x = 0; x < serverList.size(); x++) {
            if (serverList.get(x) instanceof EntityAta) {
               count++;
            }
         }
   ...
   class AIChargeAttack extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         return EntityIki.this.func_70638_az() != null && EntityIki.this.field_70146_Z.nextInt(5) == 0
            ? EntityIki.this.func_70068_e(EntityIki.this.func_70638_az()) > 4.0
            : false;
      }

      public boolean func_75253_b() {
         return EntityIki.this.func_70605_aq().func_75640_a()
            && EntityIki.this.isCharging()
            && EntityIki.this.func_70638_az() != null
            && EntityIki.this.func_70638_az().func_70089_S();
      }
      ...
      public void func_75246_d() {
         ...
         if (entitylivingbase != null && entitylivingbase.func_70089_S()) {
            if (EntityIki.this.func_174813_aQ().func_72326_a(entitylivingbase.func_174813_aQ())) {
               EntityIki.this.func_70652_k(entitylivingbase);
               EntityIki.this.setCharging(false);
            } else {
               double d0 = EntityIki.this.func_70068_e(entitylivingbase);
               if (d0 < 9.0) {
                  Vec3d vec3d = entitylivingbase.func_174824_e(1.0F);
   ...
   class AIMoveControl extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         if (this.field_188491_h == Action.MOVE_TO) {
            ...
            if (d3 < EntityIki.this.func_174813_aQ().func_72320_b()) {
               ...
               EntityIki.this.field_70159_w = EntityIki.this.field_70159_w + d0 / d3 * 0.05 * this.field_75645_e;
               EntityIki.this.field_70181_x = EntityIki.this.field_70181_x + d1 / d3 * 0.05 * this.field_75645_e;
               EntityIki.this.field_70179_y = EntityIki.this.field_70179_y + d2 / d3 * 0.05 * this.field_75645_e;
               if (EntityIki.this.func_70638_az() == null) {
                  EntityIki.this.field_70177_z = -((float)MathHelper.func_181159_b(EntityIki.this.field_70159_w, EntityIki.this.field_70179_y))
                     * (180.0F / (float)Math.PI);
                  EntityIki.this.field_70761_aq = EntityIki.this.field_70177_z;
               } else {
                  ...
                  EntityIki.this.field_70177_z = -((float)MathHelper.func_181159_b(d4, d5)) * (180.0F / (float)Math.PI);
                  EntityIki.this.field_70761_aq = EntityIki.this.field_70177_z;
               }
            }
         }
   ...
   class AIMoveRandom extends EntityAIBase {
      ...
      public void func_75246_d() {
         BlockPos blockpos = new BlockPos(EntityIki.this);
         byte flag = 1;
         double speed = 0.5;
         if (EntityIki.this.func_70638_az() != null) {
            if (EntityIki.this.func_70068_e(EntityIki.this.func_70638_az()) > 100.0) {
               blockpos = new BlockPos(EntityIki.this.func_70638_az());
               flag = 2;
               speed += 0.25;
            } else if (EntityIki.this.func_70068_e(EntityIki.this.func_70638_az()) < 36.0) {
               blockpos = new BlockPos(EntityIki.this.func_70638_az());
               flag = 3;
               speed += 0.25;
            }
         ...
         for (int i = 0; i < 3; i++) {
            BlockPos blockpos1 = blockpos.func_177982_a(
               EntityIki.this.field_70146_Z.nextInt(15) - 7, EntityIki.this.field_70146_Z.nextInt(11) - 5, EntityIki.this.field_70146_Z.nextInt(15) - 7
            );
            if (flag == 2) {
               blockpos1 = blockpos.func_177982_a(
                  EntityIki.this.field_70146_Z.nextInt(6) - 2, EntityIki.this.field_70146_Z.nextInt(7) - 2, EntityIki.this.field_70146_Z.nextInt(6) - 2
               );
            } else if (flag == 3) {
               blockpos1 = blockpos.func_177982_a(
                  EntityIki.this.field_70146_Z.nextInt(4) + 3, EntityIki.this.field_70146_Z.nextInt(5) + 4, EntityIki.this.field_70146_Z.nextInt(4) + 3
               );
            }

            if (EntityIki.this.field_70170_p.func_175623_d(blockpos1)) {
               EntityIki.this.field_70765_h
                  .func_75642_a(blockpos1.func_177958_n() + 0.5, blockpos1.func_177956_o() + 0.5, blockpos1.func_177952_p() + 0.5, speed);
               if (EntityIki.this.func_70638_az() == null) {
                  EntityIki.this.func_70671_ap()
