...
public class EntityInfPig extends EntityPInfected implements EntityCanMelt {
   private static final DataParameter<Float> HEIGH = EntityDataManager.func_187226_a(EntityInfPig.class, DataSerializers.field_187193_c);
   private static final DataParameter<Boolean> MELTING = EntityDataManager.func_187226_a(EntityInfPig.class, DataSerializers.field_187198_h);
   private float aSize;
   private int sound;
   ...
   public int canSpawnByIDData() {
      return SRPConfigMobs.infpigCanSpawnAssimilatedNat;
   }
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.INFPIG_HEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SRPAttributes.INFPIG_ARMOR);
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.25);
      this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SRPAttributes.INFPIG_KD_RESISTANCE);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.INFPIG_ATTACK_DAMAGE);
   ...
   protected void func_70609_aI() {
      ...
      if (this.field_70725_aQ == 20 && !this.field_70170_p.field_72995_K && this.field_70146_Z.nextDouble() <= SRPAttributes.INFPIG_HEADCHANCE) {
         ParasiteSummon.spawnM(this, new String[]{"srparasites:sim_pighead;1;1"}, 0, false, this.func_95999_t());
      }
   }
   ...
   public void melt() {
      this.setWait(1000);
      this.field_70180_af.func_187227_b(HEIGH, 0.9F);
   ...
   public void melting() {
      if (this.isMelting()) {
         ...
         if (!this.field_70170_p.field_72995_K) {
            if (this.getTHeigh() <= 0.7 || this.sound >= 25) {
               ...
               out.setLegs(SRPAttributes.INFPIG_V, false);
            }
         } else {
   ...
   protected void selfExplode() {
      super.selfExplode();
      ParasiteSummon.spawnM(this, new String[]{SRPConfigMobs.infpigmob}, 0, false, this.func_95999_t());
   }
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.INFECTEDPIG_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return SRPSounds.INFECTEDPIG_HURT;
   }

   protected SoundEvent func_184615_bR() {
      return SRPSounds.INFECTEDPIG_DEATH;
   }
