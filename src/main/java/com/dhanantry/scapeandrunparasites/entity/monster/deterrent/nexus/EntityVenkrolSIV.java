...
implements EntityBodyParts {
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (SRPConfigWorld.venkrolTornadoEnabled && this.field_70170_p.func_72896_J() && this.field_70170_p.func_72911_I() && this.field_70170_p.func_175678_i(pos.func_177984_a())) {
