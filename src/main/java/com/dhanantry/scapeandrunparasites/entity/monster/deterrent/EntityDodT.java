   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (this.srpTicks == 10 && this.father != null && this.father.func_70638_az() != null) {
            this.lookAt(this.father.func_70638_az());
         }

         if (!this.up && this.field_70173_aa > 60 && !this.buried()) {
            if (this.paraToRelo != null) {
               EntityParasiteBase entityout = (EntityParasiteBase)EntityList.func_188429_b(new ResourceLocation(this.paraToRelo), this.field_70170_p);
               if (entityout != null) {
