...
public class EntityInfVillagerHead extends EntityPInfected {
   public EntityInfVillagerHead(World worldIn) {
      super(worldIn);
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(5, new EntityAIAvoidEntityStatus(this, EntityLivingBase.class, new Predicate<EntityLivingBase>() {
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.INFVILLAGER_HEADHEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.3);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.INFVILLAGER_HEADDAMAGE);
   }
   ...
   public boolean func_70652_k(@Nonnull Entity entityIn) {
      if (entityIn instanceof EntityInhooM && entityIn.func_70089_S() && this.func_70089_S()) {
         ParasiteEventEntity.spawnNext(this, new EntityInfVillager(this.field_70170_p), true, false);
