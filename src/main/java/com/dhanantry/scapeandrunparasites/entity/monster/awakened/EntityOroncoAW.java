...
public class EntityOroncoAW extends EntityPAncient {
   private static final DataParameter<Boolean> URTEN = EntityDataManager.func_187226_a(EntityOroncoAW.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> ULTEN = EntityDataManager.func_187226_a(EntityOroncoAW.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> RATEN = EntityDataManager.func_187226_a(EntityOroncoAW.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> LATEN = EntityDataManager.func_187226_a(EntityOroncoAW.class, DataSerializers.field_187198_h);
   protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityOroncoAW.class, DataSerializers.field_187191_a);
   ...
   public EntityOroncoAW(World worldIn) {
      ...
      this.field_70765_h = new EntityOroncoAW.AIMoveControl(this);
   ...
   protected void func_184651_r() {
      this.field_70714_bg.func_75776_a(2, new EntityOroncoAW.AIMoveRandom());
   ...
   class AIMoveControl extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         if (this.field_188491_h == Action.MOVE_TO) {
            ...
            if (d3 < EntityOroncoAW.this.func_174813_aQ().func_72320_b()) {
               ...
               EntityOroncoAW.this.field_70159_w = EntityOroncoAW.this.field_70159_w + d0 / d3 * 0.05 * this.field_75645_e;
               EntityOroncoAW.this.field_70181_x = EntityOroncoAW.this.field_70181_x + d1 / d3 * 0.05 * this.field_75645_e;
               EntityOroncoAW.this.field_70179_y = EntityOroncoAW.this.field_70179_y + d2 / d3 * 0.05 * this.field_75645_e;
               if (EntityOroncoAW.this.func_70638_az() == null) {
                  EntityOroncoAW.this.field_70177_z = -((float)MathHelper.func_181159_b(EntityOroncoAW.this.field_70159_w, EntityOroncoAW.this.field_70179_y))
                     * (180.0F / (float)Math.PI);
                  EntityOroncoAW.this.field_70761_aq = EntityOroncoAW.this.field_70177_z;
               } else {
                  ...
                  EntityOroncoAW.this.field_70177_z = -((float)MathHelper.func_181159_b(d4, d5)) * (180.0F / (float)Math.PI);
                  EntityOroncoAW.this.field_70761_aq = EntityOroncoAW.this.field_70177_z;
               }
            }
         }
   ...
   class AIMoveRandom extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         ...
         if (!entitymovehelper.func_75640_a()) {
            ...
            double d1 = entitymovehelper.func_179919_e() - EntityOroncoAW.this.field_70163_u;
            double d2 = entitymovehelper.func_179918_f() - EntityOroncoAW.this.field_70161_v;
            double d3 = d0 * d0 + d1 * d1 + d2 * d2;
      ...
      public void func_75246_d() {
         if (EntityOroncoAW.this.func_70638_az() != null) {
            BlockPos blockpos = new BlockPos(EntityOroncoAW.this);
            byte flag = 1;
            double speed = 0.3;
            if (EntityOroncoAW.this.func_70068_e(EntityOroncoAW.this.func_70638_az()) > 400.0) {
               blockpos = new BlockPos(EntityOroncoAW.this.func_70638_az());
               flag = 2;
               speed += 0.1;
            } else if (EntityOroncoAW.this.func_70068_e(EntityOroncoAW.this.func_70638_az()) < 100.0) {
               blockpos = new BlockPos(EntityOroncoAW.this.func_70638_az());
               flag = 3;
               speed += 0.15;
            }
            ...
            for (int i = 0; i < 3; i++) {
               BlockPos blockpos1 = blockpos.func_177982_a(
                  EntityOroncoAW.this.field_70146_Z.nextInt(15) - 7,
                  EntityOroncoAW.this.field_70146_Z.nextInt(11) - 5,
                  EntityOroncoAW.this.field_70146_Z.nextInt(15) - 7
               );
               if (flag == 2) {
                  blockpos1 = blockpos.func_177982_a(
                     EntityOroncoAW.this.field_70146_Z.nextInt(12) - 2,
                     EntityOroncoAW.this.field_70146_Z.nextInt(10) - 2,
                     EntityOroncoAW.this.field_70146_Z.nextInt(12) - 2
                  );
               } else if (flag == 3) {
                  blockpos1 = blockpos.func_177982_a(
                     EntityOroncoAW.this.field_70146_Z.nextInt(8) + 3,
                     EntityOroncoAW.this.field_70146_Z.nextInt(7) + 4,
                     EntityOroncoAW.this.field_70146_Z.nextInt(8) + 3
                  );
               }

               if (EntityOroncoAW.this.field_70170_p.func_175623_d(blockpos1)) {
                  EntityOroncoAW.this.field_70765_h
                     .func_75642_a(blockpos1.func_177958_n() + 0.5, blockpos1.func_177956_o() + 0.5, blockpos1.func_177952_p() + 0.5, speed);
                  if (EntityOroncoAW.this.func_70638_az() == null) {
                     EntityOroncoAW.this.func_70671_ap()
            ...
            double d0 = EntityOroncoAW.this.field_70165_t + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
            double d1 = EntityOroncoAW.this.field_70163_u + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
            double d2 = EntityOroncoAW.this.field_70161_v + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
