...
public class EntityCanraAdapted extends EntityPAdapted implements EntityCanSummon, EntityBodyParts, IRangedAttackMob {
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(4, new EntityAIAttackRangedStatus(this, 1.0, 140, 9.0F, false));
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.CANRA_HEALTH + SRPAttributes.CANRA_A_HEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SRPAttributes.CANRA_ARMOR + SRPAttributes.CANRA_A_ARMOR);
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.29);
      this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SRPAttributes.CANRA_KD_RESISTANCE + SRPAttributes.CANRA_A_KD_RESISTANCE);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.CANRA_ATTACK_DAMAGE + SRPAttributes.CANRA_A_ATTACK_DAMAGE);
   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K && this.field_70146_Z.nextInt(2) == 0 && this.field_70173_aa % 60 == 0) {
         ...
         for (EntityRemain mob : this.field_70170_p.func_72872_a(EntityRemain.class, axisalignedbb)) {
            if (!mob.getActive()) {
         ...
         if (flag) {
            this.func_184185_a(SRPSounds.ACANRA_SPECIAL, 3.0F, 1.0F);
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.ACANRA_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.ACANRA_HURT;
   }
   ...
   public void func_82196_d(EntityLivingBase target, float distanceFactor) {
      ...
      entityareaeffectcloud.func_184496_a(new PotionEffect(SRPPotions.VIRA_E, 300, 40, false, true));
      ...
      entityareaeffectcloud.func_184496_a(new PotionEffect(SRPPotions.CORRO_E, 300, 40, false, true));
      ...
      if (this.field_70173_aa % 20 == 0) {
         ...
         if (this.field_70170_p.func_180495_p(this.func_180425_c()).func_177230_c() instanceof BlockLiquid) {
            ...
            if (this.getActualParasites() < this.getTotalParasites() && this.limit < SRPConfigMobs.canraadaptedlimit) {
               this.func_184185_a(SRPSounds.ACANRA_SPECIAL, 3.0F, 1.0F);
               if (ParasiteEventEntity.spawnBiomassFromVomit(this, SRPConfigMobs.canraadaptedmoblist, this.func_70638_az())) {
                  this.limit++;
                  this.border--;
                  this.particleStatus((byte)8);
               }
