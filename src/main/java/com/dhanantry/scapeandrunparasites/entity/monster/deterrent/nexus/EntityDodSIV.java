...
implements EntityBodyParts {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIAncientSummon(this, 120, 4, new String[]{"srparasites:ancientpod;1;1"}));
    }
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111128_a(SRPConfig.nexussivFollow * (double)SRPConfigMobs.dodsivFollowRangeMult);
    }
