...
public class EntityInfEnderman extends EntityPInfected {
   ...
   private static final DataParameter<Integer> TEXTURE_VARIANT = EntityDataManager.func_187226_a(EntityInfEnderman.class, DataSerializers.field_187192_b);
   private static final DataParameter<Boolean> ARIRAL = EntityDataManager.func_187226_a(EntityInfEnderman.class, DataSerializers.field_187198_h);
   ...
   public EntityInfEnderman(World worldIn) {
      ...
      this.head = new EntityHitbox(this, 0.0F, 0.0F, 2.3F, 0.6F, 0.6F, 1.25F);
   ...
   protected void func_70088_a() {
      super.func_70088_a();
      this.field_70180_af.func_187214_a(TEXTURE_VARIANT, 0);
      this.field_70180_af.func_187214_a(SCREAMING, false);
      this.field_70180_af.func_187214_a(CRAWLING, false);
      this.field_70180_af.func_187214_a(ARIRAL, false);
   }
   ...
   public void setTextureVariant(int variant) {
      this.field_70180_af.func_187227_b(TEXTURE_VARIANT, variant);
   }
   ...
   public void func_70636_d() {
      ...
      if (this.field_70170_p.field_72995_K) {
         ...
         if (this.func_70638_az() != null
            ...
            && this.func_70068_e(this.func_70638_az()) > Math.pow(SRPAttributes.INFENDERMAN_TP_DIST / 2.0, 2.0)
   ...
   public void updateHitboxes() {
      ...
      if (this.head != null) {
         ...
         this.head.func_70634_a(this.head.field_70165_t, this.head.field_70163_u - (isCrawling ? 1.625F : 0.0F), this.head.field_70161_v);
      }
   }
      ...
      if (this.ally <= 0 && SRPConfigMobs.infendermanteleally && this.toTeleCool <= 0 && this.spotCool <= 0) {
         ...
         if (target == null) {
            ...
            AxisAlignedBB axisalignedbb = new AxisAlignedBB(
               ...
               .func_186662_g(64.0);
            List<EntityPInfected> moblist = this.field_70170_p.func_72872_a(EntityPInfected.class, axisalignedbb);

            for (EntityPInfected mob : moblist) {
               if (mob != this
                  && mob.func_70638_az() == null
                  && mob.getParasiteType() <= 15
                  && (!(mob instanceof EntityCanMelt) || !((EntityCanMelt)mob).isMelting())
                  && !(mob.func_110143_aJ() - SRPConfigMobs.infendermanTeleDamage < 2.0F)
                  && this.teleportToEntity(mob, 1.0)) {
            ...
            for (EntityParasiteBase mobx : moblist) {
               if (mobx instanceof EntityMudo
                  && mobx.func_70638_az() == null
                  && !(mobx.func_110143_aJ() - SRPConfigMobs.infendermanTeleDamage < 2.0F)
   ...
   public void setCrawling(boolean in) {
      this.field_70180_af.func_187227_b(CRAWLING, in);
   }
   ...
   public void setAriral(boolean value) {
      this.field_70180_af.func_187227_b(ARIRAL, value);
   }
}
