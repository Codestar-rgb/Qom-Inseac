...
public class EntityCanra extends EntityPPrimitive implements EntityCanSummon, IRangedAttackMob {
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(2, new EntityAISkill(this, 20 * SRPConfigMobs.canraSummoningCooldown, 16, true, 1));
      this.field_70714_bg.func_75776_a(6, new EntityAIAttackMeleeRangeSwitch(this, 4.0F));
      this.field_70714_bg.func_75776_a(3, new EntityAIAttackMeleeStatus(this, 1.3, false, 8.0));
      this.field_70714_bg.func_75776_a(4, new EntityAIAttackRangedStatus(this, 1.0, 180, 8.0F, false));
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.CANRA_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.CANRA_HURT;
   }
   ...
   public void func_82196_d(EntityLivingBase target, float distanceFactor) {
      ...
      entityareaeffectcloud.func_184496_a(new PotionEffect(SRPPotions.CORRO_E, 300, 25, false, true));
