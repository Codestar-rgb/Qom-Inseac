...
public class EntityLesh extends EntityParasiteBase {
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(6, new EntityAIParasiteFollow(this, 1.3, 10.0, 2.0, false));
      this.field_70714_bg.func_75776_a(1, new EntityLesh.EntityAILeshCombine(this, 1.1));
   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K) {
         if (SRPConfigSystems.disloGiveBodies
            && this.func_70089_S()
            && this.srpTicks == 10
            && SRPSaveData.get(this.field_70170_p, 40).getCurrentCode(this.field_70170_p.field_73011_w.getDimension(), 20) >= 1) {
      ...
      if (!(entityIn instanceof EntityLesh)) {
         ...
         if (this.delay >= 3) {
            ...
            if (this.getaSize() >= meh.getaSize()) {
               ...
               this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(this.tSpeed);
   ...
   private boolean merge(EntityParasiteBase entityin, int code, String name) {
      if (SRPConfigSystems.mergeRandom) {
         ...
         for (int limit = 0; flag; index++) {
            ...
            if (SRPConfigSystems.mergeMobTable[index] != null) {
               ...
               if (SRPConfigSystems.useEvolution) {
                  ...
                  SRPSaveData.get(entityin.field_70170_p, 100)
                     .setTotalKills(entityin.field_70170_p.field_73011_w.getDimension(), SRPConfigSystems.valueMerge, true, entityin.field_70170_p, true, 40);
               }
         ...
         for (int i = 0; i < SRPConfigSystems.mergeMobTable.length; i++) {
            if (SRPConfigSystems.mergeMobTable[i] != null) {
               String[] entityC = SRPConfigSystems.mergeMobTable[i].split(";");
               int points = Integer.parseInt(entityC[1]);
               if (points == code) {
                  ParasiteSummon.spawnM(entityin, new String[]{entityC[0] + ";1;1"}, 7, true, name);
                  if (SRPConfigSystems.useEvolution) {
                     SRPSaveData.get(entityin.field_70170_p, 96)
                        .setTotalKills(entityin.field_70170_p.field_73011_w.getDimension(), SRPConfigSystems.valueMerge, true, entityin.field_70170_p, true, 41);
                  }
         ...
         for (int limit = 0; flag; index++) {
            ...
            if (SRPConfigSystems.mergeMobTable[index] != null) {
               ...
               flag = false;
               if (SRPConfigSystems.useEvolution) {
                  SRPSaveData.get(entityin.field_70170_p, 95)
                     .setTotalKills(entityin.field_70170_p.field_73011_w.getDimension(), SRPConfigSystems.valueMerge, true, entityin.field_70170_p, true, 42);
               }
   ...
   static class EntityAILeshCombine extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         ...
         return target == null ? true : !target.func_70089_S();
      }
         ...
         if (this.parent.field_70173_aa % 20 == 0) {
            ...
            for (EntityLesh mob : this.parent.field_70170_p.func_72872_a(EntityLesh.class, axisalignedbb)) {
               if (mob != this.parent
                  ...
                  && mob.func_70089_S()
                  && mob.func_94060_bK() == null
                  && mob.getTimes() + this.parent.getTimes() <= 4) {
                  this.parent.func_70624_b(mob);
                  mob.func_70624_b(this.parent);
                  return;
               }
            }
         }
