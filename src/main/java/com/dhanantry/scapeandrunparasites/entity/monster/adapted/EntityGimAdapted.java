...
public class EntityGimAdapted extends EntityPAdapted {
   private static final DataParameter<Byte> CLIMBING = EntityDataManager.func_187226_a(EntityGimAdapted.class, DataSerializers.field_187191_a);
   private int border;
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.AGIM_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.AGIM_HURT;
   }
