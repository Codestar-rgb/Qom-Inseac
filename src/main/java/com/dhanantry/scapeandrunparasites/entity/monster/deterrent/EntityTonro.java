...
public class EntityTonro extends EntityPStationary implements EntityCutomAttack {
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(3, new EntityAIAttackMeleeStatusAOE(this, 0.0, false, 8.0, 7.0));
      this.field_70714_bg.func_75776_a(8, new EntityAILookIdle(this));
      this.field_70714_bg.func_75776_a(2, new EntityAISkill(this, 20, 16, 1, true, 1));
   }
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.TONRO_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.TONRO_HURT;
   }
      ...
      if (this.border == 0) {
         ...
         if (this.field_70173_aa % 20 == 0) {
            ...
            if (this.func_70638_az() == null) {
               ...
               this.border = 0;
            } else if (this.func_70638_az().field_70163_u != this.field_70163_u) {
               this.skillshockwave = true;
               this.setParasiteStatus(0);
               this.border = 0;
            } else {
   ...
   private void spawnShock() {
      ...
      wa.func_70634_a(this.field_70165_t + -1.0 * (f19 * 2.0F * f16), this.field_70163_u, this.field_70161_v - -1.0 * (f4 * 2.0F * f16));
