...
public class EntityVenkrolSIII extends EntityPBeckon {
   public EntityAIVenkrolSummon summonV = new EntityAIVenkrolSummon(
      this, SRPConfigMobs.venkrolsiiilimit, 20 * SRPConfigMobs.venkrolsiiiCooldown, 3, SRPConfigMobs.venkrolsiiiCAMinimumV, SRPConfigMobs.venkrolsiiiCAExtraM
   );
   ...
   public EntityVenkrolSIII(World worldIn) {
      ...
      if (SRPAttributes.rsBlockI) {
         this.field_70714_bg.func_75776_a(3, new EntityAIBlockInfest(this, 3));
      }
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(4, new EntityAINexusGrow(this, 3));
   }
   ...
   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.VENKROLSIII_HURT;
   }
