...
public class EntityDod extends EntityPDispatcher {
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(4, new EntityAINexusGrow(this, 1, (byte)2));
      this.field_70714_bg.func_75776_a(2, new EntityAIDodAttack(this, 1, (byte)16, 10.0F));
   }
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111128_a(SRPConfig.nexussiFollow * SRPConfigMobs.dodsiFollowRangeMult);
   }
   ...
   public boolean storeParasite(EntityParasiteBase in) {
      if (super.storeParasite(in)) {
         ...
         return true;
      } else if (this.storeInf(in, false)) {
         return true;
      } else if (this.storeCrude(in, false)) {
         return true;
