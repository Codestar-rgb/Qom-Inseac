...
public class EntityFerHorse extends EntityPFeral {
   public EntityFerHorse(World worldIn) {
      super(worldIn);
      this.func_70105_a(1.3964844F, 1.75F);
      this.canModRender = 1;
      this.type = 11;
   }
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SRPAttributes.FERHORSE_HEALTH);
      this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SRPAttributes.FERHORSE_ARMOR);
      this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.27749999701976774);
      this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SRPAttributes.FERHORSE_KD_RESISTANCE);
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SRPAttributes.FERHORSE_ATTACK_DAMAGE);
