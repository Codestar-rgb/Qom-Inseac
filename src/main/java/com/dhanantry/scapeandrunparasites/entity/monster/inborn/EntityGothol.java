...
public class EntityGothol extends EntityParasiteBase {
   ...
   protected void selfExplode() {
      ...
      switch (this.getSkin()) {
         case 1:
            boolean flag = ForgeEventFactory.getMobGriefingEvent(this.field_70170_p, this) && SRPConfigMobs.gotholGriefing;
            ...
            if (!this.field_70170_p.field_72995_K) {
               ...
               for (EntityLivingBase mobx : this.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb)) {
                  if (!(mobx instanceof EntityParasiteBase)) {
                     ...
                     mobx.func_70690_d(new PotionEffect(SRPPotions.VOMIT_E, 500, 0, false, true));
                  }
               }
