...
extends EntityPAssimara {
                ...
                if (entitylivingbaseIn instanceof EntityPlayer) {
                    if (this.tpPlayerName != null) {
                        if (!this.tpPlayerName.equals(((EntityPlayer)entitylivingbaseIn).func_70005_c_())) {
                            ...
                            this.field_70170_p.func_184148_a((EntityPlayer)null, entitylivingbaseIn.field_70169_q, entitylivingbaseIn.field_70167_r, entitylivingbaseIn.field_70166_s, SRPSounds.ASSENDERMAN_PORTAL, this.func_184176_by(), 0.3f, 1.0f);
                        }
                    } else {
                        this.tpPlayerName = ((EntityPlayer)entitylivingbaseIn).func_70005_c_();
                        this.field_70170_p.func_184148_a((EntityPlayer)null, entitylivingbaseIn.field_70169_q, entitylivingbaseIn.field_70167_r, entitylivingbaseIn.field_70166_s, SRPSounds.ASSENDERMAN_PORTAL, this.func_184176_by(), 0.3f, 1.0f);
    ...
    public void func_70636_d() {
        ...
        if (this.field_70170_p.field_72995_K) {
            ...
            if (this.func_70638_az() != null && this.field_70173_aa % 20 == 0 && this.func_70068_e((Entity)this.func_70638_az()) > 4.0 && this.field_70146_Z.nextInt(SRPConfigMobs.infendermantelefreq) == 0) {
    ...
    private boolean teleportTo(double x, double y, double z) {
        ...
        if (flag) {
            this.field_70170_p.func_184148_a((EntityPlayer)null, this.field_70169_q, this.field_70167_r, this.field_70166_s, SRPSounds.ASSENDERMAN_PORTAL, this.func_184176_by(), 1.0f, 1.0f);
    ...
    protected SoundEvent func_184639_G() {
        ...
        return SRPSounds.ASSENDERMAN_GROWL;
    }
