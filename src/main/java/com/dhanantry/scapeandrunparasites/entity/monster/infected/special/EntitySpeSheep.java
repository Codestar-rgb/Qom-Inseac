...
public class EntitySpeSheep extends EntityPAssimara implements IRangedAttackMob {
   private int host;
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(4, new EntityAIAttackRangedStatus(this, 1.2, 100, (float)SRPConfig.assimaraFollow / 2.0F, true));
   }
   ...
   public void func_82196_d(EntityLivingBase target, float distanceFactor) {
      ...
      EntityProjectileNade entitylargefireball = new EntityProjectileNade(this.field_70170_p, this, d2, d3, d4, 3, 60);
