...
implements EntityCanHaveBodies {
    ...
    private static final DataParameter<Byte> PART = EntityDataManager.func_187226_a(EntityZaa.class, (DataSerializer)DataSerializers.field_187191_a);
    private static final DataParameter<Boolean> TAIL = EntityDataManager.func_187226_a(EntityZaa.class, (DataSerializer)DataSerializers.field_187198_h);
    private static final DataParameter<Boolean> DIG = EntityDataManager.func_187226_a(EntityZaa.class, (DataSerializer)DataSerializers.field_187198_h);
    ...
    protected void func_184651_r() {
        this.field_70714_bg.func_75776_a(1, (EntityAIBase)new EntityAIFollowBodies(this, 1.75, 0.26, 7, SRPConfig.adaptedKills, 140));
