    ...
    private void smash() {
        ...
        if (this.border > 100) {
            ...
            for (Object mob : moblist2) {
                if (mob == this || !this.func_70685_l((Entity)mob) || !SRPConfigSystems.rageEnable) continue;
                mob.func_70690_d(new PotionEffect(SRPPotions.RAGE_E, 1200, 1, false, false));
            }
        }
    }
}
