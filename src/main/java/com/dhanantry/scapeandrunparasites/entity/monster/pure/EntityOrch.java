...
public class EntityOrch extends EntityPPure implements EntityCutomAttack, EntityCanShoot {
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(3, new EntityAIAttackMeleeStatusAOE(this, 1.3, false, 8.0, 2.0));
      this.field_70714_bg.func_75776_a(2, new EntityAIEvadeDash(this, 17, 2, 5, 3.5, 15));
   }
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.ORCH_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.ORCH_HURT;
   }
      ...
      if (this.leapMotionY != 0.0F) {
         ...
         if (this.attacking >= 1) {
            ...
            if (this.attacking % 5 == 0 && this.attacking < 40 && SRPConfigMobs.lodoEnabled) {
               ...
               b.func_82149_j(this);
               this.field_70170_p.func_72838_d(b);
            }
   ...
   public EntityFireball getProj(double accelX, double accelY, double accelZ) {
      ...
      EntityLivingBase entitylivingbase = this.func_70638_az();
      accelY = entitylivingbase.func_174813_aQ().field_72338_b + entitylivingbase.field_70131_O / 3.0F - (1.0 + this.field_70163_u + this.field_70131_O / 2.0F);
      return new EntityProjectileWebball(this.field_70170_p, this, accelX, accelY, accelZ, (byte)2);
   }
