...
public class EntityFlam extends EntityPPreeminent {
   ...
   protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityFlam.class, DataSerializers.field_187191_a);

   public EntityFlam(World worldIn) {
      super(worldIn);
      this.field_70765_h = new EntityFlam.AIMoveControl(this);
   ...
   protected void func_184651_r() {
      super.func_184651_r();
      this.field_70714_bg.func_75776_a(6, new EntityFlam.AIMoveRandom());
      this.field_70714_bg.func_75776_a(4, new EntityFlam.AIChargeAttack());
   }
   ...
   protected void selfExplode() {
      ...
      if (!this.field_70170_p.field_72995_K) {
         ...
         AxisAlignedBB axisalignedbb = new AxisAlignedBB(
               this.field_70165_t, this.field_70163_u - 2.0, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0
            )
            .func_186662_g(4.0);
   ...
   public void DeadDead() {
      ...
      if (this.activationF >= 20) {
         switch (this.typeDead) {
            case 1:
               this.selfExplode();
               break;
            case 2:
               Entity ttt = new EntityOrbScary(this.field_70170_p, this.father, this.fuseOrb, this.orbStartTimer, false);
                  ...
                  if (this.func_174818_b(this.targetP) < 16.0) {
                     ...
                     switch (this.field_70146_Z.nextInt(2)) {
                        case 0:
                           ...
                           break;
                        case 1:
                           Entity ttt1 = new EntityOrbScary(this.field_70170_p, this.father, this.fuseOrb, this.orbStartTimer, false);
                           ttt1.func_82149_j(this);
                           ttt1.field_70163_u -= 3.0;
                           this.field_70170_p.func_72838_d(ttt1);
                           this.func_184185_a(SRPSounds.ORB_S, 1.0F, 1.0F);
                     }
                  }
               } else {
   ...
   class AIChargeAttack extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         return EntityFlam.this.targetP != null
               && !EntityFlam.this.func_70605_aq().func_75640_a()
               && EntityFlam.this.field_70146_Z.nextInt(7) == 0
               && !EntityFlam.this.moveM
            ? EntityFlam.this.func_174818_b(EntityFlam.this.targetP) > 4.0
            : false;
      }
      ...
      public void func_75249_e() {
         ...
         EntityFlam.this.field_70765_h
            .func_75642_a(
               EntityFlam.this.targetP.func_177958_n() + 0.5, EntityFlam.this.targetP.func_177956_o() + 2, EntityFlam.this.targetP.func_177952_p() + 0.5, 0.8
            );
      ...
      public void func_75246_d() {
         ...
         if (EntityFlam.this.targetP != null) {
            double d0 = EntityFlam.this.func_174818_b(EntityFlam.this.targetP);
            if (d0 < 9.0) {
               EntityFlam.this.field_70765_h
                  .func_75642_a(
                     EntityFlam.this.targetP.func_177958_n() + 0.5,
                     EntityFlam.this.targetP.func_177956_o() + 2,
                     EntityFlam.this.targetP.func_177952_p() + 0.5,
                     0.8
                  );
            }
         }
   ...
   class AIMoveControl extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         if (this.field_188491_h == Action.MOVE_TO && !EntityFlam.this.moveM) {
            ...
            if (d3 < EntityFlam.this.func_174813_aQ().func_72320_b()) {
               ...
               EntityFlam.this.field_70159_w = EntityFlam.this.field_70159_w + d0 / d3 * 0.05 * this.field_75645_e;
               EntityFlam.this.field_70181_x = EntityFlam.this.field_70181_x + d1 / d3 * 0.05 * this.field_75645_e;
               EntityFlam.this.field_70179_y = EntityFlam.this.field_70179_y + d2 / d3 * 0.05 * this.field_75645_e;
               if (EntityFlam.this.func_70638_az() == null) {
                  EntityFlam.this.field_70177_z = -((float)MathHelper.func_181159_b(EntityFlam.this.field_70159_w, EntityFlam.this.field_70179_y))
                     * (180.0F / (float)Math.PI);
                  EntityFlam.this.field_70761_aq = EntityFlam.this.field_70177_z;
               } else {
                  ...
                  EntityFlam.this.field_70177_z = -((float)MathHelper.func_181159_b(d4, d5)) * (180.0F / (float)Math.PI);
                  EntityFlam.this.field_70761_aq = EntityFlam.this.field_70177_z;
               }
            }
         }
   ...
   class AIMoveRandom extends EntityAIBase {
      ...
      public void func_75246_d() {
         BlockPos blockpos = new BlockPos(EntityFlam.this);
         byte flag = 1;
         double speed = 1.0;
         if (EntityFlam.this.func_70638_az() != null && EntityFlam.this.func_70638_az().func_70089_S()) {
            EntityFlam.this.targetP = EntityFlam.this.func_70638_az().func_180425_c();
         ...
         for (int i = 0; i < 3; i++) {
            BlockPos blockpos1 = blockpos.func_177982_a(
               EntityFlam.this.field_70146_Z.nextInt(15) - 7, EntityFlam.this.field_70146_Z.nextInt(11) - 5, EntityFlam.this.field_70146_Z.nextInt(15) - 7
            );
            if (flag == 2) {
               blockpos1 = blockpos.func_177982_a(
                  EntityFlam.this.field_70146_Z.nextInt(6) - 2, EntityFlam.this.field_70146_Z.nextInt(7) - 2, EntityFlam.this.field_70146_Z.nextInt(6) - 2
               );
            } else if (flag == 3) {
               blockpos1 = blockpos.func_177982_a(
                  EntityFlam.this.field_70146_Z.nextInt(4) + 3, EntityFlam.this.field_70146_Z.nextInt(5) + 4, EntityFlam.this.field_70146_Z.nextInt(4) + 3
               );
            }

            if (EntityFlam.this.field_70170_p.func_175623_d(blockpos1)) {
               EntityFlam.this.field_70765_h
                  .func_75642_a(blockpos1.func_177958_n() + 0.5, blockpos1.func_177956_o() + 0.5, blockpos1.func_177952_p() + 0.5, speed);
               if (EntityFlam.this.func_70638_az() == null) {
                  EntityFlam.this.func_70671_ap()
