...
public class EntityWymoAdapted extends EntityPAdapted implements EntityCanHaveBodies, EntityCutomAttack {
   ...
   private boolean up;
   private static final DataParameter<Byte> PART = EntityDataManager.func_187226_a(EntityWymoAdapted.class, DataSerializers.field_187191_a);
   private static final DataParameter<Boolean> TAIL = EntityDataManager.func_187226_a(EntityWymoAdapted.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> DIG = EntityDataManager.func_187226_a(EntityWymoAdapted.class, DataSerializers.field_187198_h);
   ...
   protected void func_184651_r() {
      this.field_70714_bg.func_75776_a(1, new EntityAIFollowBodies(this, 1.9F, 0.32, 5, 10000.0, 140));
      this.field_70715_bh.func_75776_a(2, new EntityAIHurtByTarget(this, true, new Class[0]));
      this.field_70714_bg.func_75776_a(0, new EntityAISwimming(this));
      this.field_70714_bg.func_75776_a(3, new EntityAIAttackMeleeStatusAOE(this, 1.3, false, 0.0, 4.0));
   }
   ...
   public boolean attackEntityAsMobAOE(Entity entityIn) {
      ...
      for (EntityLivingBase mob : this.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb)) {
         if (!(mob instanceof EntityParasiteBase) && this.func_70685_l(mob) && this.func_70652_k(mob)) {
            flag = true;
         }
      }
   ...
   protected SoundEvent func_184639_G() {
      return this.getParasiteStatus() != 0 ? SRPSounds.MOBSILENCE : SRPSounds.AWYMO_GROWL;
   }

   protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
      return this.field_70146_Z.nextBoolean() && this.getHitStatus() > 0 ? SRPSounds.MOBSILENCE : SRPSounds.AWYMO_HURT;
   }

   protected SoundEvent func_184615_bR() {
      return SRPSounds.AWYMO_DEATH;
   }
   ...
   public void setDigging(boolean in) {
      if (in) {
         this.func_184185_a(SRPSounds.AWYMO_DIG, 2.0F, this.func_70647_i());
      }
         ...
         if (this.getBodyNumber() >= 1 && this.getBodyNumber() <= 3) {
            ...
            for (EntityLivingBase mob : this.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb)) {
               if (!(mob instanceof EntityParasiteBase)) {
                  ...
                  if (this.attackEntityAsMobAOE(mob)) {
                     return;
                  }
               }
            }
