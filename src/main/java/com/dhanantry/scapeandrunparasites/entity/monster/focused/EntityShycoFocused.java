...
public class EntityShycoFocused extends EntityPFocused implements EntityCutomAttack, EntityBodyParts, EntityCanClimb {
   private float attackTimer;
   private boolean up;
   private double extraDamage;
   private double currentDamage;
   private double hpLeft;
   private static final DataParameter<Byte> CLIMBING = EntityDataManager.func_187226_a(EntityShycoFocused.class, DataSerializers.field_187191_a);
