...
public class EntityRanrac extends EntityPPrimitive implements EntityCanPullMobs {
   private static final DataParameter<Integer> TARGET_ENTITY = EntityDataManager.func_187226_a(EntityRanrac.class, DataSerializers.field_187192_b);
   private EntityLivingBase targetedEntity;
   private int pulling;
   private boolean canPull;
   private EntityHitbox head;
   private EntityHitbox abdomen;
   private static final DataParameter<Byte> CLIMBING = EntityDataManager.func_187226_a(EntityRanrac.class, DataSerializers.field_187191_a);
   private int border;
   ...
   public EntityRanrac(World worldIn) {
      ...
      this.canPull = true;
      this.head = new EntityHitbox(this, 1.6F, 0.8F, 1.0F, 0.7F, 0.6F, 1.25F);
      this.abdomen = new EntityHitbox(this, -1.6F, 0.8F, 1.3F, 0.9F, 1.5F, 0.5F);
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(2, new EntityAISkill(this, 40, 300, 7, true, 1));
