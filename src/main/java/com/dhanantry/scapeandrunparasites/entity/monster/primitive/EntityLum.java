...
public class EntityLum extends EntityPPrimitive implements EntityCanSwim, EntityCutomAttack {
   protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityLum.class, DataSerializers.field_187191_a);

   public EntityLum(World worldIn) {
      super(worldIn);
      this.func_70105_a(1.3F, 1.8F);
      this.field_70765_h = new EntityLum.AIMoveControl(this);
      this.borderOrb = -1;
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(2, new EntityAIAttackMeleeNotGround(this, 4.0, SRPConfig.primitiveFollow, 0.08, false, 0, 3));
      this.field_70714_bg.func_75776_a(6, new EntityLum.AIMoveRandom());
   }
   ...
   class AIMoveControl extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         if (this.field_188491_h == Action.MOVE_TO) {
            ...
            if (d3 < EntityLum.this.func_174813_aQ().func_72320_b()) {
               ...
               EntityLum.this.field_70159_w = EntityLum.this.field_70159_w + d0 / d3 * 0.05 * this.field_75645_e;
               EntityLum.this.field_70181_x = EntityLum.this.field_70181_x + d1 / d3 * 0.05 * this.field_75645_e;
               EntityLum.this.field_70179_y = EntityLum.this.field_70179_y + d2 / d3 * 0.05 * this.field_75645_e;
               if (EntityLum.this.func_70638_az() == null) {
                  EntityLum.this.field_70177_z = -((float)MathHelper.func_181159_b(EntityLum.this.field_70159_w, EntityLum.this.field_70179_y))
                     * (180.0F / (float)Math.PI);
                  EntityLum.this.field_70761_aq = EntityLum.this.field_70177_z;
               } else {
                  ...
                  EntityLum.this.field_70177_z = -((float)MathHelper.func_181159_b(d4, d5)) * (180.0F / (float)Math.PI);
                  EntityLum.this.field_70761_aq = EntityLum.this.field_70177_z;
               }
            }
         }
   ...
   class AIMoveRandom extends EntityAIBase {
      ...
      public void func_75246_d() {
         BlockPos blockpos = new BlockPos(EntityLum.this);
         byte flag = 1;
         double speed = 0.19;
         if (EntityLum.this.func_70638_az() != null) {
            if (EntityLum.this.func_70068_e(EntityLum.this.func_70638_az()) > 100.0) {
               blockpos = new BlockPos(EntityLum.this.func_70638_az());
               flag = 2;
            } else if (EntityLum.this.func_70068_e(EntityLum.this.func_70638_az()) < 36.0) {
               blockpos = new BlockPos(EntityLum.this.func_70638_az());
               flag = 3;
            }
         }
         ...
         for (int i = 0; i < 3; i++) {
            BlockPos blockpos1 = blockpos.func_177982_a(
               EntityLum.this.field_70146_Z.nextInt(15) - 7, EntityLum.this.field_70146_Z.nextInt(11) - 5, EntityLum.this.field_70146_Z.nextInt(15) - 7
            );
            if (flag == 2) {
               blockpos1 = blockpos.func_177982_a(
                  EntityLum.this.field_70146_Z.nextInt(6) - 2, EntityLum.this.field_70146_Z.nextInt(7) - 2, EntityLum.this.field_70146_Z.nextInt(6) - 2
               );
            } else if (flag == 3) {
               blockpos1 = blockpos.func_177982_a(
                  EntityLum.this.field_70146_Z.nextInt(4) + 3, EntityLum.this.field_70146_Z.nextInt(5) + 4, EntityLum.this.field_70146_Z.nextInt(4) + 3
               );
            }

            if (EntityLum.this.field_70170_p.func_180495_p(blockpos1).func_185904_a() == Material.field_151586_h) {
               EntityLum.this.field_70765_h
                  .func_75642_a(blockpos1.func_177958_n() + 0.5, blockpos1.func_177956_o() + 0.5, blockpos1.func_177952_p() + 0.5, speed);
               if (EntityLum.this.func_70638_az() == null) {
                  EntityLum.this.func_70671_ap()
