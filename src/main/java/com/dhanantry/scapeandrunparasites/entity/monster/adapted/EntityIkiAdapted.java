...
public class EntityIkiAdapted
extends EntityPAdapted
implements EntityCanShoot,
EntityCanFly {
    protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityIkiAdapted.class, (DataSerializer)DataSerializers.field_187191_a);
    private int count;
    ...
    public EntityFireball getProj(double accelX, double accelY, double accelZ) {
        ...
        EntityProjectileSpineball ball = new EntityProjectileSpineball(this.field_70170_p, (EntityLivingBase)this, accelX, accelY, accelZ, SRPAttributes.EMANA_RANGED_DAMAGE);
    ...
    extends EntityAIBase {
        ...
        public void func_75246_d() {
            ...
            for (int x = 0; x < serverList.size(); ++x) {
                if (!(serverList.get(x) instanceof EntityViin)) continue;
                ++count;
            }
            if (count < SRPConfig.worldGnatCap) {
                ...
                if (this.parent.func_70638_az() != null) {
                    ...
                    SRPMain.network.sendToAll((IMessage)new SRPPacketParticle(this.parent.field_70165_t, this.parent.field_70163_u, this.parent.field_70161_v, 0.5f, 0.5f, 10));
                }
            } else {
    ...
    extends EntityAIBase {
        ...
        public boolean func_75250_a() {
            if (EntityIkiAdapted.this.func_70638_az() != null && EntityIkiAdapted.this.field_70146_Z.nextInt(5) == 0) {
                return EntityIkiAdapted.this.func_70068_e((Entity)EntityIkiAdapted.this.func_70638_az()) > 4.0;
            }
            return false;
        }
        ...
        public void func_75246_d() {
            ...
            if (entitylivingbase != null && entitylivingbase.func_70089_S()) {
                if (EntityIkiAdapted.this.func_174813_aQ().func_72326_a(entitylivingbase.func_174813_aQ())) {
                    EntityIkiAdapted.this.func_70652_k((Entity)entitylivingbase);
                    EntityIkiAdapted.this.setCharging(false);
                } else {
                    double d0 = EntityIkiAdapted.this.func_70068_e((Entity)entitylivingbase);
                    if (d0 < 9.0) {
                        Vec3d vec3d = entitylivingbase.func_174824_e(1.0f);
    ...
    extends EntityAIBase {
        ...
        public void func_75246_d() {
            BlockPos blockpos = new BlockPos((Entity)EntityIkiAdapted.this);
            int flag = 1;
            double speed = 0.5;
            if (EntityIkiAdapted.this.func_70638_az() != null) {
                if (EntityIkiAdapted.this.func_70068_e((Entity)EntityIkiAdapted.this.func_70638_az()) > 225.0) {
                    blockpos = new BlockPos((Entity)EntityIkiAdapted.this.func_70638_az());
                    flag = 2;
                    speed += 0.25;
                } else if (EntityIkiAdapted.this.func_70068_e((Entity)EntityIkiAdapted.this.func_70638_az()) < 36.0) {
                    blockpos = new BlockPos((Entity)EntityIkiAdapted.this.func_70638_az());
                    flag = 3;
                    speed += 0.25;
                }
            ...
            for (int i = 0; i < 3; ++i) {
                BlockPos blockpos1 = blockpos.func_177982_a(EntityIkiAdapted.this.field_70146_Z.nextInt(15) - 7, EntityIkiAdapted.this.field_70146_Z.nextInt(11) - 5, EntityIkiAdapted.this.field_70146_Z.nextInt(15) - 7);
                if (!EntityIkiAdapted.this.field_70170_p.func_175623_d(blockpos1)) continue;
                EntityIkiAdapted.this.field_70765_h.func_75642_a((double)blockpos1.func_177958_n() + 0.5, (double)blockpos1.func_177956_o() + 0.5, (double)blockpos1.func_177952_p() + 0.5, speed);
                if (EntityIkiAdapted.this.func_70638_az() != null) break;
                EntityIkiAdapted.this.func_70671_ap().func_75650_a((double)blockpos1.func_177958_n() + 0.5, (double)blockpos1.func_177956_o() + 0.5, (double)blockpos1.func_177952_p() + 0.5, 180.0f, 20.0f);
                break;
            }
        }
    }
    ...
    extends EntityMoveHelper {
        ...
        public void func_75641_c() {
            if (this.field_188491_h == EntityMoveHelper.Action.MOVE_TO) {
                ...
                if ((d3 = (double)MathHelper.func_76133_a((double)d3)) < EntityIkiAdapted.this.func_174813_aQ().func_72320_b()) {
                    ...
                    EntityIkiAdapted.this.field_70159_w += d0 / d3 * 0.05 * this.field_75645_e;
                    EntityIkiAdapted.this.field_70181_x += d1 / d3 * 0.05 * this.field_75645_e;
                    EntityIkiAdapted.this.field_70179_y += d2 / d3 * 0.05 * this.field_75645_e;
                    if (EntityIkiAdapted.this.func_70638_az() == null) {
                        EntityIkiAdapted.this.field_70761_aq = EntityIkiAdapted.this.field_70177_z = -((float)MathHelper.func_181159_b((double)EntityIkiAdapted.this.field_70159_w, (double)EntityIkiAdapted.this.field_70179_y)) * 57.295776f;
                    } else {
                        ...
                        EntityIkiAdapted.this.field_70761_aq = EntityIkiAdapted.this.field_70177_z = -((float)MathHelper.func_181159_b((double)d4, (double)d5)) * 57.295776f;
                    }
                }
            }
        }
