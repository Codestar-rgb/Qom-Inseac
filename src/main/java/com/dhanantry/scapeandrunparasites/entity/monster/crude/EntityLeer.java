...
public class EntityLeer extends EntityParasiteBase implements EntityCanPullMobs {
   protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityLeer.class, DataSerializers.field_187191_a);
   private static final DataParameter<Integer> TARGET_ENTITY = EntityDataManager.func_187226_a(EntityLeer.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> TARGET_ENTITY1 = EntityDataManager.func_187226_a(EntityLeer.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> TARGET_ENTITY2 = EntityDataManager.func_187226_a(EntityLeer.class, DataSerializers.field_187192_b);
   ...
   public EntityLeer(World worldIn) {
      super(worldIn);
      this.field_70765_h = new EntityLeer.AIMoveControl(this);
   ...
   protected void func_184651_r() {
      ...
      this.field_70714_bg.func_75776_a(2, new EntityAISkill(this, 40, 300, 7, true, 1, true));
      this.field_70714_bg.func_75776_a(6, new EntityLeer.AIMoveRandom());
      this.field_70714_bg.func_75776_a(4, new EntityAIFlightLimits(this, 5, false));
   }
   ...
   public void func_70636_d() {
      ...
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (this.hasTargetedEntity()) {
            ...
            for (EntityLivingBase entitylivingbase : this.getTargetedEntityVictims()) {
               double dis = this.func_70068_e(entitylivingbase);
               if (this.func_70685_l(entitylivingbase) && dis > 0.0) {
                  ...
                  if (dis < 4.0) {
                     this.func_70652_k(entitylivingbase);
                  }
               } else {
                  this.setParasiteStatus(2);
                  this.setTargetedEntity(0, entitylivingbase);
      ...
      for (EntityLivingBase entitylivingbasex : this.getTargetedEntityVictims()) {
         if (this.func_70068_e(entitylivingbasex) > 0.0) {
            entitylivingbasex.func_184210_p();
            double str = 0.4;
            double deltaX = this.field_70165_t - entitylivingbasex.field_70165_t;
            double deltaY = this.field_70163_u - entitylivingbasex.field_70163_u;
            double deltaZ = this.field_70161_v - entitylivingbasex.field_70161_v;
            str = 0.1;
            ...
            deltaY /= distance;
            deltaZ /= distance;
            entitylivingbasex.field_70159_w += deltaX * str;
            entitylivingbasex.field_70181_x += deltaY * str;
            entitylivingbasex.field_70179_y += deltaZ * str;
         }
      }
   }
   ...
   public void setTargetedEntity(int entityId) {
      ...
      for (DataParameter<Integer> mobx : this.tracking) {
   ...
   public void setTargetedEntity(int entityId, EntityLivingBase sameEntity) {
      ...
      for (DataParameter<Integer> mob : this.tracking) {
         if ((Integer)this.field_70180_af.func_187225_a(mob) == sameEntity.func_145782_y()) {
   ...
   public void updateTargets() {
      for (DataParameter<Integer> mob : this.tracking) {
         if ((Integer)this.field_70180_af.func_187225_a(mob) != 0) {
            ...
            } else if (!((EntityLivingBase)entity).func_70089_S()) {
               this.field_70180_af.func_187227_b(mob, 0);
            }
         }
      }
   ...
   public void func_70074_a(EntityLivingBase entityLivingIn) {
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (SRPConfigSystems.useEvolution) {
            if (this.func_70644_a(SRPPotions.PIVOT_E)) {
               ...
               SRPSaveData.get(this.field_70170_p, 34)
                  .setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SRPConfigSystems.valueKill, true, this.field_70170_p, true, 39);
            }
         }
         ...
         if (parasiteCount < SRPConfig.worldMobCap) {
            ...
            EntityParasiteBase mob = new EntityInhooM(this.field_70170_p);
            ...
            mob.func_180482_a(this.field_70170_p.func_175649_E(new BlockPos(mob)), null);
   ...
   public boolean checkAttackTarget(EntityLivingBase check) {
      return check instanceof EntityParasiteBase ? false : !(check instanceof EntityPlayer) || !((EntityPlayer)check).func_184812_l_();
   }
         ...
         if (this.field_70173_aa % 20 == 0) {
            ...
            if (this.func_70638_az() == null) {
               ...
               for (EntityLivingBase mob : this.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb)) {
                  if (count >= 0 && mob != this && mob.func_70089_S() && !(mob instanceof EntityParasiteBase)) {
   ...
   public void shootEntityRed(EntityLivingBase entitylivingbase) {
      ...
      double d3 = entitylivingbase.func_174813_aQ().field_72337_e
         + (entitylivingbase.field_70131_O + 0.8F)
         - (0.5 + this.field_70163_u + this.field_70131_O / 1.0F);
   ...
   class AIChargeAttack extends EntityAIBase {
      ...
      public boolean func_75250_a() {
         return EntityLeer.this.func_70638_az() != null && EntityLeer.this.field_70146_Z.nextInt(5) == 0
            ? EntityLeer.this.func_70068_e(EntityLeer.this.func_70638_az()) > 4.0
            : false;
      }

      public boolean func_75253_b() {
         return EntityLeer.this.func_70605_aq().func_75640_a()
            && EntityLeer.this.isCharging()
            && EntityLeer.this.func_70638_az() != null
            && EntityLeer.this.func_70638_az().func_70089_S();
      }
      ...
      public void func_75246_d() {
         ...
         if (entitylivingbase != null && entitylivingbase.func_70089_S()) {
            if (EntityLeer.this.func_174813_aQ().func_72326_a(entitylivingbase.func_174813_aQ())) {
               EntityLeer.this.func_70652_k(entitylivingbase);
               EntityLeer.this.setCharging(false);
            } else {
               double d0 = EntityLeer.this.func_70068_e(entitylivingbase);
               if (d0 < 9.0) {
                  Vec3d vec3d = entitylivingbase.func_174824_e(1.0F);
   ...
   class AIMoveControl extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         if (this.field_188491_h == Action.MOVE_TO) {
            ...
            if (d3 < EntityLeer.this.func_174813_aQ().func_72320_b()) {
               ...
               EntityLeer.this.field_70159_w = EntityLeer.this.field_70159_w + d0 / d3 * 0.05 * this.field_75645_e;
               EntityLeer.this.field_70181_x = EntityLeer.this.field_70181_x + d1 / d3 * 0.05 * this.field_75645_e;
               EntityLeer.this.field_70179_y = EntityLeer.this.field_70179_y + d2 / d3 * 0.05 * this.field_75645_e;
               if (EntityLeer.this.func_70638_az() == null) {
                  EntityLeer.this.field_70177_z = -((float)MathHelper.func_181159_b(EntityLeer.this.field_70159_w, EntityLeer.this.field_70179_y))
                     * (180.0F / (float)Math.PI);
                  EntityLeer.this.field_70761_aq = EntityLeer.this.field_70177_z;
               } else {
                  ...
                  EntityLeer.this.field_70177_z = -((float)MathHelper.func_181159_b(d4, d5)) * (180.0F / (float)Math.PI);
                  EntityLeer.this.field_70761_aq = EntityLeer.this.field_70177_z;
               }
            }
         }
   ...
   class AIMoveRandom extends EntityAIBase {
      ...
      public void func_75246_d() {
         BlockPos blockpos = new BlockPos(EntityLeer.this);
         byte flag = 1;
         double speed = 0.1;
         if (EntityLeer.this.func_70638_az() != null) {
            if (EntityLeer.this.func_70068_e(EntityLeer.this.func_70638_az()) > 100.0) {
               blockpos = new BlockPos(EntityLeer.this.func_70638_az());
               flag = 2;
               speed += 0.05;
            } else if (EntityLeer.this.func_70068_e(EntityLeer.this.func_70638_az()) < 36.0) {
               blockpos = new BlockPos(EntityLeer.this.func_70638_az());
               flag = 3;
               speed += 0.05;
            }
         ...
         for (int i = 0; i < 3; i++) {
            BlockPos blockpos1 = blockpos.func_177982_a(
               EntityLeer.this.field_70146_Z.nextInt(15) - 7, EntityLeer.this.field_70146_Z.nextInt(11) - 5, EntityLeer.this.field_70146_Z.nextInt(15) - 7
            );
            if (flag == 2) {
               blockpos1 = blockpos.func_177982_a(
                  EntityLeer.this.field_70146_Z.nextInt(6) - 2, EntityLeer.this.field_70146_Z.nextInt(7) - 2, EntityLeer.this.field_70146_Z.nextInt(6) - 2
               );
            } else if (flag == 3) {
               blockpos1 = blockpos.func_177982_a(
                  EntityLeer.this.field_70146_Z.nextInt(4) + 3, EntityLeer.this.field_70146_Z.nextInt(5) + 4, EntityLeer.this.field_70146_Z.nextInt(4) + 3
               );
            }

            if (EntityLeer.this.field_70170_p.func_175623_d(blockpos1)) {
               EntityLeer.this.field_70765_h
                  .func_75642_a(blockpos1.func_177958_n() + 0.5, blockpos1.func_177956_o() + 1.0, blockpos1.func_177952_p() + 0.5, speed);
               if (EntityLeer.this.func_70638_az() == null) {
                  EntityLeer.this.func_70671_ap()
