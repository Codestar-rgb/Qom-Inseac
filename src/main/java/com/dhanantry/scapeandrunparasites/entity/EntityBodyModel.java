...
public class EntityBodyModel extends EntityBody {
   ...
   public EntityBodyModel(
      EntityParasiteBase parent, float width, float height, float damageMultiplier, float offset, float offheight, int inv, int id, boolean side
   ) {
