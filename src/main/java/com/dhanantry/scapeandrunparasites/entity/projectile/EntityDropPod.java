...
extends EntityParasiteBase {
    ...
    protected void selfExplode() {
        boolean flag = ForgeEventFactory.getMobGriefingEvent((World)this.field_70170_p, (Entity)this) && SRPConfigMobs.ratholGriefing;
            ...
            switch (this.owner) {
                case 62: {
                    ...
                    while (limit < SRPConfigMobs.oroncoMaxMobPod && cap < 5) {
                        if (ParasiteSummon.SummonM(this, SRPConfigMobs.oroncoMobList, 1, this.field_70165_t, this.field_70163_u, this.field_70161_v, this.func_70638_az(), false)) {
                            ++limit;
                            continue;
                        }
                        ++cap;
