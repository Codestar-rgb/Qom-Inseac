...
public class EntityProjectileDragonE extends EntitySRPProjectile {
   ...
   protected void func_70227_a(RayTraceResult result) {
      if (!this.field_70170_p.field_72995_K) {
         ...
         for (EntityLivingBase mob : this.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb)) {
            if (!(mob instanceof EntityParasiteBase) || mob instanceof EntityNak) {
               ...
               this.attackEntityAsMobMinimum(mob, (EntityParasiteBase)this.field_70235_a);
            }
         }
   ...
   public void func_70071_h_() {
      if (this.field_70170_p.field_72995_K
         ...
         this.ticksInAir++;
         RayTraceResult raytraceresult = ProjectileHelper.func_188802_a(this, true, this.ticksInAir >= 25, this.field_70235_a);
         ...
         this.field_70159_w = this.field_70159_w + this.field_70232_b;
         this.field_70181_x = this.field_70181_x + this.field_70233_c;
         this.field_70179_y = this.field_70179_y + this.field_70230_d;
