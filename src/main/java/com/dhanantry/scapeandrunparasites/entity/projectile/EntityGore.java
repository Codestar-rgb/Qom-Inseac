    ...
    public void func_70071_h_() {
        ...
        if (this.groun >= 1) {
            if (!this.field_70170_p.field_72995_K) {
                switch (this.type) {
                    case 1: {
                        this.placeBlood(SRPBlocks.goreSim.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.SMALL)));
                        break;
                    }
                    case 2: {
                        this.placeBlood(SRPBlocks.gorePri.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.SMALL)));
                        break;
                    }
                    case 3: {
                        this.placeBlood(SRPBlocks.goreAda.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.SMALL)));
                        break;
                    }
                    case 4: {
                        this.placeBlood(SRPBlocks.gorePur.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.SMALL)));
                        break;
                    }
                    case 5: {
                        this.placeBlood(SRPBlocks.goreFer.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.SMALL)));
                        break;
                    }
                    case 6: {
                        this.placeBlood(SRPBlocks.goreMar.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.SMALL)));
                        break;
                    }
                    case 10: {
