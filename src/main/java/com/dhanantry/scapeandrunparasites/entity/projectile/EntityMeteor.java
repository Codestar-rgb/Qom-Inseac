...
public class EntityMeteor extends Entity {
   ...
   public static final DataParameter<Boolean> FATHER = EntityDataManager.func_187226_a(EntityMeteor.class, DataSerializers.field_187198_h);
   ...
   protected void func_70088_a() {
      this.field_70180_af.func_187214_a(FATHER, false);
   }
   ...
   public void func_70071_h_() {
      ...
      if (!this.field_70170_p.field_72995_K && this.getRoot() && this.field_70173_aa % 20 == 0) {
         for (EntityPlayer mob : this.field_70170_p.field_73010_i) {
            float str = getDistancePack(this.func_180425_c(), mob.func_180425_c(), 150);
            if (str > 0.0F) {
               SRPNetwork.CHANNEL.sendTo(new MsgQlipShake(20, 0, false, true, str * 2.0F), (EntityPlayerMP)mob);
            }
         }
         ...
         if (this.field_70146_Z.nextInt(2) == 0) {
            ...
            this.field_70170_p.func_72838_d(fragment);
         }
      }

      this.ticksInAir++;
      RayTraceResult raytraceresult = ProjectileHelper.func_188802_a(this, true, this.ticksInAir >= 25, this);
      ...
      this.field_70159_w = this.field_70159_w + this.accelerationX;
      this.field_70181_x = this.field_70181_x + this.accelerationY;
      this.field_70179_y = this.field_70179_y + this.accelerationZ;
      ...
      if (this.field_70170_p.field_72995_K) {
         for (int i = 0; i < 5; i++) {
            ...
            double offsetY = (this.field_70170_p.field_73012_v.nextDouble() - 0.5) * this.field_70131_O * 4.0;
            ...
            double particleY = this.field_70163_u + offsetY + this.field_70131_O * 0.5 * 2.0;
            ...
            if (!this.getRoot()) {
               this.field_70170_p
                  .func_175688_a(EnumParticleTypes.EXPLOSION_LARGE, particleX, particleY, particleZ, particleVX, particleVY, particleVZ, new int[0]);
            } else {
               this.field_70170_p
   ...
   protected void onImpact() {
      if (!this.field_70170_p.field_72995_K) {
         if (this.getRoot()) {
            List<Entity> mobs = Lists.newArrayList();
            mobs.addAll(this.field_70170_p.field_72996_f);
            if (mobs.size() != 0) {
               for (Entity mob : mobs) {
                  if (mob instanceof EntityLivingBase) {
                     if (mob instanceof EntityPlayer) {
                        float str = getDistancePack(this.func_180425_c(), mob.func_180425_c(), 400);
                        if (str > 0.0F) {
                           SRPNetwork.CHANNEL.sendTo(new MsgQlipShake(150, 0, false, true, str * 8.0F), (EntityPlayerMP)mob);
                        }
                     }

                     float str = getDistancePack(this.func_180425_c(), mob.func_180425_c(), SRPConfigWorld.meteorDamage);
                     if (str > 0.0F) {
                        mob.func_70097_a(DamageSource.field_82729_p, str * 450.0F);
                     }

                     str = getDistancePack(this.func_180425_c(), mob.func_180425_c(), 800);
                     if (str > 0.5) {
         ...
         EntityOrbBoom orb = new EntityOrbBoom(this.field_70170_p, (EntityPMalleable)null, rad, 1);
   ...
   public void func_70014_b(NBTTagCompound compound) {
      compound.func_74782_a("direction", this.func_70087_a(new double[]{this.field_70159_w, this.field_70181_x, this.field_70179_y}));
      compound.func_74782_a("power", this.func_70087_a(new double[]{this.accelerationX, this.accelerationY, this.accelerationZ}));
   ...
   public void setRoot(boolean in) {
      this.field_70180_af.func_187227_b(FATHER, in);
   }
   ...
   public static float getDistancePack(BlockPos pos1, BlockPos pos2, int maxDistance) {
      if (maxDistance <= 0) {
         ...
         double distSq = pos1.func_177951_i(pos2);
