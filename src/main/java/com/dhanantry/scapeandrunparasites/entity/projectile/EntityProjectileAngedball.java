...
public class EntityProjectileAngedball extends EntitySRPProjectile {
   ...
   protected void func_70227_a(RayTraceResult result) {
      if (!this.field_70170_p.field_72995_K) {
         if (result.field_72308_g != null && result.field_72308_g instanceof EntityLivingBase) {
            ...
            result.field_72308_g.func_70097_a(damagesource, (float)SRPAttributes.ANGED_RANGED_ATTACK_DAMAGE);
         ...
         entityareaeffectcloud.addEffect(new PotionEffect(SRPPotions.CORRO_E, 100, 0, false, false));
