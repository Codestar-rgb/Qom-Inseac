...
public class EntityProjectileLenciaBall extends EntitySRPProjectile {
   ...
   protected void func_70227_a(RayTraceResult result) {
      if (!this.field_70170_p.field_72995_K) {
         ...
         boolean flag = ForgeEventFactory.getMobGriefingEvent(this.field_70170_p, this) && SRPConfigMobs.lenciaGriefing;
         ParasiteEventEntity.createExplosion(this.field_70170_p, this.field_70235_a, this.field_70165_t, this.field_70163_u, this.field_70161_v, 10.0F, flag);
         this.func_70106_y();
      }
   }
}
