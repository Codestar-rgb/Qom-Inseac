...
extends EntityAIBase {
    ...
    public void func_75246_d() {
        if (this.parentEntity.func_70638_az() == null) {
            ...
            if (entitylivingbase.func_70068_e((Entity)this.parentEntity) < this.prepDistance * this.prepDistance && this.parentEntity.func_70685_l((Entity)entitylivingbase)) {
                this.parentEntity.setParasiteStatus(15);
                if (entitylivingbase.func_70068_e((Entity)this.parentEntity) < this.maxDistance * this.maxDistance && entitylivingbase.func_70068_e((Entity)this.parentEntity) > this.minDistance * this.minDistance && this.parentEntity.field_70173_aa % 20 == 0) {
                    ...
                    EntityDamage entityevokerfangs = new EntityDamage(this.parentEntity.field_70170_p, entitylivingbase.field_70165_t, entitylivingbase.field_70163_u, entitylivingbase.field_70161_v, f, (EntityLivingBase)this.parentEntity, 1.0f, this.pulling, 1.0f);
