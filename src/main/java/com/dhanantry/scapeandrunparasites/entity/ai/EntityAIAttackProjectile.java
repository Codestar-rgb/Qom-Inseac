...
public class EntityAIAttackProjectile extends EntityAIBase {
   ...
   public void func_75246_d() {
      if (this.parentEntity.func_70638_az() == null || this.parentEntity.getParasiteStatus() >= 3) {
         ...
         if (entitylivingbase.func_70068_e(this.parentEntity) < 4225.0 && this.parentEntity.func_70685_l(entitylivingbase)) {
            this.attackTimer++;
   ...
   private void shoot(EntityLivingBase entitylivingbase, World world) {
      ...
      if (this.heighA <= 5) {
         ...
         entitylargefireball.field_70163_u = this.parentEntity.field_70163_u + this.parentEntity.func_70047_e() - 0.2;
