...
public abstract class EntityPDerived extends EntityPCosmical {
      ...
      this.field_70715_bh
         .func_75776_a(
            ...
            new EntityAINearestAttackableTargetStatus(
               this, EntityPlayer.class, 0, SRPConfig.derivedWalls, false, null, SRPConfig.derivedSneakPen, SRPConfig.derivedInviPen
            )
         );
         ...
         this.field_70715_bh
            .func_75776_a(
               ...
               new EntityAINearestAttackableTargetStatus(
                  ...
                  SRPConfig.derivedSneakPen,
                  SRPConfig.derivedInviPen
               )
            );
      }
