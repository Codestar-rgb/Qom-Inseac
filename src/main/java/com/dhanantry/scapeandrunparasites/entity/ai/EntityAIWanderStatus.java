   ...
   public boolean func_75250_a() {
      if (this.entity.getParasiteStatus() != 0) {
         ...
         if (vec3d == null) {
            ...
            return !this.entity.checkPositionWander(this.x, this.y, this.y)
               ? false
               : this.entity.func_70661_as().func_75505_d() == null || this.executionChance == 0;
         }
      }
   }
   ...
   protected Vec3d getPosition() {
      if (this.avoidW) {
         if (this.entity.func_70090_H()) {
            ...
            return vec3d == null ? RandomPositionGenerator.func_75463_a(this.entity, 10, 7) : vec3d;
         } else if (this.entity.getParasiteFollowing() == null) {
            return this.entity.func_70681_au().nextFloat() >= this.probability
               ? RandomPositionGenerator.func_191377_b(this.entity, 10, 7)
               : RandomPositionGenerator.func_75463_a(this.entity, 10, 7);
         } else {
            Random ran = new Random();
            if (ran.nextInt(3) == 0) {
               return this.entity.func_70681_au().nextFloat() >= this.probability
                  ? RandomPositionGenerator.func_191377_b(this.entity, 3, 2)
                  : RandomPositionGenerator.func_75463_a(this.entity, 3, 2);
            } else {
               return null;
            }
         }
         ...
         Random ran = new Random();
         return ran.nextInt(3) == 0 ? RandomPositionGenerator.func_75463_a(this.entity, 0, 0) : null;
      }
   }
