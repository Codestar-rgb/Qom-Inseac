...
implements EntityCanSummon {
    ...
    public void func_70645_a(DamageSource cause) {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            for (int k2 = -1 * BGrange; k2 <= 1 * BGrange; ++k2) {
                for (int l2 = -1 * BGrange; l2 <= 1 * BGrange; ++l2) {
                    for (int j = -1 * BGrange; j <= 1 * BGrange; ++j) {
                        ...
                        if (block != SRPBlocks.ParasiteFog) continue;
                        this.field_70170_p.func_175656_a(blockpos, SRPBlocks.ParasiteFog.func_176223_P().func_177226_a((IProperty)BlockParasiteFog.STAGE, (Comparable)Integer.valueOf(2)));
                    }
                }
            }
            ...
            if ((this.convert || ParasiteEventEntity.getRSchance(this.field_70170_p) == 0.0 || !SRPConfigSystems.useEvolution && (double)SRPConfigSystems.rschance == 0.0) && ((bbb = this.field_70170_p.func_180495_p(floor = new BlockPos((Entity)this).func_177977_b()).func_177230_c()) == SRPBlocks.InfestedStain || bbb == SRPBlocks.InfestedRubble) && ((meta = bbb.func_176201_c(this.field_70170_p.func_180495_p(floor))) <= SRPConfigSystems.rsBlockRevertStage && meta <= this.stage || ParasiteEventEntity.getRSchance(this.field_70170_p) == 0.0)) {
                this.field_70170_p.func_175656_a(floor, SRPBlocks.InfestedStain.func_176223_P().func_177226_a((IProperty)BlockInfestedStain.STAGE, (Comparable)Integer.valueOf(5)));
                this.field_70170_p.func_175654_a(floor, SRPBlocks.InfestedStain.func_176223_P().func_177226_a((IProperty)BlockInfestedStain.STAGE, (Comparable)Integer.valueOf(5)).func_177230_c(), 40, 5);
            }
        }
    }
