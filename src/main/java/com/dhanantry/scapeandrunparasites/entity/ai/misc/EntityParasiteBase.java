...
implements IHitboxedEntity {
    ...
    public void applyBonuses(SRPSaveData sabe, World world) {
        ...
        if (this.phaseCreated >= SRPConfigSystems.evolutionTotalKill) {
            this.field_70715_bh.func_75776_a(4, new EntityAINearestAttackableTargetStatus<EntityLivingBase>(this, EntityLivingBase.class, 0, false, false, entity -> !(entity instanceof EntityPlayer) && !ParasiteEventEntity.checkEntity(entity, SRPConfig.mobattackingBlackList, SRPConfig.mobattackingBlackListWhite), SRPConfig.adaptedSneakPen, SRPConfig.adaptedInviPen));
        }
    }
    ...
    public void func_70636_d() {
        ...
        if (this.field_70170_p.field_72995_K) {
            ...
            if ((tgt = this.func_70638_az()) instanceof EntityPlayer && tgt.func_70644_a(SRPPotions.THE_SIGN_E)) {
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (source == DamageSource.field_76372_a || source == DamageSource.field_76370_b) {
            if (!this.field_70178_ae) {
                ...
                return super.func_70097_a(source, this.getSkin() == 120 ? amount * (SRPConfig.firemultyplier - SRPConfig.firemultyplier / 2.0f) : amount * SRPConfig.firemultyplier);
            }
            return false;
        }
        if (this.notOwner != null) {
            if (this.notOwner.func_70089_S()) {
                if (this.func_70644_a(SRPPotions.PIVOT_E)) {
                    this.notOwner.func_70097_a(source, amount * (float)(Objects.requireNonNull(this.func_70660_b(SRPPotions.PIVOT_E)).func_76458_c() + 1) * SRPConfigSystems.pivotDamageRHost);
    ...
    public boolean func_70652_k(@Nonnull Entity entityIn) {
        ...
        if ((flag = super.func_70652_k(entityIn)) && green) {
            ...
            if (this.field_70146_Z.nextDouble() < (double)this.cothSpread && !(target = (EntityLivingBase)entityIn).func_70644_a(SRPPotions.COTH_E) && !target.func_70644_a(SRPPotions.EPEL_E)) {
    ...
    public void func_70074_a(EntityLivingBase entityLivingIn) {
        ...
        if (SRPConfigSystems.useEvolution) {
            if (this.func_70644_a(SRPPotions.PIVOT_E)) {
                ...
                SRPSaveData.get(this.field_70170_p, 35).setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SRPConfigSystems.valueKill * (SRPConfigSystems.pivotPointMultiplier * (amp + 1)), true, this.field_70170_p, true, 17);
            } else {
                SRPSaveData.get(this.field_70170_p, 34).setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SRPConfigSystems.valueKill, true, this.field_70170_p, true, 16);
            }
        }
    ...
    public boolean func_70687_e(PotionEffect potioneffectIn) {
        ...
        if (potion == SRPPotions.COTH_E || potion == SRPPotions.VIRA_E || potion == SRPPotions.CORRO_E || potion == SRPPotions.DLER_E) {
            return false;
        }
    ...
    public void func_70645_a(DamageSource cause) {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            ParasiteEventWorld.setOriginInHealth(this.field_70170_p, this.func_180425_c(), (int)(-((double)this.func_110138_aP() * SRPConfigWorld.originParasiteDeath)), true);
            if (SRPConfigSystems.useEvolution && !this.func_70644_a(SRPPotions.DEBAR_E)) {
                SRPSaveData.get(this.field_70170_p, 39).setTotalKills(this.field_70170_p.field_73011_w.getDimension(), -this.valueEvDeath, true, this.field_70170_p, false, 18);
            }
    ...
    protected void onDeathUpdateOG() {
        ...
        if (this.field_70725_aQ == 20) {
            if (!this.field_70170_p.field_72995_K && (this.func_70684_aJ() || this.field_70718_bc > 0 && this.func_146066_aG() && this.field_70170_p.func_82736_K().func_82766_b("doMobLoot")) && !this.func_70644_a(SRPPotions.DEBAR_E)) {
                ...
                int i;
                if (SRPConfigSystems.useEvolution) {
                    if (SRPSaveData.get(this.field_70170_p, 37).getEvolutionPhase(this.field_70170_p.field_73011_w.getDimension()) < SRPConfigSystems.evolutionPArasitesWithoutXP) {
    ...
    public boolean func_70601_bi() {
        if (SRPConfigSystems.useEvolution) {
            ...
            IBlockState iblockstate = this.field_70170_p.func_180495_p(new BlockPos((Entity)this).func_177977_b());
            return iblockstate.func_189884_a((Entity)this) && this.field_70170_p.func_175659_aa() != EnumDifficulty.PEACEFUL && this.isValidLightLevelOne() && SRPConfig.spawnDays <= (int)this.field_70170_p.func_82737_E();
        }
    ...
    protected boolean applyColdBiome() {
        ...
        if (c.func_180626_a(this.func_180425_c()) <= (float)SRPConfigWorld.frozenVariantTempThreshold || c.func_150559_j() || this.canChangeVariant) {
            this.setSkin(120);
