...
public class EntityAIEvadeTP extends EntityAIBase {
      ...
      if (target != null) {
         if (this.parent.func_70068_e(target) > this.blockDistance
            ...
            if (this.cooldown >= this.eCooldown) {
               this.targetIniDis = this.parent.func_70068_e(target);
               this.targetIniDisSegment = this.targetIniDis / (this.dash + 1);
            }
         }
   ...
   protected boolean teleportRandomly() {
      ...
      double d1 = this.parent.field_70163_u + (this.parent.field_70170_p.field_73012_v.nextInt(64) - 32);
      double d2 = this.parent.field_70161_v + (this.parent.field_70170_p.field_73012_v.nextDouble() - 0.5) * 64.0;
      return this.parent.func_70638_az() != null && this.parent.func_70638_az().func_70011_f(d0, d1, d2) < 10.0 ? false : this.teleportTo(d0, d1, d2);
   }
   ...
   private boolean teleportTo(double x, double y, double z) {
      ...
      if (flag) {
         this.parent
            ...
            .func_184148_a(
               (EntityPlayer)null,
               this.parent.field_70169_q,
               this.parent.field_70167_r,
               this.parent.field_70166_s,
               SRPSounds.INFECTEDENDERMAN_PORTAL,
               this.parent.func_184176_by(),
               1.0F,
               1.0F
            );
