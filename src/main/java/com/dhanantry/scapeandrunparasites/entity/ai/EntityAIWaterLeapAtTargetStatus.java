...
public class EntityAIWaterLeapAtTargetStatus extends EntityAIBase {
   ...
   public void func_75246_d() {
      if (this.leaper.func_70638_az() != null && this.leaper.shouldWorkTask()) {
         if (!this.leaper.func_70638_az().field_70128_L && this.leaper.getParasiteStatus() <= 2) {
      ...
      if (this.attacking >= 1) {
         ...
         if (this.attacking == 2 && this.leaper.field_70122_E) {
            ...
            this.leaper.field_70181_x = (double)this.leapMotionY + this.targetY;
            this.leaper.field_70159_w = this.leaper.field_70159_w + (d0 / f * this.jumpSpeed * 0.9 + this.leaper.field_70159_w * 0.3);
            this.leaper.field_70179_y = this.leaper.field_70179_y + (d1 / f * this.jumpSpeed * 0.9 + this.leaper.field_70179_y * 0.3);
         }
         ...
         if (this.attacking >= 3 && this.leaper.field_70122_E) {
            if (this.jumpR != 0) {
               ...
               AxisAlignedBB axisalignedbb = new AxisAlignedBB(
                     this.leaper.field_70165_t,
                     this.leaper.field_70163_u,
                     this.leaper.field_70161_v,
                     this.leaper.field_70165_t + 1.0,
                     this.leaper.field_70163_u + 1.0,
                     this.leaper.field_70161_v + 1.0
                  )
                  .func_72314_b(this.jumpR, 2.0, this.jumpR);

               for (EntityLivingBase mob : this.leaper.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb)) {
                  if (mob != this.leaper && !(mob instanceof EntityParasiteBase)) {
                     mob.func_70653_a(mob, 2.5F, this.leaper.field_70165_t - mob.field_70165_t, this.leaper.field_70161_v - mob.field_70161_v);
                     this.leaper.func_70652_k(mob);
                  }
               }
            }
