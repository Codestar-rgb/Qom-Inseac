...
public class EntityAIFlightAttack extends EntityAIBase {
   ...
   public void func_75246_d() {
      ...
      if (this.parent.func_70638_az() != null) {
         ...
         if (!this.parent.func_70685_l(target)) {
            if (this.xRay) {
         ...
         } else if (target.func_70068_e(this.parent) >= this.distance) {
            this.delay++;
         } else {
            this.delay = 0;
         }
   ...
   protected void attackSurr() {
      ...
      if (this.fromF != 0 && this.parent.field_70170_p.field_73012_v.nextInt(this.fromF) == 0) {
         posi = ParasiteEventEntity.getFloor(this.parent.field_70170_p, posi, 25);
         if (posi == null) {
