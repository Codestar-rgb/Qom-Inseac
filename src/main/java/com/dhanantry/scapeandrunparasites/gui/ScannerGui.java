...
extends GuiContainer {
    ...
    public void func_73866_w_() {
        ...
        this.scanBtn = new GuiButton(0, x + 120, y + 34, 48, 20, I18n.func_135052_a((String)"chat.srparasites.relay.scan_text", (Object[])new Object[0]));
    ...
    protected void func_146284_a(GuiButton button) throws IOException {
        if (button == this.scanBtn) {
            SRPNetwork.CHANNEL.sendToServer((IMessage)new MsgRequestScan(this.te.func_174877_v()));
        }
    ...
    private void drawCooldownBar(int mouseX, int mouseY, float partialTicks) {
        ...
        String label = I18n.func_135052_a((String)"gui.srparasites.scanner.cooldown", (Object[])new Object[]{secs});
