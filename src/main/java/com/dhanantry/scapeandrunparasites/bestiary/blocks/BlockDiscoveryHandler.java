...
public class BlockDiscoveryHandler {
    ...
    private static boolean scanInventory(IInventory inv, IBestiaryProgress prog) {
        ...
        for (int i = 0; i < inv.func_70302_i_(); ++i) {
            ...
            if (st.func_190926_b() || !(st.func_77973_b() instanceof ItemBlock) || (id = (itemBlock = (ItemBlock)st.func_77973_b()).func_179223_d().getRegistryName()) == null || (entry = SRPBlockCompendiumRegistry.get(id)) == null || prog.hasSeenBlock(id)) continue;
