...
public class ModelProjectileHomming extends ModelBase {
   ...
   public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
      ...
      this.renderer.field_78796_g = netHeadYaw * (float) (Math.PI / 180.0);
      this.renderer.field_78795_f = headPitch * (float) (Math.PI / 180.0);
   }
}
