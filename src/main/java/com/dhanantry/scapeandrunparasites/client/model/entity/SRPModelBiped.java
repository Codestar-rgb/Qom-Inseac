...
public class SRPModelBiped extends ModelBiped {
   ...
   public SRPModelBiped.ArmPose leftAP = SRPModelBiped.ArmPose.EMPTY;
   public SRPModelBiped.ArmPose rightAP = SRPModelBiped.ArmPose.EMPTY;
   ...
   public SRPModelBiped(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn) {
   ...
   public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netjointHYaw, float jointHPitch, float scaleFactor, Entity entityIn) {
      ...
      switch (this.parent) {
         case 1:
            ...
            float f4 = MathHelper.func_76134_b(ageInTicks * 0.08F) * 0.07F;
            this.jointH.field_78795_f = 0.45F + f4;
            float GS0 = 1.0F;
            if (entityIn.field_70169_q != entityIn.field_70165_t || entityIn.field_70166_s != entityIn.field_70161_v) {
               float GS = 1.75F;
               float GD = 0.55F;
               GS0 += 0.45F;
   ...
   public void func_178686_a(ModelBase model) {
      ...
      if (model instanceof SRPModelBiped) {
         SRPModelBiped modelbiped = (SRPModelBiped)model;
