...
public class RenderSpeCow extends RenderSRP<EntitySpeCow> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/specow.png");
