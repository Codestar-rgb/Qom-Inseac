...
public class RenderSpeBear extends RenderSRP<EntitySpeBear> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/spebear.png");
   ...
   protected void preRenderCallback(EntitySpeBear entitylivingbaseIn, float partialTickTime) {
      ...
      GlStateManager.func_179152_a(f2 * 1.3F, f3 * 1.3F, f2 * 1.3F);
   }
