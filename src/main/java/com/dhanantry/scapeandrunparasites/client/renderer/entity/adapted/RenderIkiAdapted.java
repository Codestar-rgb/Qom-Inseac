...
public class RenderIkiAdapted extends RenderMalleable<EntityIkiAdapted> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/ikia.png");
