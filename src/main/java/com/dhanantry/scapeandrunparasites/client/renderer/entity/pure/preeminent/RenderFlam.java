...
public class RenderFlam extends RenderMalleable<EntityFlam> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/flam.png");
