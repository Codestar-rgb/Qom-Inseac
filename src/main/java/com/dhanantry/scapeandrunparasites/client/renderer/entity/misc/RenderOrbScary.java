...
public class RenderOrbScary extends Render<EntityOrbScary> {
   ...
   protected void renderModelCosmical(
      EntityOrbScary e, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, float partialTicks
   ) {
      boolean flag = false;
      ...
      if (flag || flag1) {
         ...
         GlStateManager.func_179132_a(!cameraInside);
