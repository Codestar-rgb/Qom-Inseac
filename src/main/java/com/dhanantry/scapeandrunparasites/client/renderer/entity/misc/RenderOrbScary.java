...
extends Render<EntityOrbScary> {
    ...
    public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/orbscary.png");
    private static final ResourceLocation LIGHTNING_TEX = new ResourceLocation("srparasites:textures/entity/monster/orbscary_armor.png");
