...
public class RenderMeteor extends Render<EntityMeteor> {
   ...
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/projectile/meteor.png");

   public RenderMeteor(RenderManager p_i47208_1_) {
      super(p_i47208_1_);
   }

   public boolean shouldRender(EntityMeteor livingEntity, ICamera camera, double camX, double camY, double camZ) {
      return true;
   }
   ...
   protected void renderModelCosmical(
      EntityMeteor entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor
   ) {
      boolean flag = false;
