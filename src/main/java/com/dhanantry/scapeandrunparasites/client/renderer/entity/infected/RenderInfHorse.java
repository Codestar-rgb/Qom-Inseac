...
public class RenderInfHorse extends RenderSRP<EntityInfHorse> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/infhorse.png");
