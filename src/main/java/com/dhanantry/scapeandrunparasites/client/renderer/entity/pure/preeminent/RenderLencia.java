...
public class RenderLencia extends RenderMalleable<EntityLencia> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/lencia.png");
