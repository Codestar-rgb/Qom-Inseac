...
public class RenderFerHuman extends RenderSRP<EntityFerHuman> {
   public static final ResourceLocation TEXTURE = new ResourceLocation("srparasites:textures/entity/monster/ferhuman.png");
