...
public class RenderZaaAdapted extends RenderMalleable<EntityZaaAdapted> {
   public static final ResourceLocation TEXTUREH = new ResourceLocation("srparasites:textures/entity/monster/zaaa.png");
