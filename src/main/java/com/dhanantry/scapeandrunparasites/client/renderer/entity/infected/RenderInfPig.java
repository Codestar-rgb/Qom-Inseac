...
public class RenderInfPig extends RenderSRP<EntityInfPig> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("srparasites:textures/entity/monster/pig.png");
