...
public class RenderEntityBodyModel extends Render<EntityBodyModel> {
   public static final ResourceLocation TDODSIVH = new ResourceLocation("srparasites:textures/entity/monster/dodsivh.png");
   public static final ResourceLocation STEXTURE = new ResourceLocation("srparasites:textures/entity/monster/sdodivhead.png");
   ...
   protected void renderModel(
      EntityBodyModel entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor
   ) {
