...
public class DistortedItemHighlightOverlayHandler {
   ...
   public DistortedItemHighlightOverlayHandler() {
      try {
         ...
         SRPMain.logger.error("Failed to resolve item highlight fields.", var2);
         GuiDistortionHelper.itemHighlightHookAvailable = false;
      }
   }

   @SubscribeEvent
   public void onRenderHotbarPre(Pre event) {
            ...
            if (this.remainingHighlightTicksField != null && this.highlightingItemStackField != null) {
               ...
               if (mc != null && mc.field_71456_v != null) {
                  try {
                     ...
                     GuiDistortionHelper.itemHighlightHookAvailable = false;
                     SRPMain.logger.error("Failed to suppress vanilla item highlight text.", var5);
                  }
               }
            }
         }
   ...
   @SubscribeEvent
   public void onRenderHotbarPost(Post event) {
      if (event.getType() == ElementType.ALL) {
            ...
            if (mc != null && mc.field_71456_v != null && mc.field_71466_p != null) {
               try {
                  ...
                  if (alpha > 0) {
                     ...
                     mc.field_71466_p.func_175063_a(s, x, y, argb);
                  ...
                  GuiDistortionHelper.itemHighlightHookAvailable = false;
                  SRPMain.logger.error("Failed to draw distorted item highlight text.", var15);
                  return;
               } finally {
                  this.resetFrameState();
               }
