...
import com.dhanantry.scapeandrunparasites.client.gui.GuiSRPConfigEdit;
...
extends GuiSlot {
    ...
    public SRPConfigList(GuiSRPConfigView screen, Minecraft mc, int width, int height, int topIn, int bottomIn, int slotHeightIn, List<Entry> entries) {
    ...
    private String ellipsizeToWidth(String s, int maxPx) {
        ...
        String plain = SRPConfigList.stripFormatting(s);
    ...
    protected void func_148144_a(int index, boolean doubleClick, int mouseX, int mouseY) {
        ...
        this.field_148161_k.func_147108_a((GuiScreen)new GuiSRPConfigEdit(this.screen, e));
    }
    ...
    private static String prettifyCategoryName(String raw) {
        ...
        String s = raw;
        if (s.startsWith("srparasites:")) {
            s = s.substring("srparasites:".length());
        }
        s = s.replace('.', ' ');
    ...
    protected void func_192637_a(int idx, int right, int top, int height, int mouseX, int mouseY, float partialTicks) {
        ...
        if (e.header) {
            String pretty = SRPConfigList.prettifyCategoryName(e.headerText);
            ...
            int textW = this.field_148161_k.field_71466_p.func_78256_a(SRPConfigList.stripFormatting(headerDraw));
        ...
        int w = this.field_148161_k.field_71466_p.func_78256_a(SRPConfigList.stripFormatting(rightText));
