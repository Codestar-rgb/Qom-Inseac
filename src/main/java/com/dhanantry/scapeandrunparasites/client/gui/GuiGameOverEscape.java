...
extends GuiGameOver {
    ...
    public void func_73866_w_() {
        ...
        if (EscapeClientState.OFFER) {
            ...
            String label = I18n.func_74838_a((String)"gui.srparasites.escape_button") + min + "-" + max + " " + I18n.func_74838_a((String)"gui.srparasites.escape_button_blocks");
    ...
    protected void func_146284_a(GuiButton button) throws IOException {
        if (button.field_146127_k == 911) {
            SRPNetwork.CHANNEL.sendToServer((IMessage)new C2SRequestEscape());
