...
public class MsgSpawnPureParticles implements IMessage {
   public double x;
   public double y;
   public double z;
   public int count;
      ...
      public static void handleClient(MsgSpawnPureParticles msg) {
         Minecraft.func_71410_x().func_152344_a(() -> {
            if (Minecraft.func_71410_x().field_71441_e != null) {
               SRPParticleRegistry.spawnPureBurst(Minecraft.func_71410_x().field_71441_e, msg.x, msg.y, msg.z, msg.count, msg.kind);
            }
         });
      }
   }

   public static class Handler implements IMessageHandler<MsgSpawnPureParticles, IMessage> {
      public IMessage onMessage(MsgSpawnPureParticles msg, MessageContext ctx) {
         if (ctx.side == Side.CLIENT) {
            MsgSpawnPureParticles.ClientHandler.handleClient(msg);
         }
