...
public class SRPCommandOrigin implements ICommand {
   ...
   public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] argString) throws CommandException {
      ...
      if (!world.field_72995_K) {
         if (!SRPConfigWorld.originActivated) {
            sender.func_145747_a(new TextComponentString("Emerging Infestation Vector are not activated"));
            return;
         }
         ...
         if (argString[0].equals("clearworld")) {
            ...
            sender.func_145747_a(new TextComponentString("There are no longer Emerging Infestation Vectors in this world"));
            return;
         }

         if (argString.length != 6) {
            sender.func_145747_a(new TextComponentString("Invalid argument."));
            sender.func_145747_a(new TextComponentString("To set an Emerging Infestation Vector type [x y z health radius]."));
            return;
         }
         ...
         try {
            ...
            sender.func_145747_a(new TextComponentString("Invalid arguments"));
            return;
         }
            ...
            switch (ParasiteEventWorld.placeOriginInWorld(world, new BlockPos(x, y, z), h, a)) {
               case 1:
                  sender.func_145747_a(
                     new TextComponentString("Emerging Infestation Vector placed at " + x + " " + y + " " + z + " with " + h + " health and " + a + " radius")
                  );
                  break;
               case 2:
                  sender.func_145747_a(
                     new TextComponentString(
                        "Emerging Infestation Vector type Outbreak placed at " + x + " " + y + " " + z + " with " + h + " health and " + a + " radius"
                     )
                  );
                  break;
               case 3:
                  sender.func_145747_a(new TextComponentString("Emerging Infestation Vectors are not activated"));
                  break;
               case 4:
               case 5:
               default:
                  sender.func_145747_a(new TextComponentString("Unknown - EIV "));
                  break;
               case 6:
                  sender.func_145747_a(new TextComponentString("Emerging Infestation Vector too close to another EIV "));
                  break;
               case 7:
                  sender.func_145747_a(new TextComponentString("Maximum number of Emerging Infestation Vector reached "));
            }
         ...
         if (argString[0].equals("removevector")) {
            if (ParasiteEventWorld.removeOriginInWorld(world, new BlockPos(x, y, z))) {
               sender.func_145747_a(new TextComponentString("Emerging Infestation Vector removed at " + x + " " + y + " " + z));
            } else {
               sender.func_145747_a(new TextComponentString("Emerging Infestation Vector cannot be removed at " + x + " " + y + " " + z));
            }
