...
public class WeaponMeleeCleaver extends WeaponToolMeleeBase {
   public WeaponMeleeCleaver(ToolMaterial material, String name, double attackspeed, float range, float attackD, boolean fear, byte id) {
   ...
   @Override
   public Item getNext() {
      return this == SRPItems.weapon_cleaver ? SRPItems.weapon_cleaverSentient : null;
   }
