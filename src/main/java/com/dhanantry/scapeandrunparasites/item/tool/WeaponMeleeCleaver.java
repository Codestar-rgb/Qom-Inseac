...
public class WeaponMeleeCleaver
extends WeaponToolMeleeBase {
    public WeaponMeleeCleaver(Item.ToolMaterial material, String name, double attackspeed, float range, float attackD, boolean fear, byte id) {
    ...
    @Override
    public Item getNext() {
        if (this == SRPItems.weapon_cleaver) {
            return SRPItems.weapon_cleaverSentient;
        }
        return null;
    }
    ...
    public boolean func_77644_a(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (flag) {
            ...
            if (attacker.field_70170_p.field_73012_v.nextDouble() < chance) {
                SRPPotions.applyStackPotion(SRPPotions.VIRA_E, target, 100, amp);
            }
        }
        return flag;
    }
