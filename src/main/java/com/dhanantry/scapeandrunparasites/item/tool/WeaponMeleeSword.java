...
public class WeaponMeleeSword extends WeaponToolMeleeBase {
   public WeaponMeleeSword(ToolMaterial material, String name, double attackspeed, float range, float attackD, boolean fear, byte id) {
   ...
   @Override
   public Item getNext() {
      return this == SRPItems.weapon_sword ? SRPItems.weapon_swordSentient : null;
   }
