...
implements IHaveReach {
    ...
    public void func_77663_a(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        ...
        if (!worldIn.field_72995_K) {
            if (this.calling && SRPConfigSystems.useScent && worldIn.field_73012_v.nextInt(100) == 0 && entityIn.field_70173_aa % 40 == 0 && SRPSaveData.get(worldIn, 222).getDeveLevel() >= SRPConfigSystems.deveScentUse) {
