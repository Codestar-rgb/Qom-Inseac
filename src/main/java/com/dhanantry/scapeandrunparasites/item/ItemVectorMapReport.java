...
public class ItemVectorMapReport
extends Item {
    ...
    private void openGui(ItemStack stack) {
        Minecraft.func_71410_x().func_147108_a((GuiScreen)new GuiVectorMapReport(stack));
    }
    ...
    public void func_77624_a(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFormatting.GRAY + I18n.func_135052_a((String)"tooltip.srparasites.vector_map", (Object[])new Object[0]));
        ...
        if (tag != null && tag.func_74764_b(NBT_PRINT_DAY)) {
            ...
            tooltip.add(TextFormatting.DARK_GRAY + I18n.func_135052_a((String)"tooltip.srparasites.printed", (Object[])new Object[]{day, time}));
        }
    }
