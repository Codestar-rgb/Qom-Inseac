...
extends ItemArmor {
    ...
    public static final ItemArmor.ArmorMaterial HIJACKED_MAT = EnumHelper.addArmorMaterial((String)"HIJACKED", (String)"srparasites:hijacked_iron", (int)40, (int[])new int[]{4, 7, 9, 4}, (int)15, (SoundEvent)SRPSounds.FLESH_GROW, (float)3.0f);

    public SRPArmorSetBase(String registryName, ItemArmor.ArmorMaterial material, EntityEquipmentSlot slot, String setKey) {
    ...
    public SRPArmorSetBase(String registryName) {
        this(registryName, SRPArmorSetBase.inferMaterial(registryName), SRPArmorSetBase.inferSlot(registryName), SRPArmorSetBase.inferSetKey(registryName));
    }
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {
        ...
        if (SRPArmorSetBase.isWearingFullSet(player, this.setKey) && player.func_70644_a(SRPPotions.BLEED_E)) {
    ...
    public static boolean isWearingFullSet(EntityPlayer player, String setKey) {
        ...
        for (ItemStack st : armor) {
            ...
            if (((SRPArmorSetBase)st.func_77973_b()).setKey.equals(setKey)) continue;
            return false;
        }
        return true;
    }
    ...
    public static String getAnySetKey(EntityPlayer p) {
        ...
        if (!feet.func_190926_b() && feet.func_77973_b() instanceof SRPArmorSetBase) {
            return ((SRPArmorSetBase)feet.func_77973_b()).getSetKey();
        }
        return "";
    }
    ...
    private static int getBootsCD(EntityPlayer p) {
        return SRPArmorSetBase.getCDTag(p).func_74762_e(NBT_BOOT_CD);
    }

    private static int getSetCD(EntityPlayer p) {
        return SRPArmorSetBase.getCDTag(p).func_74762_e(NBT_SET_CD);
    }

    private static void setBootsCD(EntityPlayer p, int v) {
        NBTTagCompound t = SRPArmorSetBase.getCDTag(p);
    ...
    public static void onLivingHurt(LivingHurtEvent e) {
        ...
        if (SRPArmorSetBase.isFireDamage(e.getSource()) && (mult = (float)Math.max(0.0, SRPConfigSystems.hijackedArmorFireMult)) != 1.0f) {
    ...
    public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        SRPArmorSetBase bootsItem;
        Minecraft mc = Minecraft.func_71410_x();
        EntityPlayerSP client = mc.field_71439_g;
        if (SRPArmorSetBase.isHijackedSetKey(this.getSetKey())) {
            tooltip.add(TextFormatting.AQUA + I18n.func_135052_a((String)"tooltip.srparasites.hijacked.fullset_bleed", (Object[])new Object[0]));
            tooltip.add(TextFormatting.RED + I18n.func_135052_a((String)"tooltip.srparasites.hijacked.fire_penalty", (Object[])new Object[]{String.format(Locale.ROOT, "%.2f", SRPConfigSystems.hijackedArmorFireMult)}));
            tooltip.add(TextFormatting.BLUE + I18n.func_135052_a((String)"tooltip.srparasites.hijacked.boots_save", (Object[])new Object[0]));
        }
        if (client == null) {
            return;
        }
        ItemStack feet = client.func_184582_a(EntityEquipmentSlot.FEET);
        if (!feet.func_190926_b() && feet.func_77973_b() instanceof SRPArmorSetBase && SRPArmorSetBase.isHijackedSetKey((bootsItem = (SRPArmorSetBase)feet.func_77973_b()).getSetKey()) && bootsItem.getSetKey().equals(this.getSetKey())) {
            int bootCd = SRPArmorSetBase.getBootsCD((EntityPlayer)client);
            if (bootCd > 0) {
                tooltip.add(TextFormatting.BLUE + I18n.func_135052_a((String)"tooltip.srparasites.hijacked.boots_cd", (Object[])new Object[]{SRPArmorSetBase.formatTicks(bootCd)}));
            } else {
                tooltip.add(TextFormatting.BLUE + I18n.func_135052_a((String)"tooltip.srparasites.ready", (Object[])new Object[0]));
            }
        }
    }
    ...
    public static class Events {
        ...
        public static void onLivingUpdate(LivingEvent.LivingUpdateEvent e) {
            ...
            int boot = cd.func_74762_e(SRPArmorSetBase.NBT_BOOT_CD);
            int set = cd.func_74762_e(SRPArmorSetBase.NBT_SET_CD);
            if (boot > 0) {
                cd.func_74768_a(SRPArmorSetBase.NBT_BOOT_CD, boot - 1);
            }
            if (set > 0) {
                cd.func_74768_a(SRPArmorSetBase.NBT_SET_CD, set - 1);
            }
            ...
            if (SRPArmorSetBase.isHijackedSetKey(key = SRPArmorSetBase.getAnySetKey(p)) && SRPArmorSetBase.isWearingFullSet(p, key)) {
                hasFullHijackedSet = true;
            }
            if (cd.func_74764_b(SRPArmorSetBase.NBT_BOOT_CD) && cd.func_74762_e(SRPArmorSetBase.NBT_BOOT_CD) == 0 && !cd.func_74767_n(SRPArmorSetBase.NBT_BOOT_READY) && hasHijackedBoots) {
                cd.func_74757_a(SRPArmorSetBase.NBT_BOOT_READY, true);
                p.field_70170_p.func_184133_a(null, p.func_180425_c(), SoundEvents.field_187839_fV, SoundCategory.PLAYERS, 0.5f, 1.5f);
            }
            if (cd.func_74764_b(SRPArmorSetBase.NBT_SET_CD) && cd.func_74762_e(SRPArmorSetBase.NBT_SET_CD) == 0 && !cd.func_74767_n(SRPArmorSetBase.NBT_SET_READY) && hasFullHijackedSet) {
                cd.func_74757_a(SRPArmorSetBase.NBT_SET_READY, true);
        ...
        public static void onLivingFall(LivingFallEvent e) {
            ...
            SRPArmorSetBase.bloodImpact(p.field_70170_p, (Entity)p);
            SRPArmorSetBase.applyCrashDebuffs((EntityLivingBase)p);
