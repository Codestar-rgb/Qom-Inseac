...
extends Item {
    ...
    public void func_77663_a(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        if (!worldIn.field_72995_K && entityIn.field_70173_aa % 20 == 0) {
            ...
            if (posss != null) {
                SRPMain.network.sendToAll((IMessage)new SRPPacketCompass(posss.func_177958_n(), posss.func_177956_o(), posss.func_177952_p(), this.type));
            } else {
                SRPMain.network.sendToAll((IMessage)new SRPPacketCompass(worldIn.field_73012_v.nextInt(), worldIn.field_73012_v.nextInt(), worldIn.field_73012_v.nextInt(), this.type));
            }
        }
    }
