...
public class ItemDoorBase extends ItemDoor {
   ...
   public EnumActionResult func_180614_a(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
      if (facing != EnumFacing.UP) {
         ...
         if (player.func_175151_a(pos, facing, itemstack) && this.block.func_176196_c(worldIn, pos)) {
   ...
   public static void placeDoor(World worldIn, BlockPos pos, EnumFacing facing, Block door, boolean isRightHinge) {
      ...
      IBlockState iblockstate = door.func_176223_P()
         .func_177226_a(BlockDoor.field_176520_a, facing)
         .func_177226_a(BlockDoor.field_176521_M, isRightHinge ? EnumHingePosition.RIGHT : EnumHingePosition.LEFT)
         .func_177226_a(BlockDoor.field_176522_N, flag2)
         .func_177226_a(BlockDoor.field_176519_b, flag2);
      worldIn.func_180501_a(pos, iblockstate.func_177226_a(BlockDoor.field_176523_O, EnumDoorHalf.LOWER), 2);
      worldIn.func_180501_a(blockpos2, iblockstate.func_177226_a(BlockDoor.field_176523_O, EnumDoorHalf.UPPER), 2);
   ...
   public boolean placeBlockAt(
      ...
      if (!world.func_180501_a(pos, newState, 11)) {
         ...
         if (state.func_177230_c() == this.block) {
            ...
            this.block.func_180633_a(world, pos, state, player, stack);
