...
public class BiomeParasiteBoils extends BiomeParasiteBase {
   ...
   public BiomeParasiteBoils() {
      super(new BiomeProperties("Parasite Biome Boils").func_185398_c(0.13F).func_185400_d(0.5F));
   ...
   public int func_76731_a(float currentTemperature) {
      return SRPConfigWorld.biomeTwoSkyColor;
   }

   @SideOnly(Side.CLIENT)
   public int func_180627_b(BlockPos blockPos) {
      return SRPConfigWorld.biomeTwoGrassColor;
   }

   @SideOnly(Side.CLIENT)
   public int func_180625_c(BlockPos blockPos) {
      return SRPConfigWorld.biomeTwoFoliageColor;
   }

   public int getWaterColorMultiplier() {
      return SRPConfigWorld.biomeTwoWaterColor;
   }

   @Override
   public float getRedValue() {
      return SRPConfigWorld.biomeTwoFogRed / 255.0F;
   }

   @Override
   public float getGreenValue() {
      return SRPConfigWorld.biomeTwoFogGreen / 255.0F;
   }

   @Override
   public float getBlueValue() {
      return SRPConfigWorld.biomeTwoFogBlue / 255.0F;
   }
