...
extends WorldSavedData {
    ...
    private static SRPWorldData clientInstance;
    ...
    public void checkHeartExistance(World worldIn) {
        for (int i = 0; i < this.nodeX.size(); ++i) {
            ...
            if (!worldIn.func_175697_a(pos, 3) || worldIn.func_180495_p(pos).func_177230_c() == SRPBlocks.BiomeHeart) continue;
    ...
    public void checkColonyExistance(World worldIn) {
        for (int i = 0; i < this.colonyX.size(); ++i) {
            ...
            if (!worldIn.func_175697_a(pos, 3) || worldIn.func_180495_p(pos).func_177230_c() == SRPBlocks.ColonyHeart) continue;
