...
public class HarlequinRockBushGen implements IWorldGenerator {
   ...
   public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
      if (!world.field_72995_K) {
         ...
         if (ws.field_73011_w.getDimension() == 0) {
            ...
            int bz = (chunkZ << 4) + 8 + rand.nextInt(6) - 3;
            BlockPos base = new BlockPos(bx, ws.func_175645_m(new BlockPos(bx, 0, bz)).func_177956_o(), bz);
      ...
      if (surface != null) {
         if (this.flatEnough(ws, surface, 7, 3)) {
            ...
            if (tpl != null) {
               ...
               tpl.func_186253_b(ws, placeAt, settings);
            }
         }
      }
   }
   ...
   private BlockPos findSurface(WorldServer ws, BlockPos xz) {
      ...
      if (!this.isGoodGround(below)) {
         ...
         return this.isBadTop(ws, pos) ? null : pos;
      }
   }
