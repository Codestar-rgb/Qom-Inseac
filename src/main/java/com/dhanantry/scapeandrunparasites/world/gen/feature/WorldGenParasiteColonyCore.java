...
extends WorldGenParasiteColonyBase {
    ...
    public boolean func_180709_b(World worldIn, Random rand, BlockPos posss) {
        ...
        for (int i2 = 0; i2 < height; ++i2) {
            ...
            int hx2 = xx - tic;
            int hz2 = zz - tic;
            this.generateCircle(SRPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.FLESH)), Blocks.field_189880_di.func_176223_P(), worldIn, worldIn.field_73012_v, posss, hx2, hz2, 1, 20000, 6);
        ...
        this.generateSphere(worldIn, posss, 8, 6, rand, false, 6, false, 2, 1, 5, SRPBlocks.ParasiteRubble.func_176223_P().func_177226_a(BlockParasiteRubble.VARIANT, (Comparable)((Object)BlockParasiteRubble.EnumType.FLESH)), SRPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.FLESH)), Blocks.field_150350_a.func_176223_P(), missing);
    ...
    private void placeCore(World worldIn, BlockPos pos, int stage) {
        this.func_175903_a(worldIn, pos, SRPBlocks.ColonyHeart.func_176223_P().func_177226_a((IProperty)BlockColonyCore.ACTIVE, (Comparable)Integer.valueOf(stage)));
    }
}
