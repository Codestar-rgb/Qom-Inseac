...
public class WorldGenParasiteColonyB1 extends WorldGenParasiteColonyBase {
   ...
   public boolean func_180709_b(World worldIn, Random rand, BlockPos posss) {
      ...
      this.generateDNAHelix(Blocks.field_189880_di.func_176223_P(), worldIn, worldIn.field_73012_v, posss.func_177979_c(4), zz - 2, 2, 11 + bonusH);
      ...
      this.generateDNAHelix(Blocks.field_189880_di.func_176223_P(), worldIn, worldIn.field_73012_v, posss.func_177979_c(2), zz - 2, 2, 11 + bonusH);
      return true;
   }
}
