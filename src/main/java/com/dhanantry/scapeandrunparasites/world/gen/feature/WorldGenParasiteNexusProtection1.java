...
public class WorldGenParasiteNexusProtection1 extends WorldGenParasiteColonyBase {
   ...
   public boolean func_180709_b(World worldIn, Random rand, BlockPos posss) {
      ...
      this.replaceCircleGround(
         worldIn, posss, 8, SRPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, BlockParasiteStain.EnumType.FEELER)
      );
      return true;
   }
}
