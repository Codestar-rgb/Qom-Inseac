...
extends WorldGenParasiteColonyBase {
    ...
    public boolean func_180709_b(World worldIn, Random rand, BlockPos posss) {
        ...
        for (int i = 0; i < 20; ++i) {
            this.replaceCircleGround(worldIn, enter.func_177981_b(i), this.type * 7, SRPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.RED)));
        }
        int rad = this.type;
        ...
        IBlockState rim = SRPBlocks.ParasiteRubbleDense.func_176223_P().func_177226_a(BlockParasiteRubbleDense.VARIANT, (Comparable)((Object)BlockParasiteRubbleDense.EnumType.WALL));
        IBlockState rubble = SRPBlocks.ParasiteRubble.func_176223_P().func_177226_a(BlockParasiteRubble.VARIANT, (Comparable)((Object)BlockParasiteRubble.EnumType.BRICKS));
        IBlockState stainRed = SRPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.RED));
            ...
            for (int l2 = -1 * BGrange; l2 <= 1 * BGrange; ++l2) {
                for (int j = -1 * BGrange; j <= 1 * BGrange; ++j) {
                    ...
                    if (rand.nextInt(rollRare) == 0) {
                        this.placeLoot(worldIn, blockpos, SRPConfigWorld.blockLootRare, SRPBlocks.ParasiteLoot.func_176223_P().func_177226_a(BlockParasiteLoot.VARIANT, (Comparable)((Object)BlockParasiteLoot.EnumType.RARE)));
                        worldIn.func_175656_a(blockpos.func_177984_a(), SRPBlocks.DeadBlood.func_176223_P());
                        continue;
                    }
                    if (rand.nextInt(rollUncommon) == 0) {
                        this.placeLoot(worldIn, blockpos, SRPConfigWorld.blockLootUncommon, SRPBlocks.ParasiteLoot.func_176223_P().func_177226_a(BlockParasiteLoot.VARIANT, (Comparable)((Object)BlockParasiteLoot.EnumType.UNCOMMON)));
                        worldIn.func_175656_a(blockpos.func_177984_a(), SRPBlocks.DeadBlood.func_176223_P());
                        continue;
                    }
                    this.placeLoot(worldIn, blockpos, SRPConfigWorld.blockLootCommon, SRPBlocks.ParasiteLoot.func_176223_P().func_177226_a(BlockParasiteLoot.VARIANT, (Comparable)((Object)BlockParasiteLoot.EnumType.COMMON)));
                    worldIn.func_175656_a(blockpos.func_177984_a(), SRPBlocks.DeadBlood.func_176223_P());
                }
            }
        }
