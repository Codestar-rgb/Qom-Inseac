...
public class BiomeUpdateQueue {
    ...
    public static Map<Integer, List<SRPPacketBiomeChangeBatch.Entry>> buildBatches(Deque<BiomeUpdate> drained) {
        HashMap<Integer, List<SRPPacketBiomeChangeBatch.Entry>> batches = new HashMap<Integer, List<SRPPacketBiomeChangeBatch.Entry>>();
