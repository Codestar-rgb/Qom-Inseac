      ...
      if (event.getEntityLiving() instanceof EntityPlayerMP) {
         if (!event.getEntityLiving().field_70170_p.field_72995_K) {
            ...
            if (trueSrc instanceof EntityPlayerMP) {
               ...
               if (tag.func_74764_b("srpFearApplier")) {
                  if (killer.func_110124_au().toString().equals(tag.func_74779_i("srpFearApplier"))) {
                     long until = tag.func_74763_f("srpFearUntil");
                        ...
                        if (victim.func_70644_a(SRPPotions.FEAR_E)) {
                           ...
                           if (adv != null) {
                              ...
                              if (!prog.func_192105_a()) {
                                 prog.func_192109_a("kill_fear_splashed");
                              }

                              tag.func_82580_o("srpFearApplier");
                              tag.func_82580_o("srpFearUntil");
                           }
                        }
                     }
                  }
