...
extends BlockBase {
    ...
    private boolean tooManyNeighborPlants(World world, BlockPos pos) {
        ...
        for (EnumFacing f : EnumFacing.values()) {
            if (world.func_180495_p(pos.func_177972_a(f)).func_177230_c() != SRPBlocks.ResiduePlants || ++count < 2) continue;
            return true;
        }
        return false;
    }
    ...
    public void func_180650_b(World world, BlockPos pos, IBlockState state, Random rand) {
        ...
        for (int tries = 0; tries < 3; ++tries) {
            ...
            if (!world.func_175623_d(plantPos) || this.tooManyNeighborPlants(world, plantPos) || !SRPBlocks.ResiduePlants.func_176198_a(world, plantPos, face)) continue;
            IBlockState plantState = SRPBlocks.ResiduePlants.func_176223_P().func_177226_a((IProperty)BlockResiduePlants.FACING, (Comparable)face);
