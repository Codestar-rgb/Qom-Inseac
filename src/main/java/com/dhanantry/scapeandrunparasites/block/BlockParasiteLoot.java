...
implements IMetaName {
    ...
    public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (te instanceof TileEntityParasiteLoot) {
            player.openGui((Object)SRPMain.instance, 101, world, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
            return true;
        }
        return false;
    }
    ...
    public void func_190948_a(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag flag) {
        tooltip.add(TextFormatting.GREEN + I18n.func_135052_a((String)"tooltip.srparasites.parasite_loot", (Object[])new Object[0]));
    }
