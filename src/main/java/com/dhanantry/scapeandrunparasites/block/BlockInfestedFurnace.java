...
public class BlockInfestedFurnace extends BlockContainer {
   ...
   public BlockInfestedFurnace() {
      ...
      this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a(BlockHorizontal.field_185512_D, EnumFacing.NORTH).func_177226_a(LIT, Boolean.FALSE));
   }
   ...
   public static void setLitState(boolean active, World world, BlockPos pos) {
      ...
      if (state.func_177230_c() instanceof BlockInfestedFurnace) {
         boolean currentlyLit = (Boolean)state.func_177229_b(LIT);
         if (currentlyLit != active) {
            ...
            if (DEBUG) {
               System.out
                  .println(
                     "[InfestedFurnace] setLitState pos="
                        + pos
                        + " "
                        + currentlyLit
                        + " -> "
            ...
            world.func_180501_a(pos, state.func_177226_a(LIT, active), 3);
            if (te != null) {
               te.func_145829_t();
   ...
   public int getLightValue(IBlockState state, IBlockAccess world, BlockPos pos) {
      return state.func_177229_b(LIT) ? 14 : 0;
   }
   ...
   public boolean func_180639_a(
      ...
      if (DEBUG) {
         System.out
            .println(
               "[InfestedFurnace] onBlockActivated side="
                  + (worldIn.field_72995_K ? "CLIENT" : "SERVER")
                  + " pos="
                  + pos
                  + " hand="
                  + hand
                  + " sneaking="
                  + playerIn.func_70093_af()
                  + " held="
                  + playerIn.func_184586_b(hand)
            );
      }
   ...
   public void func_180663_b(World worldIn, BlockPos pos, IBlockState state) {
      if (!keepInventory) {
         ...
         if (te instanceof IInventory) {
            InventoryHelper.func_180175_a(worldIn, pos, (IInventory)te);
   ...
   public IBlockState getStateForPlacement(
      ...
      return this.func_176223_P().func_177226_a(BlockHorizontal.field_185512_D, placer.func_174811_aO().func_176734_d()).func_177226_a(LIT, Boolean.FALSE);
   }
   ...
   protected BlockStateContainer func_180661_e() {
      return new BlockStateContainer(this, new IProperty[]{BlockHorizontal.field_185512_D, LIT});
   }

   public IBlockState func_176203_a(int meta) {
      EnumFacing enumfacing = EnumFacing.func_82600_a(meta & 7);
      if (enumfacing.func_176740_k() == Axis.Y) {
         enumfacing = EnumFacing.NORTH;
      }

      boolean lit = (meta & 8) != 0;
      return this.func_176223_P().func_177226_a(BlockHorizontal.field_185512_D, enumfacing).func_177226_a(LIT, lit);
   }

   public int func_176201_c(IBlockState state) {
      int meta = ((EnumFacing)state.func_177229_b(BlockHorizontal.field_185512_D)).func_176745_a();
