...
public class BlockInfestedBush
extends BlockBush
...
IShearable {
    ...
    public BlockInfestedBush(String name, float hardness) {
        ...
        this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a(VARIANT, (Comparable)((Object)EnumType.INFECTED)).func_177226_a((IProperty)NODE, (Comparable)Boolean.FALSE).func_177226_a((IProperty)END, (Comparable)Boolean.FALSE));
    ...
    public boolean func_180671_f(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if ((belowBlock instanceof BlockInfestedBush || belowBlock instanceof BlockParasiteBush) && ("spine".equals(variantName) || "vine".equals(variantName))) {
            ...
            Block curBlock;
            BlockPos base = down;
            for (int guard = 0; guard < 64 && ((curBlock = (cur = worldIn.func_180495_p(base)).func_177230_c()) instanceof BlockInfestedBush || curBlock instanceof BlockParasiteBush); ++guard) {
            ...
            return support.isSideSolid((IBlockAccess)worldIn, base, EnumFacing.UP);
        }
        ...
        return support.isSideSolid((IBlockAccess)worldIn, down, EnumFacing.UP);
    }
    ...
    public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (BlockInfestedBush.isRawMeat(held)) {
            if (!world.field_72995_K) {
                int meta = this.func_176201_c(state);
                Item itemBlock = Item.func_150898_a((Block)this);
                if (itemBlock != null) {
                    BlockInfestedBush.func_180635_a((World)world, (BlockPos)pos.func_177984_a(), (ItemStack)new ItemStack(itemBlock, 1, meta));
                }
    ...
    public boolean func_176196_c(World worldIn, BlockPos pos) {
        ...
        if (below.func_177230_c() instanceof BlockInfestedBush || below.func_177230_c() instanceof BlockParasiteBush) {
            ...
            if (v == EnumType.SPINE || v == EnumType.VINE) {
                BlockPos base = pos.func_177977_b();
                for (int guard = 0; (worldIn.func_180495_p(base).func_177230_c() instanceof BlockInfestedBush || worldIn.func_180495_p(base).func_177230_c() instanceof BlockParasiteBush) && guard < 64; ++guard) {
                    base = base.func_177977_b();
                }
    ...
    protected boolean checkBushV(IBlockState state) {
        ...
        if (state.func_177230_c() == this) {
            return state.func_177229_b(VARIANT) == EnumType.SPINE || state.func_177229_b(VARIANT) == EnumType.VINE;
        }
        return false;
    }
    ...
    public void func_189540_a(IBlockState state, World world, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        if (fromPos.equals((Object)pos.func_177977_b()) || this.isVariant(state, "spine")) {
    ...
    private boolean isSameVariantAbove(IBlockAccess world, BlockPos pos, IBlockState here, String variantName) {
        ...
        Comparable v = above.func_177229_b(VARIANT);
    ...
    public IBlockState func_176221_a(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        if (this.isVariant(state, "grass1")) {
            ...
            IBlockState s;
            BlockPos scan = pos;
            while ((s = world.func_180495_p(down = scan.func_177977_b())).func_177230_c() == this && this.isVariant(s, "spine")) {
                scan = down;
            }
