...
public class BlockBuglin extends BlockBase {
   ...
   public BlockBuglin(String name, float hardness, boolean creative, boolean tickRandom, float resistance) {
      ...
      this.func_149672_a(SRPSoundTypes.TUNNEL);
         ...
         if (worldIn.func_175697_a(pos, 3)) {
            if (worldIn.func_175659_aa() != EnumDifficulty.PEACEFUL) {
               if (SRPConfigMobs.lodoEnabled) {
                  ...
                  List<EntityParasiteBase> moblist = worldIn.func_72872_a(EntityLodo.class, axisalignedbb);
                  if (moblist.isEmpty()) {
                     ...
                     if (moblist.size() <= 10) {
                        ...
                        l222.func_70107_b(pos.func_177958_n() + 0.5, pos.func_177956_o(), pos.func_177952_p() + 0.5);
                        l222.setFloorTimer();
                        worldIn.func_72838_d(l222);
                        worldIn.func_72960_a(l222, (byte)50);
                     }
                  }
               }
            }
   ...
   protected boolean canBlockStay(World worldIn, BlockPos pos) {
      ...
      return below.isSideSolid(worldIn, down, EnumFacing.UP);
   }
   ...
   public void func_180663_b(World worldIn, BlockPos pos, IBlockState state) {
      if (!worldIn.field_72995_K && worldIn.func_175697_a(pos, 1) && worldIn.func_175659_aa() != EnumDifficulty.PEACEFUL) {
         Entity ent = EntityList.func_188429_b(new ResourceLocation("srparasites", "buglin"), worldIn);
         if (ent != null) {
            ent.func_70107_b(pos.func_177958_n() + 0.5, pos.func_177956_o(), pos.func_177952_p() + 0.5);
