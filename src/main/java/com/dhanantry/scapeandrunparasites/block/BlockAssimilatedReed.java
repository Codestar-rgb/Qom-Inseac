...
public class BlockAssimilatedReed extends BlockBushBase {
   ...
   private static final Fluid DEADBLOOD = FluidRegistry.getFluid("deadblood");
   ...
   public BlockAssimilatedReed(String name, float hardness, boolean creative, boolean tickRandom) {
      ...
      this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a(AGE, 0));
   }
   ...
   public boolean func_176196_c(World world, BlockPos pos) {
      ...
      return below.func_177230_c() == this ? true : isValidBaseBlock(below) && hasAdjacentGrowthFluid(world, pos.func_177977_b());
   }
   ...
   private static boolean isValidBaseBlock(IBlockState state) {
   ...
   private static boolean hasAdjacentGrowthFluid(World world, BlockPos base) {
      for (EnumFacing f : EnumFacing.field_176754_o) {
         ...
         Fluid neighbor = FluidRegistry.lookupFluidForBlock(st.func_177230_c());
         if (neighbor != null
            && (DEADBLOOD != null && neighbor == DEADBLOOD || "deadblood".equals(neighbor.getName()) || "srparasites:deadblood".equals(neighbor.getName()))) {
            return true;
         }
      }
            ...
            if (world.func_175623_d(pos.func_177984_a())) {
               ...
               if (height < 7) {
                  ...
                  if (age >= 15) {
                     ...
                     world.func_180501_a(pos, state.func_177226_a(AGE, 0), 4);
                  } else {
                     world.func_180501_a(pos, state.func_177226_a(AGE, age + 1), 4);
                  }
               }
            }
         }
   ...
   public int func_176201_c(IBlockState state) {
      return (Integer)state.func_177229_b(AGE);
   }
   ...
   public IBlockState func_176203_a(int meta) {
      ...
      return this.func_176223_P().func_177226_a(AGE, meta);
   }
