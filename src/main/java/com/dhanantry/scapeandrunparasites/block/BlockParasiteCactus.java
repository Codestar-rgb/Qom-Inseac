...
public class BlockParasiteCactus
extends BlockCactus {
    ...
    public boolean func_176586_d(World worldIn, BlockPos pos) {
        ...
        if (downState.func_177230_c() == Blocks.field_150354_m || downState.func_177230_c() == Blocks.field_180395_cM || downState.func_177230_c() == SRPBlocks.InfestedSand || downState.func_177230_c() == this) {
            for (EnumFacing f : EnumFacing.Plane.HORIZONTAL) {
                IBlockState side = worldIn.func_180495_p(pos.func_177972_a(f));
                if (!side.func_185904_a().func_76220_a() || side.func_177230_c() == this) continue;
                return false;
            }
            return true;
        }
    ...
    public void func_180634_a(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
        ...
        if (now - (last = player.getEntityData().func_74763_f(NBT_PCACTUS_LAST_PUSH)) < 8L) {
            return;
        }
        player.getEntityData().func_74772_a(NBT_PCACTUS_LAST_PUSH, now);
        ...
        player.func_70024_g((dx /= mag) * 0.35, 0.08, (dz /= mag) * 0.35);
