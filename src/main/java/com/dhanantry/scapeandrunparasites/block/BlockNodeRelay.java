...
public class BlockNodeRelay extends Block {
   ...
   public boolean func_180639_a(
      ...
      if (world.field_72995_K) {
         ...
         if (te instanceof TileEntityNodeRelay) {
            BlockPos controllerPos = ((TileEntityNodeRelay)te).getControllerPos();
            if (controllerPos != null) {
               player.openGui("srparasites", 0, world, controllerPos.func_177958_n(), controllerPos.func_177956_o(), controllerPos.func_177952_p());
               return true;
            }
         }
   ...
   private void tryDismantle(World world, BlockPos nodePos, @Nullable EntityPlayer player) {
      if (!world.field_72995_K) {
         ...
         if (te instanceof TileEntityNodeRelay) {
            ...
            if (ctrlPos != null && world.func_175667_e(ctrlPos)) {
               TileEntity cte = world.func_175625_s(ctrlPos);
               if (cte instanceof TileEntityRelayController) {
            ...
            if (controller != null) {
               ...
               player.func_146105_b(new TextComponentString("Relay controller missing or unloaded."), true);
            }
         }
      }
   }
