...
public class TileEntityParasiteBarrier extends TileEntity implements ITickable {
   ...
   public void func_73660_a() {
      if (this.field_145850_b != null) {
         ...
         } else if (this.field_145850_b.func_82737_E() % 2L == 0L) {
            int[] bb = this.currentWorldBounds();
            AxisAlignedBB search = new AxisAlignedBB(bb[0] - 48, 0.0, bb[2] - 48, bb[1] + 48, this.field_145850_b.func_72800_K(), bb[3] + 48);

            for (EntityLiving attacker : this.field_145850_b.func_72872_a(EntityLiving.class, search)) {
               this.clearCrossFactionAggroIfTargetInside(attacker, bb);
            }

            List<Entity> list = this.field_145850_b.func_175647_a(Entity.class, search, this::isSRP);
            if (list.isEmpty()) {
   ...
   public void scrubMobsAroundField() {
      if (this.field_145850_b != null && !this.field_145850_b.field_72995_K) {
         ...
         for (Entity e : this.field_145850_b.func_175647_a(Entity.class, search, this::isSRP)) {
            this.clearAggroIfTargetInside(e, bb);
            this.clearPathIfTouchesInside(e, bb);
         }
      }
   ...
   private void clearCrossFactionAggroIfTargetInside(EntityLiving attacker, int[] bb) {
      ...
      if (tgt != null) {
         boolean targetInside = tgt.field_70165_t >= bb[0] && tgt.field_70165_t <= bb[1] && tgt.field_70161_v >= bb[2] && tgt.field_70161_v <= bb[3];
         if (targetInside) {
            boolean attackerIsSRP = this.isSRP(attacker);
            boolean targetIsSRP = this.isSRP(tgt);
         ...
         if (el.func_70661_as() != null) {
            ...
            if (path != null) {
               ...
               for (int i = 0; i < n; i++) {
                  ...
                  if (p != null && p.field_75839_a >= bb[0] && p.field_75839_a <= bb[1] && p.field_75838_c >= bb[2] && p.field_75838_c <= bb[3]) {
                     el.func_70661_as().func_75499_g();
                     if (el.func_70638_az() != null && this.isInside(bb, el.func_70638_az())) {
                        el.func_70624_b(null);
                        el.func_70604_c(null);
                     }
   ...
   private void pushOrTeleportOutside(int[] bb, Entity e) {
      ...
      BlockPos top = this.field_145850_b.func_175672_r(new BlockPos(MathHelper.func_76128_c(tx), 0, MathHelper.func_76128_c(tz)));
      double ty = top.func_177956_o() + 0.1;
      ...
      if (p != null) {
         ...
         Predicate<ItemStack> isBarrierItem = st -> {
            if (st != null && !st.func_190926_b()) {
               ...
               return rl != null && "srparasites".equals(rl.func_110624_b()) && "parasite_barrier".equals(rl.func_110623_a());
            } else {
               return false;
            }
         };
         if (isBarrierItem.test(mh) || isBarrierItem.test(oh)) {
            ...
            int R = 48;
            int STEP = 2;
            double y = MathHelper.func_151237_a(p.field_70163_u, 2.0, this.field_145850_b.func_72800_K() - 2);
            int px = MathHelper.func_76128_c(p.field_70165_t);
            int pz = MathHelper.func_76128_c(p.field_70161_v);
            int fromX = MathHelper.func_76125_a(px - 48, minX, maxX);
            int toX = MathHelper.func_76125_a(px + 48, minX, maxX);
            int fromZ = MathHelper.func_76125_a(pz - 48, minZ, maxZ);
            int toZ = MathHelper.func_76125_a(pz + 48, minZ, maxZ);
            double xA = minX + 0.5;
            double xB = maxX + 0.5;
