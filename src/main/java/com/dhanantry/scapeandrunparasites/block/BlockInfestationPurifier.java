...
extends BlockBase {
    ...
    private static final ResourceLocation[] BECKON_IDS = new ResourceLocation[]{new ResourceLocation("srparasites", "beckon_si"), new ResourceLocation("srparasites", "beckon_sii"), new ResourceLocation("srparasites", "beckon_siii"), new ResourceLocation("srparasites", "beckon_siv")};
    ...
    public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!hasDiamond) {
            if (!world.field_72995_K) {
                player.func_146105_b((ITextComponent)new TextComponentTranslation("message.srparasites.purifier_use_diamond", new Object[0]), true);
            }
            return true;
        }
        if (!PurifyMappings.isSrp(belowState)) {
            if (!world.field_72995_K) {
                player.func_146105_b((ITextComponent)new TextComponentTranslation("message.srparasites.purifier_not_over_srp", new Object[0]), true);
            }
            return true;
        }
        if (world.field_72995_K) {
        ...
        if (connectedCount > 0) {
            player.func_146105_b((ITextComponent)new TextComponentTranslation("message.srparasites.purifier_entities_marked", new Object[]{connectedCount}), true);
            return true;
        }
        ...
        if (te instanceof TileEntityInfestationPurifier) {
            ...
            SRPNetwork.CHANNEL.sendToAllAround((IMessage)new MsgSpawnPureParticles(cx, cy, cz, 24, 1), new NetworkRegistry.TargetPoint(world.field_73011_w.getDimension(), cx, cy, cz, 64.0));
            this.spawnStartPulse(world, pos);
            ((TileEntityInfestationPurifier)te).startAt(below, player.func_110124_au());
            player.func_146105_b((ITextComponent)new TextComponentTranslation("message.srparasites.purifier_started", new Object[0]), true);
        }
        return true;
    }
    ...
    private int checkAndGlowConnectedBeckons(final World world, BlockPos pos, BlockPos startSrp) {
        ...
        List _unused = world.func_175647_a(Entity.class, box, (Predicate)new Predicate<Entity>(){
            ...
            public boolean apply(Entity e) {
                ...
                boolean bl = isBeckon = id.equals((Object)new ResourceLocation("srparasites", "beckon_si")) || id.equals((Object)new ResourceLocation("srparasites", "beckon_sii")) || id.equals((Object)new ResourceLocation("srparasites", "beckon_siii")) || id.equals((Object)new ResourceLocation("srparasites", "beckon_siv"));
                if (!isBeckon) {
                    return false;
                }
