...
public class BlockHarleskinnSlab
extends BlockSlab {
    ...
    public BlockHarleskinnSlab(boolean isDouble, String name, String toolClass, int harvestLevel, SoundType soundType, float hardness, float resistance, boolean dropsItems) {
        ...
        IBlockState base = this.field_176227_L.func_177621_b().func_177226_a(VARIANT, (Comparable)((Object)Variant.DEFAULT));
        this.func_180632_j(isDouble ? base : base.func_177226_a((IProperty)field_176554_a, (Comparable)BlockSlab.EnumBlockHalf.BOTTOM));
        this.func_149675_a(true);
        SRPBlocks.SRP_BLOCKS.add((Block)this);
    }

    public BlockHarleskinnSlab(boolean isDouble, String name, String toolClass, int harvestLevel, SoundType soundType, float hardness, float resistance, boolean dropsItems, BlockSlab partnerDouble) {
        ...
        if (!this.doubleSlab) {
            ...
            Item item = (Item)new ItemSlab((Block)this, (BlockSlab)this, this.doublePartner).setRegistryName(Objects.requireNonNull(this.getRegistryName()));
            item.func_77637_a((CreativeTabs)SRPMain.SRP_CREATIVETAB);
    ...
    public IBlockState func_176203_a(int meta) {
        IBlockState s = this.func_176223_P().func_177226_a(VARIANT, (Comparable)((Object)Variant.DEFAULT));
        if (!this.func_176552_j()) {
            s = s.func_177226_a((IProperty)field_176554_a, (Comparable)((meta & 8) != 0 ? BlockSlab.EnumBlockHalf.TOP : BlockSlab.EnumBlockHalf.BOTTOM));
        }
        return s;
    }
    ...
    public Item func_180660_a(IBlockState state, Random rand, int fortune) {
        ...
        return half != null ? Item.func_150898_a((Block)half) : Items.field_190931_a;
    }
    ...
    protected ItemStack func_180643_i(IBlockState state) {
        ...
        BlockSlab half = this.halfForDrops();
        return half != null ? new ItemStack(Item.func_150898_a((Block)half)) : ItemStack.field_190927_a;
    }
    ...
    public void func_180650_b(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (BlockHarleskinnSlab.touchingAnyInfestation(worldIn, pos)) {
