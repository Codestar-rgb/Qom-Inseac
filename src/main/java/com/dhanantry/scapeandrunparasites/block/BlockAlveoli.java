...
public class BlockAlveoli extends BlockBase implements IShearable {
   public static final PropertyBool ACTIVE = PropertyBool.func_177716_a("active");
   public static final PropertyBool DEPLETED = PropertyBool.func_177716_a("depleted");

   public BlockAlveoli() {
      super(Material.field_151571_B, "alveoli", 1.0F, true, true);
      this.func_149672_a(SRPSoundTypes.FLESH);
      this.func_149713_g(0);
      this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a(ACTIVE, Boolean.TRUE).func_177226_a(DEPLETED, Boolean.FALSE));
   }

   protected BlockStateContainer func_180661_e() {
      return new BlockStateContainer(this, new IProperty[]{ACTIVE, DEPLETED});
   }

   public IBlockState func_176203_a(int meta) {
      boolean active = (meta & 1) != 0;
      boolean depleted = (meta & 2) != 0;
      return this.func_176223_P().func_177226_a(ACTIVE, active).func_177226_a(DEPLETED, depleted);
   }
   ...
   public int func_176201_c(IBlockState state) {
      ...
      if ((Boolean)state.func_177229_b(DEPLETED)) {
         m |= 2;
      }
   ...
   public boolean func_180639_a(
      World w, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ
   ) {
      ...
      if (held.func_77973_b() == Items.field_151069_bo) {
         if (!w.field_72995_K) {
            ...
            ItemStack fluid = new ItemStack(SRPItems.ALVEOLAR_FLUID);
            if (!player.field_71071_by.func_70441_a(fluid)) {
   ...
   public IBlockState func_180642_a(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
      ...
      return this.func_176223_P().func_177226_a(ACTIVE, near).func_177226_a(DEPLETED, false);
   }
   ...
   public void func_176213_c(World w, BlockPos pos, IBlockState state) {
      ...
      if (!(Boolean)state.func_177229_b(DEPLETED)) {
         ...
         if ((Boolean)state.func_177229_b(ACTIVE) != near) {
            w.func_180501_a(pos, state.func_177226_a(ACTIVE, near), 2);
         }
      }
   }

   private void setDepleted(World w, BlockPos pos, IBlockState state) {
      IBlockState s = state.func_177226_a(DEPLETED, true).func_177226_a(ACTIVE, false);
      w.func_180501_a(pos, s, 3);
      w.func_175684_a(pos, this, 1200);
   }

   public void func_180650_b(World w, BlockPos pos, IBlockState state, Random rand) {
      if ((Boolean)state.func_177229_b(DEPLETED)) {
         boolean near = this.isNearFollicle(w, pos, 6);
         w.func_180501_a(pos, state.func_177226_a(DEPLETED, false).func_177226_a(ACTIVE, near), 3);
      } else {
         boolean near = this.isNearFollicle(w, pos, 6);
         if ((Boolean)state.func_177229_b(ACTIVE) != near) {
            w.func_180501_a(pos, state.func_177226_a(ACTIVE, near), 3);
         }
      }
   }
         ...
         for (int dy = -r; dy <= r; dy++) {
            for (int dz = -r; dz <= r; dz++) {
               ...
               if (rl != null) {
                  ...
                  if (path.contains("hair_follicle")) {
                     return true;
                  }
               }
            }
