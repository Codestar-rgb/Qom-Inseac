...
extends Block {
    ...
    public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        player.openGui((Object)"srparasites", 0, world, controllerPos.func_177958_n(), controllerPos.func_177956_o(), controllerPos.func_177952_p());
        return true;
    }
    ...
    public void func_180633_a(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        for (BlockPos p : nodes) {
            ...
            if (placer instanceof EntityPlayer) {
                ((EntityPlayer)placer).func_146105_b((ITextComponent)new TextComponentTranslation("block.srparasites.relay_controller.no_space", new Object[0]), true);
            }
        ...
        for (BlockPos p : nodes) {
            world.func_180501_a(p, SRPBlocks.NODE_RELAY.func_176223_P(), 2);
