...
extends Block {
    ...
    public void func_180650_b(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (meta == 0) {
            worldIn.func_175656_a(pos, SRPBlocks.ParasiteFog.func_176223_P().func_177226_a((IProperty)STAGE, (Comparable)Integer.valueOf(1)));
        }
        if (meta == 2) {
            ...
            for (int k2 = -1 * BGrange; k2 <= 1 * BGrange; ++k2) {
                for (int l2 = -1 * BGrange; l2 <= 1 * BGrange; ++l2) {
                    for (int j = -1 * BGrange; j <= 1 * BGrange; ++j) {
                        ...
                        if (block != SRPBlocks.ParasiteFog || (meta2 = block.func_176201_c(iblockstate)) == 2) continue;
                        worldIn.func_175656_a(blockpos, SRPBlocks.ParasiteFog.func_176223_P().func_177226_a((IProperty)STAGE, (Comparable)Integer.valueOf(2)));
                    }
                }
            }
