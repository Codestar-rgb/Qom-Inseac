...
public class BlockNodeLamp extends BlockBase {
   ...
   public static final PropertyInteger RANGE_LEVEL = PropertyInteger.func_177719_a("range_level", 0, 5);

   public BlockNodeLamp() {
      super(Material.field_151591_t, "node_redstone_lamp", 0.3F, true, true);
      this.func_149672_a(SoundType.field_185853_f);
      this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a(POWERED, false).func_177226_a(RANGE_LEVEL, 0));
      this.func_149675_a(true);
   }

   protected BlockStateContainer func_180661_e() {
      return new BlockStateContainer(this, new IProperty[]{POWERED, RANGE_LEVEL});
   }

   public IBlockState func_176203_a(int meta) {
      boolean powered = (meta & 8) != 0;
      int level = meta & 7;
      return this.func_176223_P().func_177226_a(POWERED, powered).func_177226_a(RANGE_LEVEL, level);
   }

   public int func_176201_c(IBlockState state) {
      int meta = (Integer)state.func_177229_b(RANGE_LEVEL);
   ...
   public int func_180641_l(IBlockState state, World world, BlockPos pos) {
      return (Integer)state.func_177229_b(RANGE_LEVEL) * 3;
   }

   public void func_180650_b(World world, BlockPos pos, IBlockState state, Random rand) {
      if (!world.field_72995_K) {
         this.updateLampState(world, pos, state);
         world.func_175684_a(pos, this, 100);
      }
   }
   ...
   public void func_176213_c(World world, BlockPos pos, IBlockState state) {
      ...
      if (!world.field_72995_K) {
         this.updateLampState(world, pos, state);
         world.func_175684_a(pos, this, 20);
      }
   }
   ...
   private boolean updateLampState(World world, BlockPos pos, IBlockState state) {
      int newLevel = 0;
      List<Entity> entities = world.func_72872_a(Entity.class, new AxisAlignedBB(pos).func_186662_g(250.0));
      double nearestDistSq = Double.MAX_VALUE;

      for (Entity e : entities) {
         if (e != null && e.func_70089_S() && (e instanceof EntityDod || e instanceof EntityDodSII || e instanceof EntityDodSIII || e instanceof EntityDodSIV)) {
            double distSq = e.func_174818_b(pos);
      ...
      boolean changed = powered != (Boolean)state.func_177229_b(POWERED) || newLevel != (Integer)state.func_177229_b(RANGE_LEVEL);
      if (changed) {
         world.func_180501_a(pos, state.func_177226_a(POWERED, powered).func_177226_a(RANGE_LEVEL, newLevel), 3);
   ...
   public boolean func_180639_a(
      ...
      if (world.field_72995_K) {
         ...
         boolean powered = (Boolean)state.func_177229_b(POWERED);
         int maxStrength = 0;
         double nearestDistSq = Double.MAX_VALUE;

         for (Entity e : world.func_72872_a(Entity.class, new AxisAlignedBB(pos).func_186662_g(250.0))) {
         ...
         player.func_145747_a(new TextComponentTranslation("message.srparasites.node_lamp.strength", new Object[]{strengthLabel}));
         player.func_145747_a(new TextComponentTranslation("message.srparasites.node_lamp.distance", new Object[]{distanceLabel}));
         return true;
      }
   }
}
