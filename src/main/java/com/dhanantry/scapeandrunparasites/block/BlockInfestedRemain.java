...
extends BlockBush {
    ...
    public BlockInfestedRemain(String name) {
        ...
        this.func_149672_a(SRPSoundTypes.SOIL);
    ...
    public void func_180650_b(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (!worldIn.field_72995_K) {
            if (SRPConfigWorld.residueFlammableWave && (worldIn.func_180495_p(pos.func_177978_c()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177968_d()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177974_f()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177976_e()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177984_a()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177977_b()).func_177230_c() == Blocks.field_150480_ab)) {
            ...
            for (int x = 0; x < serverList.size(); ++x) {
                if (!(serverList.get(x) instanceof EntityPBeckon) || ++count <= SRPConfig.nexusVenkrolCap && !(this.getDistanceSq(pos, (Entity)serverList.get(x)) < (double)(SRPConfig.nexusVenkrolDis * SRPConfig.nexusVenkrolDis))) continue;
                return;
            }
    ...
    public void func_180634_a(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
        if (!worldIn.field_72995_K) {
            ...
            if (!(entityIn instanceof EntityParasiteBase) && entityIn instanceof EntityLivingBase && !(target = (EntityLivingBase)entityIn).func_70644_a(SRPPotions.COTH_E) && !target.func_70644_a(SRPPotions.EPEL_E)) {
