...
public class TileEntityDermoidCyst extends TileEntityLockableLoot implements ITickable {
   ...
   public ItemStack func_70298_a(int index, int count) {
      ItemStack stack = ItemStackHelper.func_188382_a(this.items, index, count);
   ...
   public void func_174889_b(EntityPlayer player) {
      if (!player.func_175149_v()) {
         ...
         if (!this.field_145850_b.field_72995_K) {
            this.field_145850_b.func_184133_a(null, this.field_174879_c, SRPSounds.FLESH_GROW, SoundCategory.BLOCKS, 10.0F, 1.0F);
      ...
      if (this.field_145850_b != null && !this.field_145850_b.field_72995_K) {
         if (++this.ticksSinceSync % 80 == 0) {
            ...
            for (EntityPlayer p : this.field_145850_b.func_72872_a(EntityPlayer.class, box)) {
               if (p.field_71070_bA instanceof ContainerChest) {
                  IInventory lower = ((ContainerChest)p.field_71070_bA).func_85151_d();
                  if (lower == this) {
                     this.numPlayersUsing++;
                  }
               }
   ...
   public void func_145839_a(NBTTagCompound nbt) {
      ...
      this.items = NonNullList.func_191197_a(this.func_70302_i_(), ItemStack.field_190927_a);
