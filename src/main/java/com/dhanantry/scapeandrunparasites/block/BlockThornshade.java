...
implements IGrowable {
    ...
    public void func_176213_c(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (!this.func_185514_i(soil)) {
            if (!worldIn.field_72995_K) {
                Block.func_180635_a((World)worldIn, (BlockPos)pos, (ItemStack)new ItemStack(SRPItems.itemThornshadeBerry));
            }
    ...
    private boolean isSrpSoil(IBlockState state) {
        ...
        return "srparasites".equals(block.getRegistryName().func_110624_b());
    }
    ...
    public boolean func_180639_a(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        BlockThornshade.func_180635_a((World)worldIn, (BlockPos)pos, (ItemStack)new ItemStack(SRPItems.itemThornshadeBerry, count));
        boolean snowy = this.isSnowy(worldIn, pos);
