...
public class EscapeOnDeathHandler {
    ...
    private static boolean isSrparasitesCause(LivingDeathEvent e) {
        ...
        if (e.getSource().func_76346_g() != null && e.getSource().func_76346_g().getClass().getName().startsWith("com.dhanantry.scapeandrunparasites")) {
            return true;
        }
        if (e.getSource().func_76364_f() != null && e.getSource().func_76364_f().getClass().getName().startsWith("com.dhanantry.scapeandrunparasites")) {
            return true;
        }
