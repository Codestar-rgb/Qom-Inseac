...
public class TileEntityParasiteLoot extends TileEntityLockable implements IInventory {
   ...
   public float getFullness() {
      ...
      return total <= 0 ? 0.0F : (float)this.getUsedSlotCount() / total;
   }

   public int getFullnessField() {
      return (int)Math.round(this.getFullness() * 1000.0);
   }
   ...
   public ItemStack func_70298_a(int index, int count) {
      ItemStack s = ItemStackHelper.func_188382_a(this.items, index, count);
      this.func_70296_d();
      return s;
   }

   public ItemStack func_70304_b(int index) {
      ItemStack s = ItemStackHelper.func_188383_a(this.items, index);
      this.func_70296_d();
      return s;
   }

   public void func_70299_a(int index, ItemStack stack) {
      if (!stack.func_190926_b() && !this.func_94041_b(index, stack)) {
   ...
   public static boolean isValidParasiteLootItem(ItemStack stack) {
      if (stack == null || stack.func_190926_b()) {
         ...
         return stack.func_77973_b().getRegistryName() == null ? false : "srparasites".equals(stack.func_77973_b().getRegistryName().func_110624_b());
      }
   }
   ...
   public NBTTagCompound func_189515_b(NBTTagCompound tag) {
      ...
      ItemStackHelper.func_191282_a(tag, this.items);
      return tag;
   }
   ...
   public void func_145839_a(NBTTagCompound tag) {
      ...
      ItemStackHelper.func_191283_b(tag, this.items);
   }
