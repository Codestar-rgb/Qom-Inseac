 ...
 */
package com.subspaceparasite.entity.logic;
...
public class VenkrolTornadoLogic {
    public static void tickTornadoEffects(EntityLivingBase venkrol) {
        if (!SPConfigWorld.venkrolTornadoEnabled) {
            return;
        }
        if (venkrol == null) {
            return;
        ...
        for (EntityLivingBase e : targets) {
            if (e == venkrol || !e.func_70089_S() || VenkrolTornadoLogic.isSPParasite(e) || e.field_70163_u < venkrol.field_70163_u) continue;
            VenkrolTornadoLogic.applyTornadoForces(venkrol, e, maxRadius);
        }
    }

    private static boolean isSPParasite(EntityLivingBase e) {
        ResourceLocation rl = EntityList.func_191301_a((Entity)e);
        if (rl == null) {
            return false;
        }
        String modid = rl.func_110624_b();
        return "subspaceparasite".equals(modid);
    }
    ...
    private static void applyTornadoForces(EntityLivingBase venkrol, EntityLivingBase target, double maxRadius) {
        ...
        if (target instanceof EntityPlayer) {
            ...
            if (!boots.func_190926_b() && boots.func_77973_b() == SPItems.VENKROL_BOOTS) {
                return;
            }
