...
extends Entity {
    ...
    private static final String SCENT_HOST_TAG = "SPScentBuffed";
    ...
    public void func_184178_b(EntityPlayerMP player) {
        ...
        for (EntityPlayer entityPlayer : playerEntityList) {
            SPMain.network.sendToDimension((IMessage)new SPPacketMovingSound(102), this.field_70170_p.field_73011_w.getDimension());
        }
    }
    ...
    public void func_184203_c(EntityPlayerMP player) {
        ...
        List playerEntityList = this.field_70170_p.field_73010_i;
        for (EntityPlayer entityPlayer : playerEntityList) {
            SPMain.network.sendToDimension((IMessage)new SPPacketMovingSound(103), this.field_70170_p.field_73011_w.getDimension());
        }
    }
    ...
    private void scentTactical() {
        if (this.active >= SPConfigSystems.scentSpawnWaves) {
    ...
    private void scentBuilder() {
        this.field_70170_p.func_184148_a(null, this.field_70165_t, this.field_70163_u, this.field_70161_v, SPSounds.SCENTWAVE, this.func_184176_by(), 10.0f, 1.0f);
        this.field_70170_p.func_184148_a(null, this.getTargetToKill().field_70165_t, this.getTargetToKill().field_70163_u, this.getTargetToKill().field_70161_v, SPSounds.SCENTWAVE, this.getTargetToKill().func_184176_by(), 10.0f, 1.0f);
        this.loopLife = (byte)(this.loopLife - 1);
        int a = 0;
        int horde = this.maxMinInt(this.minwave, this.maxwave);
        for (int limit = 0; limit < 10; ++limit) {
            if ((a += this.placeWaves(SPConfigSystems.scentMiniDis, SPConfigSystems.scentMaxDis)) < horde) continue;
            this.delay = 100 + a * 20;
            this.scentState = (byte)4;
            return;
        }
    ...
    private void scentFollower() {
        if (this.followTargetScent) {
            if (this.getTargetToKill() != null) {
                if (this.getTargetToKill().func_70068_e((Entity)this) > 144.0 && this.getTargetToKill().func_70644_a(SPPotions.PREY_E)) {
    ...
    private boolean checkAttri(EntityLivingBase in) {
        ...
        int cond = 0;
        if (in.func_110148_a(SharedMonsterAttributes.field_111267_a) != null && in.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111126_e() >= SPConfigSystems.minAttriHealth) {
            ++cond;
        }
        if (in.func_110148_a(SharedMonsterAttributes.field_188791_g) != null && in.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111126_e() >= SPConfigSystems.minAttriArmor) {
            ++cond;
        }
        if (in.func_110148_a(SharedMonsterAttributes.field_111264_e) != null && in.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111126_e() >= SPConfigSystems.minAttriDamage) {
            ++cond;
        }
        return cond >= SPConfigSystems.minAttriFailCount || cond == 0;
    }
    ...
    private void updateScentOLevel() {
        if (this.dangerToUs >= SPConfigSystems.scentLevelPointsEight) {
            this.scentLevel = (byte)8;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveEight;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveEight;
            this.maxwave = SPConfigSystems.scentWaveMaximumEight;
            this.minwave = SPConfigSystems.scentWaveMinimumEight;
        } else if (this.dangerToUs >= SPConfigSystems.scentLevelPointsSeven) {
            this.scentLevel = (byte)7;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveSeven;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveSeven;
            this.maxwave = SPConfigSystems.scentWaveMaximumSeven;
            this.minwave = SPConfigSystems.scentWaveMinimumSeven;
        } else if (this.dangerToUs >= SPConfigSystems.scentLevelPointsSix) {
            this.scentLevel = (byte)6;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveSix;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveSix;
            this.maxwave = SPConfigSystems.scentWaveMaximumSix;
            this.minwave = SPConfigSystems.scentWaveMinimumSix;
        } else if (this.dangerToUs >= SPConfigSystems.scentLevelPointsFive) {
            this.scentLevel = (byte)5;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveFive;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveFive;
            this.maxwave = SPConfigSystems.scentWaveMaximumFive;
            this.minwave = SPConfigSystems.scentWaveMinimumFive;
        } else if (this.dangerToUs >= SPConfigSystems.scentLevelPointsFour) {
            this.scentLevel = (byte)4;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveFour;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveFour;
            this.maxwave = SPConfigSystems.scentWaveMaximumFour;
            this.minwave = SPConfigSystems.scentWaveMinimumFour;
        } else if (this.dangerToUs >= SPConfigSystems.scentLevelPointsThree) {
            this.scentLevel = (byte)3;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveThree;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveThree;
            this.maxwave = SPConfigSystems.scentWaveMaximumThree;
            this.minwave = SPConfigSystems.scentWaveMinimumThree;
        } else if (this.dangerToUs >= SPConfigSystems.scentLevelPointsTwo) {
            this.scentLevel = (byte)2;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveTwo;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveTwo;
            this.maxwave = SPConfigSystems.scentWaveMaximumTwo;
            this.minwave = SPConfigSystems.scentWaveMinimumTwo;
        } else if (this.dangerToUs >= SPConfigSystems.scentLevelPointsOne) {
            this.scentLevel = 1;
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveOne;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveOne;
            this.maxwave = SPConfigSystems.scentWaveMaximumOne;
            this.minwave = SPConfigSystems.scentWaveMinimumOne;
        } else {
            this.maxmob = SPConfigSystems.scentWaveMaxMobWaveZero;
            this.minmob = SPConfigSystems.scentWaveMinMobWaveZero;
            this.maxwave = SPConfigSystems.scentWaveMaximumZero;
            this.minwave = SPConfigSystems.scentWaveMinimumZero;
        }
    }
    ...
    private int checkNearby() {
        ...
        if (count > SPConfig.worldMobCap + (players *= SPConfig.worldMobCapPlusPlayer)) {
            return 20;
        }
        return i;
    }
    ...
    private boolean moveMobToLoc(EntityParasiteBase in) {
        int minDist = SPConfigSystems.scentMiniDis;
        int maxDist = SPConfigSystems.scentMaxDis;
        int loop = 0;
        if (loop < 7) {
            ++loop;
            int range = maxDist * 2;
    ...
    public int placeWaves(int minDist, int maxDist) {
        ...
        if (this.func_70011_f(poss.func_177958_n(), poss.func_177956_o(), poss.func_177952_p()) < (double)minDist || this.func_70011_f(poss.func_177958_n(), poss.func_177956_o(), poss.func_177952_p()) > (double)SPConfigSystems.oneMinRangeCap) {
            return 0;
        }
    ...
    private String[] getMob() {
        ...
        switch (this.getareaValue()) {
            case 0: {
                mob = SPConfigSystems.scentLevelZero;
                break;
            }
            case 1: {
                mob = SPConfigSystems.scentLevelOne;
                break;
            }
            case 2: {
                mob = SPConfigSystems.scentLevelTwo;
                break;
            }
            case 3: {
                mob = SPConfigSystems.scentLevelThree;
                break;
            }
            case 4: {
                mob = SPConfigSystems.scentLevelFour;
                break;
            }
            case 5: {
                mob = SPConfigSystems.scentLevelFive;
                break;
            }
            case 6: {
                mob = SPConfigSystems.scentLevelSix;
                break;
            }
            case 7: {
                mob = SPConfigSystems.scentLevelSeven;
                break;
            }
            case 8: {
                mob = SPConfigSystems.scentLevelEight;
            }
        }
        return mob;
    }
    ...
    public boolean checkIfScentAlone(EntityParasiticScent scent) {
        ...
        for (BlockPos s : scentsLoadedPositions) {
            if (!(scent.func_70011_f(s.func_177958_n(), s.func_177956_o(), s.func_177952_p()) <= (double)SPConfigSystems.scentSpacing)) continue;
            return false;
        }
        return true;
    }
