    ...
    public void func_70071_h_() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            if (this.field_70173_aa % 20 == 0) {
                ...
                if (!this.getActive() && SPConfigSystems.disloGiveBodies && SPSaveData.get(this.field_70170_p, 50).getCurrentCode(this.field_70170_p.field_73011_w.getDimension(), 20) >= 1) {
                    this.setPlus(SPConfigMobs.canraadaptedremainplus);
                    this.setHealth(SPConfigMobs.canraadaptedremainhealth);
                }
            }
            if (this.active) {
                ...
                if (this.count > this.goal) {
                    ...
                    for (int x = 0; x < serverList.size(); ++x) {
                        ...
                        if (count <= SPConfig.worldMobCap) continue;
                        this.count = 0;
                        return;
                    }
                    ...
                    out.func_70690_d(new PotionEffect(SPPotions.DEBAR_E, 400, 0, false, false));
