...
implements EntityCanMelt {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.INFADVENTURER_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.INFADVENTURER_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.230000004172325);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.INFADVENTURER_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.INFADVENTURER_ATTACK_DAMAGE);
    ...
    public void func_70636_d() {
        super.func_70636_d();
        this.melting();
        if (!this.field_70170_p.field_72995_K && this.srpTicks == 10 && this.killcount > (double)SPConfigMobs.infadventurerThrall && ParasiteEventEntity.canSpawnNext) {
    ...
    protected SoundEvent func_184639_G() {
        ...
        return SPSounds.ASSIM_ADVENTURER_GROWL;
    }

    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        return SPSounds.ASSIM_ADVENTURER_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.ASSIM_ADVENTURER_DEATH;
    }

    @Override
    public void func_70074_a(EntityLivingBase entityLivingIn) {
        super.func_70074_a(entityLivingIn);
        if (!this.field_70170_p.field_72995_K && this.killcount > (double)SPConfigMobs.infadventurerThrall && !this.field_70128_L && ParasiteEventEntity.canSpawnNext) {
            ParasiteEventEntity.spawnNext(this, new EntityMes(this.field_70170_p), true, true);
        }
    }
    ...
    protected void func_70609_aI() {
        ...
        if (this.field_70725_aQ == 20 && !this.field_70170_p.field_72995_K && this.field_70146_Z.nextDouble() <= SPAttributes.INFADVENTURER_HEADCHANCE) {
            ParasiteSummon.spawnM(this, new String[]{"subspaceparasite:sim_adventurerhead;1;1"}, 0, false, this.func_95999_t());
        }
    }
        ...
        if (this.isMelting()) {
            ...
            if (!this.field_70170_p.field_72995_K) {
                if ((double)this.getTHeigh() <= 0.7 || this.sound >= 127) {
                    ...
                    out.setLegs(SPAttributes.INFADVENTURER_V, false);
                }
            } else {
    ...
    protected void selfExplode() {
        super.selfExplode();
        ParasiteSummon.spawnM(this, new String[]{SPConfigMobs.infadventurermob}, 0, false, this.func_95999_t());
    }
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        SPReference.setSimPlayerName(this);
        return floo;
    }
