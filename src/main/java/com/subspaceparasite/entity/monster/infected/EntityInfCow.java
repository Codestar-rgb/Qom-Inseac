...
implements EntityCanMelt {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.INFCOW_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.INFCOW_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a((double)0.2f);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.INFCOW_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.INFCOW_ATTACK_DAMAGE);
    ...
    protected void func_70609_aI() {
        ...
        if (this.field_70725_aQ == 20 && !this.field_70170_p.field_72995_K && this.field_70146_Z.nextDouble() <= SPAttributes.INFCOW_HEADCHANCE) {
            ParasiteSummon.spawnM(this, new String[]{"subspaceparasite:sim_cowhead;1;1"}, 0, false, this.func_95999_t());
        }
    }
        ...
        if (this.isMelting()) {
            ...
            if (!this.field_70170_p.field_72995_K) {
                if ((double)this.getTHeigh() <= 0.7 || this.sound >= 73) {
                    ...
                    out.setLegs(SPAttributes.INFCOW_V, false);
                }
            } else {
