...
EntityBodyParts {
    protected static final DataParameter<Boolean> FLYING = EntityDataManager.func_187226_a(EntityInfDragonE.class, (DataSerializer)DataSerializers.field_187198_h);
    private int flying;
    private float aaa;
    private float sss;
    ...
    protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityInfDragonE.class, (DataSerializer)DataSerializers.field_187191_a);
    private static final DataParameter<Boolean> ATTACKING = EntityDataManager.func_187226_a(EntityInfDragonE.class, (DataSerializer)DataSerializers.field_187198_h);
    private int limit;
    ...
    public EntityInfDragonE(World worldIn) {
        ...
        this.headlHealth = (float)((double)this.func_110138_aP() * SPConfig.tendrilHealth);
    ...
    public int canSpawnByIDData() {
        return SPConfigMobs.infdragoneCanSpawnAssimilatedNat;
    }
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIAttackMeleeStatusAOE(this, 1.9, false, 8.0, 6.0));
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAISkill(this, 60, 32, 7, true, 1));
    }

    protected void func_110147_ax() {
        super.func_110147_ax();
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.INFDRAGONE_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.INFDRAGONE_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.27);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.INFDRAGONE_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.INFDRAGONE_ATTACK_DAMAGE);
    ...
    private void flame() {
        ...
        EntityProjectileDragonE entitylargefireball = new EntityProjectileDragonE(this.field_70170_p, (EntityLivingBase)this, d2, d3, d4);
    ...
    extends EntityAIBase {
        ...
        public void func_75246_d() {
            BlockPos blockpos = new BlockPos((Entity)EntityInfDragonE.this);
            int flag = 1;
            double speed = 0.5;
            if (EntityInfDragonE.this.func_70638_az() != null) {
                if (EntityInfDragonE.this.func_70068_e((Entity)EntityInfDragonE.this.func_70638_az()) > 100.0) {
                    blockpos = new BlockPos((Entity)EntityInfDragonE.this.func_70638_az());
                    flag = 2;
                } else if (EntityInfDragonE.this.func_70068_e((Entity)EntityInfDragonE.this.func_70638_az()) < 36.0) {
                    blockpos = new BlockPos((Entity)EntityInfDragonE.this.func_70638_az());
                    flag = 3;
                    speed += 0.25;
                }
            ...
            for (int i = 0; i < 3; ++i) {
                BlockPos blockpos1 = blockpos.func_177982_a(EntityInfDragonE.this.field_70146_Z.nextInt(15) - 7, EntityInfDragonE.this.field_70146_Z.nextInt(11) - 5, EntityInfDragonE.this.field_70146_Z.nextInt(15) - 7);
                if (flag == 2) {
                    blockpos1 = blockpos.func_177982_a(EntityInfDragonE.this.field_70146_Z.nextInt(6) - 2, EntityInfDragonE.this.field_70146_Z.nextInt(7) - 2, EntityInfDragonE.this.field_70146_Z.nextInt(6) - 2);
                } else if (flag == 3) {
                    blockpos1 = blockpos.func_177982_a(EntityInfDragonE.this.field_70146_Z.nextInt(4) + 3, EntityInfDragonE.this.field_70146_Z.nextInt(5) + 4, EntityInfDragonE.this.field_70146_Z.nextInt(4) + 3);
                }
                if (!EntityInfDragonE.this.field_70170_p.func_175623_d(blockpos1)) continue;
                EntityInfDragonE.this.field_70765_h.func_75642_a((double)blockpos1.func_177958_n() + 0.5, (double)blockpos1.func_177956_o() + 0.5, (double)blockpos1.func_177952_p() + 0.5, speed);
                if (EntityInfDragonE.this.func_70638_az() != null) break;
                EntityInfDragonE.this.func_70671_ap().func_75650_a((double)blockpos1.func_177958_n() + 0.5, (double)blockpos1.func_177956_o() + 0.5, (double)blockpos1.func_177952_p() + 0.5, 180.0f, 20.0f);
                break;
            }
        }
    }
    ...
    extends EntityMoveHelper {
        ...
        public void func_75641_c() {
            if (this.field_188491_h == EntityMoveHelper.Action.MOVE_TO) {
                ...
                if ((d3 = (double)MathHelper.func_76133_a((double)d3)) < EntityInfDragonE.this.func_174813_aQ().func_72320_b()) {
                    ...
                    EntityInfDragonE.this.field_70159_w += d0 / d3 * 0.05 * this.field_75645_e;
                    EntityInfDragonE.this.field_70181_x += d1 / d3 * 0.05 * this.field_75645_e;
                    EntityInfDragonE.this.field_70179_y += d2 / d3 * 0.05 * this.field_75645_e;
                    if (EntityInfDragonE.this.func_70638_az() == null) {
                        EntityInfDragonE.this.field_70761_aq = EntityInfDragonE.this.field_70177_z = -((float)MathHelper.func_181159_b((double)EntityInfDragonE.this.field_70159_w, (double)EntityInfDragonE.this.field_70179_y)) * 57.295776f;
                    } else {
                        ...
                        EntityInfDragonE.this.field_70761_aq = EntityInfDragonE.this.field_70177_z = -((float)MathHelper.func_181159_b((double)d4, (double)d5)) * 57.295776f;
                    }
                }
            }
        }
