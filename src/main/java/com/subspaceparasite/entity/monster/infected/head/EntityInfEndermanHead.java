...
extends EntityPInfected {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.INFENDERMAN_HEADHEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.4);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.INFENDERMAN_HEADDAMAGE);
    ...
    public void func_70636_d() {
        ...
        if (this.field_70170_p.field_72995_K) {
            ...
            if (this.func_70638_az() != null && this.field_70173_aa % 20 == 0 && this.func_70068_e((Entity)this.func_70638_az()) > 4.0 && this.field_70146_Z.nextInt(SPConfigMobs.infendermantelefreq * 2) == 0 && !this.teleportAllies()) {
                this.teleportRandomly();
            }
            if (SPConfigSystems.disloGiveBodies && this.func_70089_S() && this.srpTicks == 10 && SPSaveData.get(this.field_70170_p, 44).getCurrentCode(this.field_70170_p.field_73011_w.getDimension(), 20) >= 1) {
    ...
    protected boolean teleportAllies() {
        if (this.ally > 0 || !SPConfigMobs.infendermanteleally) {
            return false;
        }
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (source.func_76363_c() && this.field_70146_Z.nextInt(SPConfigMobs.infendermantelefreq * 2) == 0 && !this.teleportAllies()) {
            this.teleportRandomly();
        }
        return flag;
    }
    ...
    public boolean func_70652_k(@Nonnull Entity entityIn) {
        ...
        if (flag) {
            ...
            if (this.field_70146_Z.nextInt(SPConfigMobs.infendermantelefreq * 2) == 0 && !this.teleportAllies()) {
                this.teleportRandomly();
            }
        }
        return flag;
