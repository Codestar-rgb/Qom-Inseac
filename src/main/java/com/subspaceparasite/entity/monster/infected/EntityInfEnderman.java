...
extends EntityPInfected {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.INFENDERMAN_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.INFENDERMAN_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a((double)0.3f);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.INFENDERMAN_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.INFENDERMAN_ATTACK_DAMAGE);
                ...
                if (entitylivingbaseIn instanceof EntityPlayer) {
                    if (this.tpPlayerName != null) {
                        if (!this.tpPlayerName.equals(entitylivingbaseIn.func_70005_c_())) {
                            ...
                            this.field_70170_p.func_184148_a(null, entitylivingbaseIn.field_70169_q, entitylivingbaseIn.field_70167_r, entitylivingbaseIn.field_70166_s, SPSounds.INFECTEDENDERMAN_PORTAL, this.func_184176_by(), 0.3f, 1.0f);
                        }
                    } else {
                        this.tpPlayerName = entitylivingbaseIn.func_70005_c_();
                        this.field_70170_p.func_184148_a(null, entitylivingbaseIn.field_70169_q, entitylivingbaseIn.field_70167_r, entitylivingbaseIn.field_70166_s, SPSounds.INFECTEDENDERMAN_PORTAL, this.func_184176_by(), 0.3f, 1.0f);
    ...
    public void func_70636_d() {
        ...
        if (this.field_70170_p.field_72995_K) {
            ...
            if (SPConfigMobs.infendermanWaterDamageEnabled && this.func_70090_H()) {
            ...
            if (this.func_70638_az() != null && this.field_70173_aa % 20 == 0 && this.func_70068_e((Entity)this.func_70638_az()) > Math.pow(SPAttributes.INFENDERMAN_TP_DIST / 2.0, 2.0) && this.field_70146_Z.nextInt(SPConfigMobs.infendermantelefreq) == 0 && !this.teleportAllies()) {
    ...
    protected boolean teleportAllies() {
        if (this.ally > 0 || !SPConfigMobs.infendermanteleally || this.toTeleCool > 0 || this.spotCool > 0) {
            return false;
        }
        ...
        for (EntityParasiteBase mob : moblist) {
            if (mob == this || mob.func_70638_az() != null || mob.getParasiteType() > 15 || mob instanceof EntityCanMelt && ((EntityCanMelt)((Object)mob)).isMelting() || mob.func_110143_aJ() - SPConfigMobs.infendermanTeleDamage < 2.0f || !this.teleportToEntity((Entity)mob, 1.0)) continue;
        ...
        for (EntityParasiteBase mob : moblist) {
            if (!(mob instanceof EntityMudo) || mob.func_70638_az() != null || mob.func_110143_aJ() - SPConfigMobs.infendermanTeleDamage < 2.0f || !this.teleportToEntity((Entity)mob, 1.0)) continue;
            this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
            this.toTele = mob;
            this.setWorkTask(false);
            this.ally = 1;
    ...
    private void teleportAlly() {
        block8: {
            block7: {
                ...
                if (this.toTele.getParasiteIDRegister() != 59 && this.toTele.getParasiteIDRegister() != 69) {
                    this.toTele.func_70097_a(DamageSource.field_76379_h, SPConfigMobs.infendermanTeleDamage);
                }
        ...
        this.ally = 0;
        this.toTele = null;
        this.toTeleCool = SPConfigMobs.infendermanallyCool;
    }
    ...
    protected void func_70609_aI() {
        super.func_70609_aI();
        if (this.field_70725_aQ == 20 && !this.field_70170_p.field_72995_K && this.field_70146_Z.nextDouble() <= SPAttributes.INFENDERMAN_HEADCHANCE) {
            ParasiteSummon.spawnM(this, new String[]{"subspaceparasite:sim_endermanhead;1;1"}, 0, false, this.func_95999_t());
        }
    }
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (source.func_76363_c() && this.field_70146_Z.nextInt(SPConfigMobs.infendermantelefreq) == 0 && !this.teleportAllies()) {
            this.teleportRandomly();
        }
        return flag;
    }
    ...
    public boolean func_70652_k(@Nonnull Entity entityIn) {
        ...
        if (flag) {
            ...
            if (this.field_70146_Z.nextInt(SPConfigMobs.infendermantelefreq) == 0 && !this.teleportAllies()) {
                this.teleportRandomly();
            }
        }
        return flag;
    ...
    public void func_70014_b(NBTTagCompound compound) {
        ...
        compound.func_74768_a("SPTextureVariant", this.getTextureVariant());
        compound.func_74757_a("thiscancrawl", this.isCrawling());
        compound.func_74757_a("SPAriral", this.isAriral());
    }

    @Override
    public void func_70037_a(NBTTagCompound compound) {
        super.func_70037_a(compound);
        if (compound.func_74764_b("SPAriral")) {
            this.setAriral(compound.func_74767_n("SPAriral"));
        }
        if (compound.func_74764_b("SPTextureVariant")) {
            this.setTextureVariant(compound.func_74762_e("SPTextureVariant"));
        }
