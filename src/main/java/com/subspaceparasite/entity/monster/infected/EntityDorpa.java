...
implements EntityCanShoot {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.DORPA_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.DORPA_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.27);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.DORPA_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.DORPA_ATTACK_DAMAGE);
    ...
    protected void selfExplode() {
        super.selfExplode();
        ParasiteSummon.spawnM(this, new String[]{SPConfigMobs.dorpamob}, 0, false, this.func_95999_t());
    }
    ...
    public void spawnEffectsGore() {
        for (int i = 0; i <= 60; ++i) {
            if (i % 5 == 0) {
                this.spawnParticles(SPEnumParticle.GCLOUD, 0, 0, 127);
            }
            if (i % 5 != 0) continue;
            this.spawnParticles(SPEnumParticle.GSPLASH, 1, -1, -1);
        }
    }
    ...
    protected SoundEvent func_184639_G() {
        ...
        return SPSounds.INFECTEDSPIDER_GROWL;
    }

    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        return SPSounds.INFECTEDSPIDER_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.INFECTEDSPIDER_DEATH;
    }

    protected SoundEvent getStepSound() {
        return SPSounds.INFECTEDSPIDER_STEP;
    }
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (this.field_70170_p.field_73012_v.nextInt(3) == 0) {
            this.setSkin(1);
            this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.DORPA_HEALTH * 0.5);
            this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.DORPA_ATTACK_DAMAGE * 1.25);
