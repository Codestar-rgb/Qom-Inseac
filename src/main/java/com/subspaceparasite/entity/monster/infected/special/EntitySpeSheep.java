...
public class EntitySpeSheep
extends EntityPAssimara
implements IRangedAttackMob {
    private int host;

    public EntitySpeSheep(World worldIn) {
        super(worldIn);
        this.func_70105_a(0.7566f, 2.85f);
        this.canModRender = 1;
        this.type = (byte)11;
    }
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIAttackRangedStatus(this, 1.2, 100, (float)SPConfig.assimaraFollow / 2.0f, true));
    }
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.1725);
    ...
    public void func_82196_d(EntityLivingBase target, float distanceFactor) {
        ...
        EntityProjectileNade entitylargefireball = new EntityProjectileNade(this.field_70170_p, (EntityLivingBase)this, d2, d3, d4, 3, 60);
