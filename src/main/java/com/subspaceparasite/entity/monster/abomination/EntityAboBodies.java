...
extends EntityParasiteBase {
    ...
    public EntityAboBodies(World worldIn) {
        ...
        this.attackSpeedT = 6;
        this.field_70728_aV = SPAttributes.XP_INFECTED * 3;
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (this.srpTicks == 10 && this.leemCooldown <= 0) {
                ...
                for (EntityParasiteBase mob : moblist) {
                    ...
                    mob.func_70690_d(new PotionEffect(SPPotions.PIVOT_E, 300, 0, false, false));
                    mob.func_70690_d(new PotionEffect(SPPotions.PARATE_E, 300, 0, false, false));
                    mob.SetRooter(this);
                }
            }
        }
