...
extends EntityPPrimitive {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.HULL_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.HULL_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.35);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.HULL_ATTACK_DAMAGE);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.HULL_KD_RESISTANCE);
        ...
        if (!this.field_70170_p.field_72995_K) {
            if (this.srpTicks == 10) {
                ...
                if (this.getSSS()) {
                    ...
                    if ((double)currentH < SPConfigMobs.hullNeededHealth) {
                        this.setSSS(false);
                    }
                } else if ((double)currentH >= SPConfigMobs.hullNeededHealth) {
                    ++this.timer;
                    if ((float)this.timer > SPConfigMobs.hullNeededTime) {
                        this.setSSS(true);
    ...
    public boolean func_70652_k(@Nonnull Entity entityIn) {
        ...
        if (flag) {
            if (this.getSSS()) {
                float f = (float)this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111126_e() * SPConfigMobs.hullStealthDamageMultiplier;
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.HULL_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.HULL_DEATH;
    }
    ...
    public boolean scaryOrbEffect(EntityLivingBase in, int mobs) {
        ...
        if (flag) {
            ParasiteEventEntity.orbApplyEffects(in, this, SPConfigMobs.hullOrbEffects, mobs);
        }
        return flag;
    }
