...
implements EntityCutomAttack {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAISkill(this, 100, (int)(SPConfig.primitiveFollow * 0.7), 2, false, 1));
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.SHYCO_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.SHYCO_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.3);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.SHYCO_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.SHYCO_ATTACK_DAMAGE);
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (flag) {
            this.currentDamage = this.extraDamage * (1.0 - (double)(this.func_110143_aJ() / this.func_110138_aP()) * SPAttributes.SHYCO_I_DAMAGE);
        }
    ...
    public void func_70074_a(EntityLivingBase entityLivingIn) {
        ...
        if (!this.field_70170_p.field_72995_K && this.killcount > SPConfig.adaptedKills && !this.field_70128_L && ParasiteEventEntity.canSpawnNext) {
            ParasiteEventEntity.spawnNext(this, new EntityShycoAdapted(this.field_70170_p), true, true);
        }
    }
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.SHYCO_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.SHYCO_DEATH;
    }
    ...
    public boolean scaryOrbEffect(EntityLivingBase in, int mobs) {
        ...
        if (flag) {
            ParasiteEventEntity.orbApplyEffects(in, this, SPConfigMobs.shycoOrbEffects, mobs);
        }
        return flag;
    }
