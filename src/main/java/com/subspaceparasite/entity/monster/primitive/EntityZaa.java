...
implements EntityCanHaveBodies {
    ...
    protected void func_184651_r() {
        this.field_70714_bg.func_75776_a(1, (EntityAIBase)new EntityAIFollowBodies(this, 1.75, 0.26, 7, SPConfig.adaptedKills, 140));
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.ZAA_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.ZAA_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.26);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.ZAA_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.ZAA_ATTACK_DAMAGE);
    ...
    public void setDigging(boolean in) {
        if (in) {
            this.func_184185_a(SPSounds.ZAA_DIG, 2.0f, this.func_70647_i());
        }
