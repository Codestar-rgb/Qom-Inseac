...
extends EntityPPure {
    protected static final DataParameter<Byte> VEX_FLAGS = EntityDataManager.func_187226_a(EntityRond.class, (DataSerializer)DataSerializers.field_187191_a);
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.OMBOO_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.OMBOO_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.OMBOO_KD_RESISTANCE);
    ...
    extends EntityAIBase {
        ...
        public void func_75246_d() {
            EntityBomb out = new EntityBomb(this.parent.field_70170_p, this.parent, SPConfigMobs.ombooGriefing);
            out.func_82149_j((Entity)this.parent);
            out.setFuse(80);
            out.setStren(1.0f);
            out.setDamage((float)SPAttributes.OMBOO_BOMBDAMAGE, 4);
    ...
    extends EntityAIBase {
        ...
        public boolean func_75250_a() {
            if (EntityRond.this.func_70638_az() != null && EntityRond.this.field_70146_Z.nextInt(7) == 0) {
                return EntityRond.this.func_70068_e((Entity)EntityRond.this.func_70638_az()) > 3.0;
            }
            return false;
        }

        public boolean func_75253_b() {
            return EntityRond.this.func_70605_aq().func_75640_a() && EntityRond.this.isCharging() && EntityRond.this.func_70638_az() != null && EntityRond.this.func_70638_az().func_70089_S();
        }
        ...
        public void func_75246_d() {
            ...
            if (entitylivingbase != null && entitylivingbase.func_70089_S()) {
                if (EntityRond.this.func_174813_aQ().func_72326_a(entitylivingbase.func_174813_aQ())) {
                    EntityRond.this.func_70652_k((Entity)entitylivingbase);
                    EntityRond.this.setCharging(false);
                } else {
                    double d0 = EntityRond.this.func_70068_e((Entity)entitylivingbase);
                    if (d0 < 9.0) {
                        Vec3d vec3d = entitylivingbase.func_174824_e(1.0f);
                        EntityRond.this.field_70765_h.func_75642_a(vec3d.field_72450_a, vec3d.field_72448_b + 10.0, vec3d.field_72449_c, 1.0);
                    }
    ...
    extends EntityAIBase {
        ...
        public void func_75246_d() {
            BlockPos blockpos = new BlockPos((Entity)EntityRond.this);
            int flag = 1;
            double speed = 0.2;
            if (EntityRond.this.func_70638_az() != null) {
                if (EntityRond.this.func_70068_e((Entity)EntityRond.this.func_70638_az()) > 100.0) {
                    blockpos = new BlockPos((Entity)EntityRond.this.func_70638_az());
                    flag = 2;
                    speed += 0.1;
                } else if (EntityRond.this.func_70068_e((Entity)EntityRond.this.func_70638_az()) < 36.0) {
                    blockpos = new BlockPos((Entity)EntityRond.this.func_70638_az());
                    flag = 3;
                    speed += 0.1;
                }
            ...
            for (int i = 0; i < 3; ++i) {
                BlockPos blockpos1 = blockpos.func_177982_a(EntityRond.this.field_70146_Z.nextInt(15) - 7, EntityRond.this.field_70146_Z.nextInt(11) - 5, EntityRond.this.field_70146_Z.nextInt(15) - 7);
                if (flag == 2) {
                    blockpos1 = blockpos.func_177982_a(EntityRond.this.field_70146_Z.nextInt(6) - 2, EntityRond.this.field_70146_Z.nextInt(7) - 2, EntityRond.this.field_70146_Z.nextInt(6) - 2);
                } else if (flag == 3) {
                    blockpos1 = blockpos.func_177982_a(EntityRond.this.field_70146_Z.nextInt(4) + 3, EntityRond.this.field_70146_Z.nextInt(5) + 4, EntityRond.this.field_70146_Z.nextInt(4) + 3);
                }
                if (!EntityRond.this.field_70170_p.func_175623_d(blockpos1)) continue;
                EntityRond.this.field_70765_h.func_75642_a((double)blockpos1.func_177958_n() + 0.5, (double)blockpos1.func_177956_o() + 1.0, (double)blockpos1.func_177952_p() + 0.5, speed);
                if (EntityRond.this.func_70638_az() != null) break;
                EntityRond.this.func_70671_ap().func_75650_a((double)blockpos1.func_177958_n() + 0.5, (double)blockpos1.func_177956_o() + 1.0, (double)blockpos1.func_177952_p() + 0.5, 180.0f, 20.0f);
                break;
            }
        }
    }
    ...
    extends EntityMoveHelper {
        ...
        public void func_75641_c() {
            if (this.field_188491_h == EntityMoveHelper.Action.MOVE_TO) {
                ...
                if ((d3 = (double)MathHelper.func_76133_a((double)d3)) < EntityRond.this.func_174813_aQ().func_72320_b()) {
                    this.field_188491_h = EntityMoveHelper.Action.WAIT;
                    EntityRond.this.field_70159_w *= 0.5;
                    EntityRond.this.field_70181_x *= 0.5;
                    EntityRond.this.field_70179_y *= 0.5;
                } else {
                    EntityRond.this.field_70159_w += d0 / d3 * 0.05 * this.field_75645_e;
                    EntityRond.this.field_70181_x += d1 / d3 * 0.05 * this.field_75645_e;
                    EntityRond.this.field_70179_y += d2 / d3 * 0.05 * this.field_75645_e;
                    if (EntityRond.this.func_70638_az() == null) {
                        EntityRond.this.field_70761_aq = EntityRond.this.field_70177_z = -((float)MathHelper.func_181159_b((double)EntityRond.this.field_70159_w, (double)EntityRond.this.field_70179_y)) * 57.295776f;
                    } else {
                        ...
                        EntityRond.this.field_70761_aq = EntityRond.this.field_70177_z = -((float)MathHelper.func_181159_b((double)d4, (double)d5)) * 57.295776f;
                    }
                }
            }
        }
