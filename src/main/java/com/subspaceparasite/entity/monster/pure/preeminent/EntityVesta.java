...
implements EntityBodyParts {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIGiveEffectsArea(this, SPAttributes.VESTA_CD, SPAttributes.VESTA_RANGE, SPConfigMobs.vestaeffects));
    }

    protected void func_110147_ax() {
        super.func_110147_ax();
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.VESTA_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.VESTA_ARMOR);
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.VESTA_ATTACK_DAMAGE);
    ...
    public void func_70636_d() {
        ...
        if (this.srpTicks == 25) {
            ...
            for (EntityParasiteBase mob : moblist) {
                SPPotions.applyStackPotion(SPPotions.LINK_E, (EntityLivingBase)mob, 6666, 0);
                SPPotions.applyStackPotion(SPPotions.FOSTER_E, (EntityLivingBase)mob, 6666, 0);
            }
        }
    }
    ...
    public boolean scaryOrbEffect(EntityLivingBase in, int mobs) {
        ...
        if (flag) {
            ParasiteEventEntity.orbApplyEffects(in, this, SPConfigMobs.vestaOrbEffects, mobs);
        }
        return flag;
    }
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (this.field_70146_Z.nextDouble() < SPConfig.variantChance || this.phaseCreated >= SPConfigSystems.evolutionParasiteAlwaysVariant) {
            switch (2) {
                case 2: {
                    this.setSkin(1);
                    this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.VESTA_ARMOR * 1.5);
