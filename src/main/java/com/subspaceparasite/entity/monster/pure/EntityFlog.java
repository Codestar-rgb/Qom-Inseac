...
implements EntityCutomAttack {
    ...
    private boolean up;
    private static final DataParameter<Byte> CLIMBING = EntityDataManager.func_187226_a(EntityFlog.class, (DataSerializer)DataSerializers.field_187191_a);
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIAttackMeleeStatusAOE(this, 1.5, false, 0.0, 3.0));
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAIEvadeDash(this, 20, 2, 4, 1.5, 15));
    }

    protected void func_110147_ax() {
        super.func_110147_ax();
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.FLOG_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.FLOG_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.274172325);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.FLOG_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.FLOG_ATTACK_DAMAGE);
