...
EntityCanShoot {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.ORCH_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.ORCH_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.2775);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.ORCH_ATTACK_DAMAGE);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.ORCH_KD_RESISTANCE);
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.ORCH_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.ORCH_DEATH;
    }
    ...
    public boolean scaryOrbEffect(EntityLivingBase in, int mobs) {
        ...
        if (flag) {
            ParasiteEventEntity.orbApplyEffects(in, this, SPConfigMobs.orchOrbEffects, mobs);
        }
        return flag;
    }

    protected void func_180429_a(BlockPos pos, Block blockIn) {
        this.func_184185_a(SPSounds.HEAVY_STEPS_MULTIPLE, 0.15f, 1.0f);
    }
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (this.field_70146_Z.nextDouble() < SPConfig.variantChance || this.phaseCreated >= SPConfigSystems.evolutionParasiteAlwaysVariant) {
            switch (this.field_70146_Z.nextInt(2)) {
                case 0: {
                    this.setSkin(1);
                    this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.ORCH_HEALTH * 0.5);
                    this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.ORCH_ATTACK_DAMAGE * 1.5);
    ...
    protected void skillLeap() {
        ...
        if (this.attacking >= 1) {
            ...
            if (this.attacking % 5 == 0 && this.attacking < 40 && SPConfigMobs.lodoEnabled) {
