...
EntityCanShoot {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.PHEON_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.PHEON_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.283);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.PHEON_ATTACK_DAMAGE);
    ...
    public boolean attackEntityAsMobAOE(Entity entityIn) {
        ...
        if (moblist.size() > 4) {
            ...
            float luck = (float)(SPAttributes.TERLA_ATTACK_DAMAGE * 2.0);
    ...
    public boolean scaryOrbEffect(EntityLivingBase in, int mobs) {
        ...
        if (flag) {
            ParasiteEventEntity.orbApplyEffects(in, this, SPConfigMobs.pheonOrbEffects, mobs);
        }
        return flag;
    }
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (this.field_70146_Z.nextDouble() < SPConfig.variantChance || this.phaseCreated >= SPConfigSystems.evolutionParasiteAlwaysVariant) {
            switch (this.field_70146_Z.nextInt(1)) {
                case 0: {
                    this.setSkin(1);
                    this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.PHEON_HEALTH * 0.5);
                    this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.PHEON_ATTACK_DAMAGE * 1.5);
    ...
    public Entity getProj(double accelX, double accelY, double accelZ) {
        this.func_184185_a(SPSounds.DORPA_RANGE, 2.0f, 1.0f);
        Vec3d vec3d = this.func_70676_i(1.0f);
        EntityProjectileHomming entitylargefireball = new EntityProjectileHomming(this.field_70170_p, (EntityLivingBase)this, (Entity)this.func_70638_az(), SPAttributes.ORONCO_ATTACK_DAMAGE);
