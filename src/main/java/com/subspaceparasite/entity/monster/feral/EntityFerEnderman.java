...
extends EntityPFeral {
    ...
    private static final DataParameter<Boolean> SCREAMING = EntityDataManager.func_187226_a(EntityFerEnderman.class, (DataSerializer)DataSerializers.field_187198_h);
    private static final DataParameter<Boolean> CRAWLING = EntityDataManager.func_187226_a(EntityFerEnderman.class, (DataSerializer)DataSerializers.field_187198_h);
    ...
    public EntityFerEnderman(World worldIn) {
        super(worldIn);
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.FERENDERMAN_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.FERENDERMAN_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.330000011920929);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.FERENDERMAN_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.FERENDERMAN_ATTACK_DAMAGE);
    ...
    public void func_70624_b(@Nullable EntityLivingBase entitylivingbaseIn) {
        ...
        if (entitylivingbaseIn == null) {
            ...
            if (flag) {
                this.spotCool = SPConfigMobs.feralendermansaw;
                if (entitylivingbaseIn instanceof EntityPlayer) {
                    if (this.tpPlayerName != null) {
                        if (!this.tpPlayerName.equals(((EntityPlayer)entitylivingbaseIn).func_70005_c_())) {
                            ...
                            this.field_70170_p.func_184148_a((EntityPlayer)null, entitylivingbaseIn.field_70169_q, entitylivingbaseIn.field_70167_r, entitylivingbaseIn.field_70166_s, SPSounds.INFECTEDENDERMAN_PORTAL, this.func_184176_by(), 0.3f, 1.0f);
                        }
                    } else {
                        this.tpPlayerName = ((EntityPlayer)entitylivingbaseIn).func_70005_c_();
                        this.field_70170_p.func_184148_a((EntityPlayer)null, entitylivingbaseIn.field_70169_q, entitylivingbaseIn.field_70167_r, entitylivingbaseIn.field_70166_s, SPSounds.INFECTEDENDERMAN_PORTAL, this.func_184176_by(), 0.3f, 1.0f);
    ...
    public void func_70636_d() {
        ...
        } else if (this.func_70638_az() != null && this.field_70173_aa % 20 == 0 && this.func_70068_e((Entity)this.func_70638_az()) > Math.pow(SPAttributes.FERENDERMAN_TP_DIST / 2.0, 2.0) && this.field_70146_Z.nextInt(SPConfigMobs.feralendermantelefreq) == 0 && !this.teleportAllies()) {
    ...
    protected boolean teleportAllies() {
        if (this.ally > 0 || !SPConfigMobs.feralendermanteleally || this.toTeleCool > 0 || this.spotCool > 0) {
            return false;
        }
        ...
        if (this.func_70644_a(SPPotions.RAGE_E)) {
            List moblist5 = this.field_70170_p.func_72872_a(EntityPAdapted.class, axisalignedbb);
            for (Object mob : moblist5) {
                if (mob.func_70638_az() != null || mob.func_110143_aJ() - SPConfigMobs.feralendermanTeleDamage < 2.0f || !this.teleportToEntity((Entity)mob, 1.0)) continue;
        ...
        List moblist1 = this.field_70170_p.func_72872_a(EntityPPrimitive.class, axisalignedbb);
        for (Object mob : moblist1) {
            if (mob.func_70638_az() != null || mob.func_110143_aJ() - SPConfigMobs.feralendermanTeleDamage < 2.0f || !this.teleportToEntity((Entity)mob, 1.0)) continue;
            this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
            this.toTele = mob;
            this.setWorkTask(false);
        ...
        List moblist7 = this.field_70170_p.func_72872_a(EntityPFeral.class, axisalignedbb);
        for (Object mob : moblist7) {
            if (mob.func_70638_az() != null || mob.func_110143_aJ() - SPConfigMobs.feralendermanTeleDamage < 2.0f || !this.teleportToEntity((Entity)mob, 1.0)) continue;
            this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
            this.toTele = mob;
            this.setWorkTask(false);
        ...
        List moblist2 = this.field_70170_p.func_72872_a(EntityPInfected.class, axisalignedbb);
        for (EntityPInfected mob : moblist2) {
            if (mob.func_70638_az() != null || mob.getParasiteType() > 15 || mob instanceof EntityCanMelt && ((EntityCanMelt)((Object)mob)).isMelting() || mob.func_110143_aJ() - SPConfigMobs.feralendermanTeleDamage < 2.0f || !this.teleportToEntity((Entity)mob, 1.0)) continue;
            this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
            this.toTele = mob;
            this.setWorkTask(false);
            this.ally = 1;
        ...
        List moblist3 = this.field_70170_p.func_72872_a(EntityParasiteBase.class, axisalignedbb);
        for (EntityParasiteBase mob : moblist3) {
            if (!(mob instanceof EntityMudo) || mob.func_70638_az() != null || mob.func_110143_aJ() - SPConfigMobs.feralendermanTeleDamage < 2.0f || !this.teleportToEntity((Entity)mob, 1.0)) continue;
            this.setCoordTarget(target.field_70165_t, target.field_70163_u, target.field_70161_v);
            this.toTele = mob;
            this.setWorkTask(false);
            this.ally = 1;
    ...
    private void teleportAlly() {
        block8: {
            block7: {
                ...
                if (this.toTele.getParasiteIDRegister() != 59 && this.toTele.getParasiteIDRegister() != 69) {
                    this.toTele.func_70097_a(DamageSource.field_76379_h, SPConfigMobs.feralendermanTeleDamage);
                }
                if (this.func_70027_ad() && this.field_70146_Z.nextInt(4) != 0) {
                    this.toTele.func_70015_d(8);
                }
                this.field_70170_p.func_184148_a((EntityPlayer)null, this.toTele.field_70169_q, this.toTele.field_70167_r, this.toTele.field_70166_s, SPSounds.INFECTEDENDERMAN_PORTAL, this.func_184176_by(), 1.0f, 1.0f);
                flag2 = true;
        ...
        this.ally = 0;
        this.toTele = null;
        this.toTeleCool = SPConfigMobs.feralendermanallyCool;
    }
    ...
    protected boolean teleportRandomly() {
        ...
        if (this.func_70638_az() != null && this.func_70638_az().func_70011_f(d0, d1, d2) < Math.pow(SPAttributes.INFENDERMAN_TP_DIST, 2.0)) {
            return false;
        }
    ...
    private boolean teleportTo(double x, double y, double z) {
        ...
        if (flag) {
            this.field_70170_p.func_184148_a((EntityPlayer)null, this.field_70169_q, this.field_70167_r, this.field_70166_s, SPSounds.INFECTEDENDERMAN_PORTAL, this.func_184176_by(), 1.0f, 1.0f);
            this.func_184185_a(SPSounds.INFECTEDENDERMAN_PORTAL, 1.0f, 1.0f);
        }
        return flag;
    }
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (source.func_76363_c() && this.field_70146_Z.nextInt(SPConfigMobs.feralendermantelefreq) == 0 && !this.teleportAllies()) {
            this.teleportRandomly();
        }
        return flag;
    }
    ...
    public boolean func_70652_k(@Nonnull Entity entityIn) {
        ...
        if (flag && this.field_70146_Z.nextInt(SPConfigMobs.feralendermantelefreq) == 0 && !this.teleportAllies()) {
            this.teleportRandomly();
        }
        return flag;
    }
    ...
    protected SoundEvent func_184639_G() {
        ...
        return SPSounds.INFECTEDENDERMAN_GROWL;
    }

    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        return SPSounds.INFECTEDENDERMAN_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.INFECTEDENDERMAN_DEATH;
    }
