...
extends EntityPDerived {
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.KIRIN_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.KIRIN_DEATH;
    }
    ...
    public void func_70071_h_() {
        ...
        if (this.field_70170_p.field_72995_K && (ticks = ((Integer)this.field_70180_af.func_187225_a(BLINK_TICKS)).intValue()) > 0 && (p = (BlockPos)this.field_70180_af.func_187225_a(BLINK_POS)) != null && !Objects.equals(p, BlockPos.field_177992_a)) {
            ...
            SPClientParticles.spawnKirinWarning(this.field_70170_p, cx, y, cz, sizeSmall, angSmall, 1);
            SPClientParticles.spawnKirinWarning(this.field_70170_p, cx, y, cz, sizeBig, angBig, 1);
        }
    }
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.KIRIN_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.KIRIN_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.24);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.KIRIN_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.KIRIN_ATTACK_DAMAGE);
    ...
    private void summon() {
        ...
        if (this.border == 3) {
            ...
            this.func_184185_a(SPSounds.KIRIN_SHOOT, this.func_70599_aP() * 2.0f, (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2f + 1.0f);
        }
        if (this.border > 12) {
            this.skillSummon = true;
            this.setParasiteStatus(0);
