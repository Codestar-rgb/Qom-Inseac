 ...
 */
package com.subspaceparasite.entity.monster.derived;
...
import com.subspaceparasite.entity.ai.misc.EntityPDerived;
...
EntityCanFly {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIFlightAttack(this, SPConfig.derivedFollow, true, 3));
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.HEBLU_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.HEBLU_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.27);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.HEBLU_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.HEBLU_ATTACK_DAMAGE);
        this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111128_a(SPConfig.derivedFollow);
    }
        ...
        if (this.vomit > 0) {
            ...
            if (this.field_70170_p.field_72995_K) {
                for (int i = 0; i < 19; ++i) {
                    ...
                    this.spawnParticles(SPEnumParticle.GCLOUD, -255, 0, 0, offsetX, offsetY, offsetZ, motionX * rain, motionY * rain, motionZ * rain);
                }
            }
        } else {
            this.raining = false;
    ...
    public void func_82196_d(EntityLivingBase target, float distanceFactor) {
        ...
        if (this.field_70146_Z.nextBoolean()) {
            ...
            this.func_184185_a(SPSounds.HEBLU_SHOOT, this.func_70599_aP() * 2.0f, (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2f + 1.0f);
        } else {
    ...
    protected SoundEvent func_184639_G() {
        ...
        return SPSounds.HEBLU_GROWL;
    }

    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        return SPSounds.HEBLU_HURT;
    }
    ...
    protected SoundEvent func_184615_bR() {
        return SPSounds.HEBLU_DEATH;
    }

    protected SoundEvent getStepSound() {
        return SPSounds.HEAVY_STEPS;
    }
            ...
            if (entitylivingbase.func_70068_e((Entity)this.parentEntity) < 4096.0 && this.parentEntity.func_70685_l((Entity)entitylivingbase)) {
                ...
                if (this.attackTimer == 20) {
                    if (this.parentEntity.field_70170_p.field_73012_v.nextInt(3) == 0 && entitylivingbase.field_70122_E) {
                        ...
                        this.parentEntity.func_184185_a(SPSounds.HEBLU_SHOOT, this.parentEntity.func_70599_aP() * 2.0f, (this.parentEntity.field_70170_p.field_73012_v.nextFloat() - this.parentEntity.field_70170_p.field_73012_v.nextFloat()) * 0.2f + 1.0f);
                        this.attackTimer = -60;
                        return;
                    }
                    double d1 = 4.0;
