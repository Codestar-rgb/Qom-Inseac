...
extends EntityPDispatcher {
    public EntityDodSII(World worldIn) {
        ...
        this.totalP = SPConfigMobs.dodsiiTotalActiveMobs;
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.DODSII_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.DODSII_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.0);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.DODSII_ATTACK_DAMAGE);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(1.0);
        this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111128_a(SPConfig.nexussiiFollow * (double)SPConfigMobs.dodsiiFollowRangeMult);
    }
    ...
    public float getBombDamage() {
        return (float)SPAttributes.DODSII_ATTACK_DAMAGE;
    }
