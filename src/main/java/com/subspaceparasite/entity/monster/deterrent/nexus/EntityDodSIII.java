...
extends EntityPDispatcher {
    public EntityDodSIII(World worldIn) {
        ...
        this.totalP = SPConfigMobs.dodsiiiTotalActiveMobs;
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.DODSIII_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.DODSIII_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.0);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.DODSIII_ATTACK_DAMAGE);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(1.0);
        this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111128_a(SPConfig.nexussiiiFollow * (double)SPConfigMobs.dodsiiiFollowRangeMult);
    }
    ...
    public float getBombDamage() {
        return (float)SPAttributes.DODSIII_ATTACK_DAMAGE;
    }
