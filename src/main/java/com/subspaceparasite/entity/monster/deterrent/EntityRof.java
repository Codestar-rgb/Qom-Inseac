...
extends EntityPStationary {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (!this.up && this.field_70173_aa > 120 && !this.buried() && this.targetScent != null) {
                for (int i = 0; i <= this.maxmob; ++i) {
                    this.spawnWaves();
                    if (i < this.minmob || this.field_70146_Z.nextInt(3) != 0) continue;
                    this.targetScent = null;
                }
                this.func_184185_a(SPSounds.ROF_SPIT_OUT, 1.2f, this.func_70647_i());
                this.targetScent = null;
            }
        }
    }
    ...
    protected void retreat(boolean dead) {
        if (this.up) {
            this.func_184185_a(SPSounds.ROF_EMERGE, 1.0f, this.func_70647_i() - 0.1f);
    ...
    private EntityLiving getMobFromList() {
        ...
        return (EntityLiving)EntityList.func_188429_b((ResourceLocation)new ResourceLocation(mob), (World)this.field_70170_p);
    }
    ...
    public int spawnWaves() {
        ...
        out.field_70163_u = this.field_70163_u + (double)this.field_70131_O + 0.5;
        this.setMotion((EntityLivingBase)out, d3 *= (d7 *= (double)(this.field_70170_p.field_73012_v.nextFloat() * this.field_70170_p.field_73012_v.nextFloat() + 0.3f)), d4, d5 *= d7, 0.03, 1.2);
        this.field_70170_p.func_72838_d((Entity)out);
        out.func_70690_d(new PotionEffect(SPPotions.RAGE_E, 1200, 1, false, false));
