...
implements EntityCanShoot {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.UNVO_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.UNVO_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.0);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.UNVO_ATTACK_DAMAGE);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(1.0);
        this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111128_a(SPConfig.turretFollow);
    }
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.UNVO_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.UNVO_DEATH;
    }
    ...
    public EntityFireball getProj(double accelX, double accelY, double accelZ) {
        ...
        EntityProjectileSpineball ball = new EntityProjectileSpineball(this.field_70170_p, (EntityLivingBase)this, accelX, accelY, accelZ, SPAttributes.UNVO_RANGE_ATTACK_DAMAGE);
        ball.setDurationAmplifier(SPConfigMobs.unvoPoisonDuration, SPConfigMobs.unvoPoisonAmplifier);
        ball.setGearDamage(SPConfigMobs.unvoGearD);
        return ball;
    }

    @Override
    public void playProjSound() {
        this.func_184185_a(SPSounds.UNVO_SHOOTING, 2.0f, 1.0f);
    }
}
