...
extends EntityParasiteBase {
    ...
    public EntityCruxB(World worldIn) {
        ...
        if ((atm = SPConfigMobs.cruxMaxGrowTime - SPConfigMobs.cruxMinGrowTime + 1) <= 0 || SPConfigMobs.cruxMaxGrowTime <= SPConfigMobs.cruxMinGrowTime) {
            atm = SPConfigMobs.cruxMinGrowTime;
        }
        this.growing = this.field_70146_Z.nextInt(atm) + SPConfigMobs.cruxMinGrowTime;
        this.st1 = false;
        this.tSize = 1.0f;
        this.aSize = 1.0f;
        this.fuseTime = 70;
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.CRUXA_HEALTH * 0.3);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.CRUXA_ARMOR * 0.3);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.CRUXA_KD_RESISTANCE * 0.3);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.CRUXA_ATTACK_DAMAGE * 0.3);
