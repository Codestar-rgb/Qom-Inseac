...
EntityCutomAttack {
    ...
    public EntityHostII(World worldIn) {
        ...
        if (SPConfig.mobattacking) {
            this.field_70715_bh.func_75776_a(4, new EntityAINearestAttackableTargetStatus<EntityLiving>(this, EntityLiving.class, 0, SPConfig.adaptedWalls, false, new Predicate<EntityLiving>(){
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAISkill(this, 20, (int)SPConfig.adaptedFollow, 2, false, 1, true));
    }
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.HERD_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.HERD_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.12);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(1.0);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.HERD_ATTACK_DAMAGE);
    ...
    public void func_82196_d(EntityLivingBase target, float distanceFactor) {
        ...
        if (this.getBurrowed() && this.field_70131_O > 1.0f) {
            ...
            if (this.field_70146_Z.nextInt(4) == 0 && target.func_70068_e((Entity)this) < 225.0 && target.func_70068_e((Entity)this) > 25.0) {
                ...
                bomb.setStren(0.0f);
                bomb.setSkin(1);
                bomb.setDamage((float)SPAttributes.HERD_BOMBDAMAGE, 5);
            ...
            EntityProjectileSpineball ball = entitylargefireball = new EntityProjectileSpineball(this.field_70170_p, (EntityLivingBase)this, d2, d3, d4, SPAttributes.EMANA_RANGED_DAMAGE);
