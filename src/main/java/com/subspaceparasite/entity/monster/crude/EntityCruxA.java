...
implements EntityCutomAttack {
    ...
    public EntityCruxA(World worldIn) {
        ...
        this.field_70715_bh.func_75776_a(4, new EntityAINearestAttackableTargetStatus<EntityPlayer>(this, EntityPlayer.class, 0, false, false, null, SPConfig.primitiveSneakPen, SPConfig.primitiveInviPen));
        ...
        this.extraDamageCap = SPConfigMobs.cruxaDamageCap;
        this.baseDamage = -1.0;
        this.cooldownBack = 0;
        this.canBack = true;
    }
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIAttackMeleeStatusAOE(this, 1.3, true, 0.0, 3.0));
    }

    protected void func_110147_ax() {
        super.func_110147_ax();
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.CRUXA_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.CRUXA_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.24);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.CRUXA_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.CRUXA_ATTACK_DAMAGE);
    ...
    private void popBack() {
        if (this.canBack) {
            ...
            this.canBack = false;
            this.func_184185_a(SPSounds.MOBEXPLOTION, 3.0f, 1.0f);
            this.cooldownBack = 0;
            if (this.field_70170_p.field_72995_K) {
                int i;
                for (i = 0; i <= 180; ++i) {
                    if (i % 5 != 0) continue;
                    this.spawnParticlesGore(SPEnumParticle.GSPLASH, 0, -1, -1, 5.0, 9.0);
                }
                for (i = 0; i <= 80; ++i) {
                    if (i % 5 == 0) {
            ...
            for (int i = 0; i < 7 && SPConfig.paraGore; ++i) {
                ...
                d3 = d3 * (d7 *= (double)(this.field_70170_p.field_73012_v.nextFloat() * this.field_70170_p.field_73012_v.nextFloat() + 0.3f)) * 7.0;
                d4 = d4 * d7 * 12.0;
                d5 = d5 * d7 * 7.0;
    ...
    public void func_70074_a(EntityLivingBase entityLivingIn) {
        ...
        if (this.baseDamage == -1.0) {
            this.baseDamage = this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111125_b() * SPConfigMobs.cruxaDamageGain;
        }
    ...
    protected SoundEvent func_184639_G() {
        ...
        return SPSounds.CRUX_GROWL;
    }

    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        return SPSounds.CRUX_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.CRUX_DEATH;
    }
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (SPConfigSystems.rageEnable) {
            this.func_70690_d(new PotionEffect(SPPotions.RAGE_E, 1333320, 0, false, false));
        }
        return floo;
    }
    ...
    private boolean checkBlock(Block in, IBlockState state, BlockPos pos) {
        return in == Blocks.field_150350_a || in instanceof BlockLiquid || !state.func_185913_b() || state.func_185887_b(this.field_70170_p, pos) <= 0.0f || this.blockException(in.getRegistryName().toString());
    }
}
