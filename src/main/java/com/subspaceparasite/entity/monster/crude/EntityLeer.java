...
implements EntityCanPullMobs {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.LEER_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.LEER_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.LEER_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.LEER_ATTACK_DAMAGE);
    ...
    public void func_70074_a(EntityLivingBase entityLivingIn) {
        ...
        if (SPConfigSystems.useEvolution) {
            if (this.func_70644_a(SPPotions.PIVOT_E)) {
                ...
                SPSaveData.get(this.field_70170_p, 35).setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SPConfigSystems.valueKill * (SPConfigSystems.pivotPointMultiplier * (amp + 1)), true, this.field_70170_p, true, 38);
            } else {
                SPSaveData.get(this.field_70170_p, 34).setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SPConfigSystems.valueKill, true, this.field_70170_p, true, 39);
            }
        }
