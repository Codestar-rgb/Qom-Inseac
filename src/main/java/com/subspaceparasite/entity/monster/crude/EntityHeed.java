...
implements EntityBodyParts {
    ...
    public EntityHeed(World worldIn) {
        ...
        if (SPConfig.mobattacking) {
            this.field_70715_bh.func_75776_a(4, new EntityAINearestAttackableTargetStatus<EntityLiving>(this, EntityLiving.class, 0, !SPConfigSystems.useOneMind, false, new Predicate<EntityLiving>(){
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.HEED_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.HEED_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.32);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.HEED_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.HEED_ATTACK_DAMAGE);
    ...
    private void throwBlock() {
        ...
        for (EntityParasiteBase entityIn : moblist) {
            if (entityIn == this || !SPConfigSystems.rageEnable) continue;
            entityIn.func_70690_d(new PotionEffect(SPPotions.RAGE_E, 1200, 0, false, false));
        }
