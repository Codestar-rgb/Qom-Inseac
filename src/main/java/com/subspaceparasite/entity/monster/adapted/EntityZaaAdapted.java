...
implements EntityCanHaveBodies {
    ...
    private static final DataParameter<Byte> PART = EntityDataManager.func_187226_a(EntityZaaAdapted.class, (DataSerializer)DataSerializers.field_187191_a);
    private static final DataParameter<Boolean> TAIL = EntityDataManager.func_187226_a(EntityZaaAdapted.class, (DataSerializer)DataSerializers.field_187198_h);
    private static final DataParameter<Boolean> DIG = EntityDataManager.func_187226_a(EntityZaaAdapted.class, (DataSerializer)DataSerializers.field_187198_h);
    ...
    protected void func_184651_r() {
        this.field_70714_bg.func_75776_a(1, (EntityAIBase)new EntityAIFollowBodies(this, 1.9f, 0.32, 5, 10000.0, 80));
    ...
    public void setDigging(boolean in) {
        if (in) {
            this.func_184185_a(SPSounds.AZAA_DIG, 2.0f, this.func_70647_i());
        }
