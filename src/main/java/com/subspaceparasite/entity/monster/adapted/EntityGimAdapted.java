...
extends EntityPAdapted {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.GIM_HEALTH + SPAttributes.GIM_A_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.GIM_ARMOR + SPAttributes.GIM_A_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.33);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.GIM_KD_RESISTANCE + SPAttributes.GIM_A_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.GIM_ATTACK_DAMAGE + SPAttributes.GIM_A_ATTACK_DAMAGE);
    ...
    public boolean scaryOrbEffect(EntityLivingBase in, int mobs) {
        ...
        if (flag) {
            ParasiteEventEntity.orbApplyEffects(in, this, SPConfigMobs.gimadaptedOrbEffects, mobs);
        }
        return flag;
    }
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.AGIM_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.AGIM_DEATH;
    }
