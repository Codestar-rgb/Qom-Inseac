...
EntityCutomAttack {
    ...
    private boolean up;
    private static final DataParameter<Byte> PART = EntityDataManager.func_187226_a(EntityWymoAdapted.class, (DataSerializer)DataSerializers.field_187191_a);
    private static final DataParameter<Boolean> TAIL = EntityDataManager.func_187226_a(EntityWymoAdapted.class, (DataSerializer)DataSerializers.field_187198_h);
    private static final DataParameter<Boolean> DIG = EntityDataManager.func_187226_a(EntityWymoAdapted.class, (DataSerializer)DataSerializers.field_187198_h);

    public EntityWymoAdapted(World worldIn) {
        super(worldIn);
    ...
    protected void func_184651_r() {
        this.field_70714_bg.func_75776_a(1, (EntityAIBase)new EntityAIFollowBodies(this, 1.9f, 0.32, 5, 10000.0, 140));
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIAttackMeleeStatusAOE(this, 1.3, false, 0.0, 4.0));
    }

    protected void func_110147_ax() {
        super.func_110147_ax();
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.WYMO_HEALTH + SPAttributes.WYMO_A_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.WYMO_ARMOR + SPAttributes.WYMO_A_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.32);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(1.0);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.WYMO_ATTACK_DAMAGE + SPAttributes.WYMO_A_ATTACK_DAMAGE);
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.AWYMO_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.AWYMO_DEATH;
    }

    protected void func_180429_a(BlockPos pos, Block blockIn) {
        this.func_184185_a(SPSounds.MOBSILENCE, 0.15f, 1.0f);
    }
    ...
    public void setDigging(boolean in) {
        if (in) {
            this.func_184185_a(SPSounds.AWYMO_DIG, 2.0f, this.func_70647_i());
        }
    ...
    public void bodyPartEffect() {
        ...
        if (this.getBodyNumber() >= 1 && this.getBodyNumber() <= 3) {
            AxisAlignedBB axisalignedbb = new AxisAlignedBB(this.func_180425_c()).func_186662_g(5.0);
            List moblist = this.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb);
            for (EntityLivingBase mob : moblist) {
                EntityPlayer player;
