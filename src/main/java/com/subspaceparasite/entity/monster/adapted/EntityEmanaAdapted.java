...
EntityCanFly {
    ...
    public EntityEmanaAdapted(World worldIn) {
        ...
        this.tendril_1 = new EntityHitbox((EntityLiving)this, 0.2f, 1.1f, 0.1f, 0.9f, 2.6f, 1.25f);
        this.tendril_2 = new EntityHitbox((EntityLiving)this, 3.0f, 1.1f, 0.1f, 0.9f, 2.6f, 1.25f);
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.EMANA_HEALTH + SPAttributes.EMANA_A_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.EMANA_ARMOR + SPAttributes.EMANA_A_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.EMANA_KD_RESISTANCE + SPAttributes.EMANA_A_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111128_a(SPConfig.adaptedFollow);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.EMANA_A_MELLE);
    }
    ...
    protected SoundEvent func_184601_bQ(DamageSource damageSourceIn) {
        ...
        return SPSounds.AEMANA_HURT;
    }

    protected SoundEvent func_184615_bR() {
        return SPSounds.AEMANA_DEATH;
    }
    ...
    public EntityFireball getProj(double accelX, double accelY, double accelZ) {
        ...
        EntityProjectileSpineball ball = new EntityProjectileSpineball(this.field_70170_p, (EntityLivingBase)this, accelX, accelY, accelZ, SPAttributes.EMANA_A_RANGED_DAMAGE);
        ball.setDurationAmplifier(SPConfigMobs.emanaPoisonDuration * 2, SPConfigMobs.emanaPoisonAmplifier + 1);
        ball.setGearDamage(SPConfigMobs.emanaadaptedgeard);
        return ball;
    }
    ...
    public void playProjSound() {
        ...
        if (this.count == 3) {
            ...
            this.func_184185_a(SPSounds.ATTACKEMANA, 4.0f, v);
            return;
        }
        this.func_184185_a(SPSounds.AEMANA_SHOOTINGPOST, 2.0f, 1.0f);
    }
