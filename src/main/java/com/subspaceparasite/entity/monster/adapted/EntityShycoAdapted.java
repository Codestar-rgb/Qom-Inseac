...
EntityCanClimb {
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAISkill(this, 80, (int)(SPConfig.adaptedFollow * 0.7), 2, false, 1));
    ...
    public boolean scaryOrbEffect(EntityLivingBase in, int mobs) {
        ...
        if (flag) {
            ParasiteEventEntity.orbApplyEffects(in, this, SPConfigMobs.shycoadaptedOrbEffects, mobs);
        }
        return flag;
    }
    ...
    private void shockwave() {
        ...
        if (this.border == 0) {
            ...
            this.func_184185_a(SPSounds.ATTACKSHYCO, 4.0f, v);
            ++this.border;
            return;
        }
        if (this.border <= 2) {
