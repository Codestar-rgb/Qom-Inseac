...
extends EntityParasiteBase {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.RATHOL_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.RATHOL_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.2);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.RATHOL_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.RATHOL_DAMAGE);
    ...
    protected void selfExplode() {
            ...
            case 1: {
                ...
                if (!this.field_70170_p.field_72995_K) {
                    ...
                    for (EntityLivingBase mob : moblist) {
                        ...
                        mob.func_70690_d(new PotionEffect(SPPotions.VOMIT_E, 600, 0, false, true));
                    }
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            this.func_70106_y();
            this.spawnLingeringCloud();
            ParasiteSummon.spawnM(this, SPConfigMobs.ratholMobs, 0, false, this.func_95999_t());
        }
    }
