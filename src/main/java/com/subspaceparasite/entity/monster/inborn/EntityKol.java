    ...
    extends EntityAIBase {
            ...
            for (int x = flag.func_177958_n() - range; x <= flag.func_177958_n() + range; ++x) {
                for (int z = flag.func_177952_p() - range; z <= flag.func_177952_p() + range; ++z) {
                    ...
                    if (this.checkPosition(x, z) == this.defence) {
                        ...
                        this.entity.field_70170_p.func_175656_a(spot.func_177977_b(), SPBlocks.ParasiteStructure.func_176223_P().func_177226_a((IProperty)BlockColonyStructure.ACTIVE, (Comparable)Integer.valueOf(2)));
                        this.func_75251_c();
                        return;
                    }
                    ...
                    this.entity.field_70170_p.func_175656_a(spot.func_177977_b(), SPBlocks.ParasiteStructure.func_176223_P().func_177226_a((IProperty)BlockColonyStructure.ACTIVE, (Comparable)Integer.valueOf(1)));
                    this.func_75251_c();
                    return;
                }
            }
        ...
        private boolean checkArea(World world, BlockPos pos) {
            ...
            for (int i = yy - a; i <= yy + a; ++i) {
                ...
                if (block != SPBlocks.ParasiteStructure && block != SPBlocks.ColonyHeart && block != SPBlocks.BiomeHeart) continue;
                return true;
            }
            return false;
        }
