...
extends EntityParasiteBase {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.ATA_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.ATA_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.34559);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.ATA_ATTACK_DAMAGE);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.ATA_KD_RESISTANCE);
    ...
    protected void func_82167_n(Entity entityIn) {
        ...
        if (entityIn == this.func_70638_az()) {
            ...
            SPMain.network.sendToAll((IMessage)new SPPacketParticle(this.field_70165_t, this.field_70163_u, this.field_70161_v, 0.5f, 0.5f, 10));
            SPMain.network.sendToAll((IMessage)new SPPacketParticle(this.field_70165_t, this.field_70163_u, this.field_70161_v, 0.5f, 0.5f, 10));
            this.func_184185_a(SPSounds.BUTHOL_BOOM, 0.3f, (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2f + 1.0f);
