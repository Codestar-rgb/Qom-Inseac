...
extends EntityParasiteBase {
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(SPAttributes.GOTHOL_HEALTH);
        this.func_110148_a(SharedMonsterAttributes.field_188791_g).func_111128_a(SPAttributes.GOTHOL_ARMOR);
        this.func_110148_a(SharedMonsterAttributes.field_111263_d).func_111128_a(0.2);
        this.func_110148_a(SharedMonsterAttributes.field_111266_c).func_111128_a(SPAttributes.GOTHOL_KD_RESISTANCE);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(SPAttributes.GOTHOL_DAMAGE);
    ...
    protected void selfExplode() {
        if (!this.field_70170_p.field_72995_K) {
            ...
            for (int k2 = -1 * range; k2 <= 1 * range; ++k2) {
                for (int l2 = -1 * range; l2 <= 1 * range; ++l2) {
                    ...
                    this.field_70170_p.func_175656_a(blockpos, SPBlocks.InfestRemain.func_176203_a(1));
                }
            }
        }
        switch (this.getSkin()) {
            case 1: {
                boolean flag = ForgeEventFactory.getMobGriefingEvent((World)this.field_70170_p, (Entity)this) && SPConfigMobs.gotholGriefing;
                ...
                if (!this.field_70170_p.field_72995_K) {
                    ...
                    for (EntityLivingBase mob : moblist) {
                        ...
                        SPPotions.applyStackPotion(SPPotions.VIRA_E, mob, 400, 4);
                        mob.func_70690_d(new PotionEffect(SPPotions.VOMIT_E, 500, 0, false, true));
                    }
                    this.func_184185_a(SPSounds.RATHOL_BOOM, 2.0f, 1.0f);
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            for (EntityLivingBase mob : moblist) {
                if (mob instanceof EntityParasiteBase) continue;
                SPPotions.applyStackPotion(SPPotions.VIRA_E, mob, 400, 2);
                mob.func_70690_d(new PotionEffect(SPPotions.VOMIT_E, 500, 0, false, true));
            }
            this.func_184185_a(SPSounds.RATHOL_BOOM, 2.0f, 1.0f);
            this.field_70729_aU = true;
            this.func_70106_y();
            this.spawnLingeringCloud();
            ParasiteSummon.spawnM(this, SPConfigMobs.gotholMobs, 0, false, this.func_95999_t());
        }
    }
