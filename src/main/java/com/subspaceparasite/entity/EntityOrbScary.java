...
extends Entity {
    ...
    public void func_70071_h_() {
        ...
        if (!this.field_70170_p.field_72995_K && this.field_70173_aa == 1) {
            this.func_184185_a(SPSounds.ORB_SUMMON, 1.0f, 1.0f);
            this.func_184185_a(SPSounds.ORB_IDLE, 1.0f, 1.0f);
        }
    ...
    protected void selfExplode() {
        ...
        if (this.getSelfeState() == 2) {
            ...
            if (this.timerDDD > 35) {
                ...
                this.func_184185_a(SPSounds.ORB_E, 1.0f, (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2f + 1.0f);
                if (this.timerDDD > 45) {
                    this.func_70106_y();
                }
            }
