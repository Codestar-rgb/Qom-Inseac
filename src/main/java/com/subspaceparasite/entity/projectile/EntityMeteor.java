...
import com.subspaceparasite.world.gen.feature.WorldGenParasiteMeteorCrash;
...
extends Entity {
    ...
    public void func_70071_h_() {
        ...
        if (!this.field_70170_p.field_72995_K && this.getRoot() && this.field_70173_aa % 20 == 0) {
            ...
            for (EntityPlayer mob : players) {
                ...
                SPNetwork.CHANNEL.sendTo((IMessage)new MsgQlipShake(20, 0, false, true, str * 2.0f), (EntityPlayerMP)mob);
            }
    ...
    protected void onImpact() {
        if (!this.field_70170_p.field_72995_K) {
                ...
                if (mobs.size() != 0) {
                    for (Entity mob : mobs) {
                        ...
                        if (mob instanceof EntityPlayer && (str = EntityMeteor.getDistancePack(this.func_180425_c(), mob.func_180425_c(), 400)) > 0.0f) {
                            SPNetwork.CHANNEL.sendTo((IMessage)new MsgQlipShake(150, 0, false, true, str * 8.0f), (EntityPlayerMP)mob);
                        }
                        if ((str = EntityMeteor.getDistancePack(this.func_180425_c(), mob.func_180425_c(), SPConfigWorld.meteorDamage)) > 0.0f) {
                        ...
                        ((EntityLivingBase)mob).func_70690_d(new PotionEffect(SPPotions.COTH_E, 1200, 0, false, false));
                    }
                }
            }
            int rad = 40;
            ...
            if (this.getRoot() && SPConfigWorld.originActivated) {
