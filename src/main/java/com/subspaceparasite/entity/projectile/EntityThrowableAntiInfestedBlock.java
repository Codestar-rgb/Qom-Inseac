                ...
                for (int l2 = -1 * range; l2 <= 1 * range; ++l2) {
                    for (int j = -1 * offsetT; j <= 1 * offsetT; ++j) {
                        ...
                        if (block == SPBlocks.InfestedStain) {
                            this.field_70170_p.func_175656_a(blockpos, SPBlocks.InfestedStain.func_176223_P().func_177226_a((IProperty)BlockInfestedStain.STAGE, (Comparable)Integer.valueOf(5)));
                            this.field_70170_p.func_175654_a(blockpos, SPBlocks.InfestedStain.func_176223_P().func_177226_a((IProperty)BlockInfestedStain.STAGE, (Comparable)Integer.valueOf(5)).func_177230_c(), 40, 5);
                        }
                        if (block != SPBlocks.InfestedRubble) continue;
                        this.field_70170_p.func_175656_a(blockpos, SPBlocks.InfestedRubble.func_176223_P().func_177226_a((IProperty)BlockInfestedRubble.STAGE, (Comparable)Integer.valueOf(5)));
                        this.field_70170_p.func_175654_a(blockpos, SPBlocks.InfestedRubble.func_176223_P().func_177226_a((IProperty)BlockInfestedRubble.STAGE, (Comparable)Integer.valueOf(5)).func_177230_c(), 40, 5);
                    }
                }
            }
            this.func_70106_y();
