...
extends MultiPartEntityPart {
    ...
    public boolean func_70097_a(DamageSource source, float amount) {
        if (this.field_70170_p.field_72995_K && (source.func_76364_f() instanceof EntityPlayer || source.func_76346_g() instanceof EntityPlayer)) {
            SPNetwork.CHANNEL.sendToServer((IMessage)new HitboxHit(this.getParent(), amount * this.dmgVuln, true));
        }
    ...
    public boolean func_184230_a(EntityPlayer player, EnumHand hand) {
        if (this.field_70170_p.field_72995_K) {
            SPNetwork.CHANNEL.sendToServer((IMessage)new HitboxHit(this.getParent(), 0.0f, false));
        }
