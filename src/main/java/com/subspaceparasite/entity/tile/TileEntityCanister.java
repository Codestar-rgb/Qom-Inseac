...
implements ITickable {
    ...
    public void func_73660_a() {
        ...
        if (!this.field_145850_b.field_72995_K && this.ticksSinceSync % 20 == 0 && this.ticksSinceSync > 20 * SPConfig.cystDelay) {
            int ccc = 0;
            for (int in = 0; in < this.func_70302_i_(); ++in) {
                if (((IItemHandler)Objects.requireNonNull(this.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null))).getStackInSlot(in).func_77973_b() != Items.field_190931_a) {
                    ...
                    if (ParasiteEventEntity.checkName(Objects.requireNonNull(stack.func_77973_b().getRegistryName()).toString(), SPConfig.cystItemBlackList, false)) continue;
                    if (stack.func_77984_f()) {
                        if (stack.func_96631_a(5, this.field_145850_b.field_73012_v, null)) {
                            stack.func_190918_g(1);
                            if (SPConfigSystems.useEvolution) {
                                SPSaveData data = SPSaveData.get(this.field_145850_b, 45);
                                data.setTotalKills(this.field_145850_b.field_73011_w.getDimension(), SPConfig.cystConsumePoint, true, this.field_145850_b, true, 43);
                            }
                        }
                    } else {
                        stack.func_190918_g(1);
                        if (SPConfigSystems.useEvolution) {
                            SPSaveData data = SPSaveData.get(this.field_145850_b, 46);
                            data.setTotalKills(this.field_145850_b.field_73011_w.getDimension(), SPConfig.cystConsumePoint, true, this.field_145850_b, true, 44);
                        }
                    }
                    if (this.field_145850_b.field_73012_v.nextBoolean()) {
                        this.field_145850_b.func_184148_a(null, (double)this.field_174879_c.func_177958_n(), (double)this.field_174879_c.func_177956_o(), (double)this.field_174879_c.func_177952_p(), SPSounds.CYST_EATING, SoundCategory.HOSTILE, 0.25f, 1.0f);
                    }
                    SPMain.network.sendToAll((IMessage)new SPPacketParticle((double)this.field_174879_c.func_177958_n() + 0.5, (double)this.field_174879_c.func_177956_o() + 0.7, (double)this.field_174879_c.func_177952_p() + 0.5, 0.5f, 0.5f, 2));
                    return;
                }
                ++ccc;
            }
            if (ccc == this.func_70302_i_()) {
                if (this.field_145850_b.func_180495_p(this.field_174879_c.func_177977_b()).func_177230_c() != Blocks.field_150350_a) {
                    this.field_145850_b.func_175656_a(this.field_174879_c, SPBlocks.ParasiteCanister.func_176223_P().func_177226_a(BlockParasiteCanister.VARIANT, (Comparable)((Object)BlockParasiteCanister.EnumType.CYST)));
                } else {
    ...
    public String func_174875_k() {
        return "subspaceparasite:canister";
    }
