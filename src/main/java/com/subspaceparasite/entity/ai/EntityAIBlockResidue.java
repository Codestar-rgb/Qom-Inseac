    ...
    public void func_75246_d() {
        if (this.blockBreakCounter > 0) {
            ...
            if (this.blockBreakCounter == -1) {
                ...
                this.parent.func_184185_a(SPSounds.ADAPTED_V, 2.0f, 1.0f);
            }
            ...
            if (this.blockBreakCounter == -60) {
                ...
                for (int k2 = -1 * this.range; k2 <= 1 * this.range; ++k2) {
                    for (int l2 = -1 * this.range; l2 <= 1 * this.range; ++l2) {
                        ...
                        if (block != Blocks.field_150350_a || blockDown == Blocks.field_150350_a || !world.func_180495_p(blockpos.func_177977_b()).func_185913_b() || blockDown == SPBlocks.InfestedStain || this.parent.field_70170_p.field_73012_v.nextInt(2) != 0) continue;
                        this.parent.field_70170_p.func_175656_a(blockpos, SPBlocks.InfestRemain.func_176203_a(1));
                    }
                }
            }
