...
extends EntityAIBase {
    ...
    public EntityAIFollowBodies(EntityParasiteBase in, double pushDistance, double movement, int digCooldown, double evolution, int digSkillCool) {
        this.parent = in;
        this.worm = (EntityCanHaveBodies)((Object)in);
    ...
    private void followHead() {
        ...
        double dis = this.parent.func_70068_e((Entity)follo2);
        ...
        if (dis > checkDis * checkDis) {
            ...
            if (dis > 9.0) {
                this.parent.func_82149_j((Entity)follo2);
            }
            if ((distance = Math.sqrt((deltaX = follo2.field_70165_t - this.parent.field_70165_t) * deltaX + (deltaY = follo2.field_70163_u - this.parent.field_70163_u) * deltaY + (deltaZ = follo2.field_70161_v - this.parent.field_70161_v) * deltaZ)) == 0.0) {
                return;
            }
            this.parent.field_70159_w += (deltaX /= distance) * str;
            this.parent.field_70181_x += (deltaY /= distance) * str;
            this.parent.field_70179_y += (deltaZ /= distance) * str;
    ...
    private void diggingTeleport() {
        ...
        if (this.parent.srpTicks == 10) {
            ...
            if (this.worm.getDigging()) {
                ...
                double distanceEn = this.parent.func_70068_e((Entity)this.parent.func_70638_az());
                if ((distanceEn > 196.0 || !this.parent.func_70685_l((Entity)this.parent.func_70638_az()) && distanceEn > 49.0) && this.digSkill > this.digSkillCooldown) {
                    this.digSkill = 0;
                    this.worm.setDigging(true);
                    this.worm.setTargetPos(this.parent.func_70638_az().func_180425_c());
                }
