...
extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        return (this.parent.func_70638_az() != null || this.inC) && this.parent.getParasiteStatus() > 0 && this.parent.getParasiteStatus() < 3 && this.parent.field_70122_E;
    }
        ...
        if (target != null || this.inC) {
            if (this.inC) {
                ...
                if (this.cooldown >= this.eCooldown) {
                    ...
                    this.parent.field_70159_w += dd0 / (double)f * this.dash * (double)0.8f + this.parent.field_70159_w * (double)0.2f + i;
                    this.parent.field_70179_y += dd1 / (double)f * this.dash * (double)0.8f + this.parent.field_70179_y * (double)0.2f + j;
