...
extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        ...
        if (this.host.field_70170_p.func_82737_E() < this.nextAllowedTick) {
            return false;
        }
    ...
    public void func_75246_d() {
        ...
        switch (this.phase) {
            case ASCEND: {
                ...
                RayTraceResult up = this.host.field_70170_p.func_147447_a(start, end, false, true, false);
                if (up != null && up.field_72313_a == RayTraceResult.Type.BLOCK) {
                ...
                if (tA == null) break;
                this.faceTowards(tA.field_70165_t, tA.field_70163_u + (double)tA.func_70047_e() * 0.5, tA.field_70161_v);
                break;
            }
            case HOVER: {
                this.host.func_189654_d(true);
                ...
                this.faceTowards(tH.field_70165_t, tH.field_70163_u + (double)tH.func_70047_e() * 0.5, tH.field_70161_v);
                ++this.hoverTicks;
                int need = 20;
                if (this.hoverTicks < need) break;
                this.lockedTargetPos = new Vec3d(tH.field_70165_t, tH.field_70163_u + (double)tH.func_70047_e() * 0.5, tH.field_70161_v);
            ...
            case DIVE: {
                ...
                ++this.diveTicks;
                Vec3d start = new Vec3d(this.host.field_70165_t, this.host.field_70163_u, this.host.field_70161_v);
                Vec3d next = new Vec3d(this.host.field_70165_t + this.host.field_70159_w, this.host.field_70163_u + this.host.field_70181_x, this.host.field_70161_v + this.host.field_70179_y);
                ...
                if (tD != null && tD.func_70089_S()) {
                    ...
                    if (this.host.func_70068_e((Entity)tD) < 2.25) {
                        this.explodeAndFinish();
                        return;
                    }
                    Vec3d aim = new Vec3d(tD.field_70165_t, tD.field_70163_u + (double)tD.func_70047_e() * 0.5, tD.field_70161_v);
    ...
    private void applyDiveVector(Vec3d target, double speed) {
        ...
        this.host.field_70133_I = true;
        this.faceTowards(this.host.field_70165_t + this.host.field_70159_w, this.host.field_70163_u + this.host.field_70181_x, this.host.field_70161_v + this.host.field_70179_y);
    }

    private void explodeAndFinish() {
        this.host.field_70170_p.func_72885_a((Entity)this.host, this.host.field_70165_t, this.host.field_70163_u, this.host.field_70161_v, this.explosionPower, false, false);
        this.finish(true);
    }
    ...
    private void finish(boolean setCd) {
        ...
        if (setCd) {
            this.nextAllowedTick = this.host.field_70170_p.func_82737_E() + (long)this.cooldownTicks;
        }
    }
    ...
    private void faceTowards(double x, double y, double z) {
        ...
        this.host.field_70177_z = yaw = (float)(MathHelper.func_181159_b((double)dz, (double)dx) * 57.29577951308232) - 90.0f;
