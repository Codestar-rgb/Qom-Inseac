...
extends EntityAIBase {
    ...
    public void func_75249_e() {
        ...
        this.kirin.func_184185_a(SPSounds.OMBOO_DEATH, 1.0f, 0.9f);
    }
    ...
    public void func_75246_d() {
        ...
        if (!this.world.field_72995_K && this.chargeTicks <= 0) {
            ...
            this.kirin.func_184185_a(SPSounds.INFECTEDENDERMAN_PORTAL, 1.0f, 1.0f);
    ...
    private void doBlinkLifeSteal() {
        ...
        List nearby = this.world.func_175647_a(EntityLivingBase.class, box, e -> e != null && e != this.kirin && e.func_70089_S() && !this.isSPEntity((EntityLivingBase)e));
        if (nearby.isEmpty()) {
            this.world.func_184148_a(null, this.kirin.field_70165_t, this.kirin.field_70163_u, this.kirin.field_70161_v, SPSounds.ALAFHA_HURT, SoundCategory.HOSTILE, 0.7f, 0.9f + this.kirin.func_70681_au().nextFloat() * 0.2f);
            return;
        }
        ...
        this.world.func_184148_a(null, target.field_70165_t, target.field_70163_u, target.field_70161_v, SPSounds.CRUX_HURT, SoundCategory.HOSTILE, 1.0f, 0.8f + this.kirin.func_70681_au().nextFloat() * 0.4f);
        if (stolen > 0.0f) {
    ...
    private boolean isSPEntity(EntityLivingBase entity) {
        String name = entity.getClass().getName();
        return name.startsWith("com.subspaceparasite.entity");
    }
