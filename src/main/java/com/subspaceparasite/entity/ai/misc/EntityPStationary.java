...
extends EntityPMalleable {
    ...
    public EntityPStationary(World worldIn) {
        ...
        this.onlyPeek = false;
        this.relocate = false;
        this.valueEvDeath = SPConfig.turretLoosingEPValue;
        this.delayBuried = 0;
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (SPConfigSystems.useEvolution && this.srpTicks == 20 && SPConfigSystems.damageStationaryRS && ParasiteEventEntity.getRSchance(this.field_70170_p) == 0.0) {
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (source.func_76346_g() instanceof EntityLivingBase && (attacker = (EntityLivingBase)source.func_76346_g()).func_70644_a(SPPotions.KILLNEX_E)) {
            int amp = attacker.func_70660_b(SPPotions.KILLNEX_E).func_76458_c();
    ...
    protected boolean onDeathDislo(DamageSource cause) {
        ...
        if (!flag && cause.func_76346_g() instanceof EntityLivingBase) {
            int count = SPSaveData.get(this.field_70170_p, 27).getCurrentCode(this.field_70170_p.field_73011_w.getDimension(), 22);
            ...
            if (count >= 1) {
                ...
                SPPotions.applyStackPotion(SPPotions.KILLNEX_E, target, 1200, count);
            }
        }
        return flag;
    }
