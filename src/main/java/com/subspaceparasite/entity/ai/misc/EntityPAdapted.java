...
extends EntityPMalleable {
    public EntityPAdapted(World worldIn) {
        super(worldIn);
        this.field_70715_bh.func_75776_a(4, new EntityAINearestAttackableTargetStatus<EntityPlayer>(this, EntityPlayer.class, 0, SPConfig.adaptedWalls, false, null, SPConfig.adaptedSneakPen, SPConfig.adaptedInviPen));
        ...
        if (SPConfig.mobattacking) {
            this.field_70715_bh.func_75776_a(4, new EntityAINearestAttackableTargetStatus<EntityLiving>(this, EntityLiving.class, 0, SPConfig.adaptedWalls, false, entity -> !(entity instanceof EntityWaterMob) && !(entity instanceof EntityAnimal) && !(entity instanceof EntityVillager) && !ParasiteEventEntity.checkEntity((EntityLivingBase)entity, SPConfig.mobattackingBlackList, SPConfig.mobattackingBlackListWhite), SPConfig.adaptedSneakPen, SPConfig.adaptedInviPen));
        }
        this.field_70728_aV = SPAttributes.XP_ADAPTED;
        this.canD = SPConfig.adapteddespawn;
        this.damageCap = SPConfig.adaptedCap;
        this.canModRender = 1;
        this.type = (byte)41;
        this.fuseOrb = 16;
        this.orbStartTimer = 15;
        this.foodSteal = SPConfig.adaptedFoodSteal;
        this.orbItemCool = SPConfig.adaptedItemOrbCooldown * 20;
        this.pointCap = SPConfig.adaptedPointCap;
        this.pointReduction = SPConfig.adaptedPointRed;
        this.chanceLearn = SPConfig.adaptedChanceLe;
        this.chanceLearnFire = SPConfig.adaptedChanceLeFire;
        this.DamageTypeCap = SPConfig.adaptedPointDamCap;
        this.MiniDamage = SPConfig.adaptedMinDamage;
        this.regen = SPConfig.adaptedRegen * SPConfig.globalHealthMultiplier;
        this.oneMindDeathValue = SPConfig.adaptedOneMindDeathV;
        this.regenEff = 10;
        this.foodRott = SPConfig.adaptedFoodChance;
        this.foodRootNumber = SPConfig.adaptedFoodAmount;
        this.cothSpread = SPConfigSystems.cothAdapted;
        this.valueEvDeath = SPConfig.adaptedLoosingEPValue;
        ...
        if (!SPConfigSystems.useEvolution) {
            ...
            if (this.func_104002_bU()) {
                ...
                if (result == Event.Result.DENY) {
                    ...
                    SPSaveData data = SPSaveData.get(this.field_70170_p, 22);
                    if (this.field_70173_aa > 10) {
                        data.setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SPConfigSystems.valueEvolutionDespawn, true, this.field_70170_p, true, 34);
                    }
                    this.spawnCyst();
                    this.storeBefDes();
                    this.func_70106_y();
                ...
                if (entity != null) {
                    ...
                    if (flag && d3 > 16384.0) {
                        data = SPSaveData.get(this.field_70170_p, 23);
                        if (this.field_70173_aa > 10) {
                            data.setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SPConfigSystems.valueEvolutionDespawn, true, this.field_70170_p, true, 35);
                        }
                        this.spawnCyst();
                        this.storeBefDes();
                        this.func_70106_y();
                    ...
                    if (this.field_70708_bq > 600 && this.field_70146_Z.nextInt(800) == 0 && d3 > 1024.0 && flag) {
                        data = SPSaveData.get(this.field_70170_p, 24);
                        if (this.field_70173_aa > 10) {
                            data.setTotalKills(this.field_70170_p.field_73011_w.getDimension(), SPConfigSystems.valueEvolutionDespawn, true, this.field_70170_p, true, 36);
                        }
                        this.spawnCyst();
                        this.storeBefDes();
                        this.func_70106_y();
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (source.func_76346_g() instanceof EntityLivingBase && (attacker = (EntityLivingBase)source.func_76346_g()).func_70644_a(SPPotions.KILLADA_E)) {
            int amp = Objects.requireNonNull(attacker.func_70660_b(SPPotions.KILLADA_E)).func_76458_c();
    ...
    protected void attackEntityFromEffects(int range, int count) {
        ...
        for (int k2 = -1 * range; k2 <= range && SPConfig.paraGore; ++k2) {
            for (int l2 = -1 * range; l2 <= range; ++l2) {
                ...
                this.field_70170_p.func_175656_a(blockpos, SPBlocks.goreAda.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.FLAT)));
    ...
    protected void spawnGore() {
        ...
        if (this.field_70170_p.func_180495_p(this.func_180425_c().func_177977_b()).func_185913_b() && (this.field_70170_p.func_180495_p(this.func_180425_c()).func_177230_c() instanceof BlockBush || this.field_70170_p.func_180495_p(this.func_180425_c()).func_177230_c() == Blocks.field_150350_a)) {
            this.field_70170_p.func_175656_a(this.func_180425_c(), SPBlocks.goreAda.func_176223_P().func_177226_a(BlockGore.VARIANT, (Comparable)((Object)BlockGore.EnumType.BIG)));
            ...
            nnn.setGoal(20 * SPConfig.adaptedRemainValue);
    ...
    protected boolean onDeathDislo(DamageSource cause) {
        ...
        if (!flag && cause.func_76346_g() instanceof EntityLivingBase) {
            int count = SPSaveData.get(this.field_70170_p, 25).getCurrentCode(this.field_70170_p.field_73011_w.getDimension(), 22);
            ...
            if (count >= 1) {
                ...
                SPPotions.applyStackPotion(SPPotions.KILLADA_E, target, 1200, count);
            }
        }
        return flag;
    }
