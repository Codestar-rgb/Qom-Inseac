...
extends EntityAIBase {
    ...
    public void func_75246_d() {
        if (this.attacking >= 1) {
            ++this.attacking;
            if (this.attacking == 2) {
                this.parentEntity.func_184185_a(SPSounds.ANCIENT_POD, 5.0f, 1.0f);
            }
            if (this.attacking % 20 == 0 && this.attacking >= 40 && ParasiteSummon.SummonM(this.parentEntity, this.sMobs, 10, this.targetX, this.targetY, this.targetZ, this.parentEntity.func_70638_az(), true)) {
                ++this.limit;
            }
            ...
            if (this.parentEntity.func_70685_l((Entity)entitylivingbase) && this.parentEntity.func_70068_e((Entity)entitylivingbase) < 2500.0) {
