...
extends EntityAIBase {
    ...
    public void func_75246_d() {
        ...
        --this.attackTick;
        if (this.attackTick > 0 && this.attacker.func_70644_a(SPPotions.PIVOT_E)) {
            this.attackTick -= this.attacker.func_70660_b(SPPotions.PIVOT_E).func_76458_c() * 2;
        }
    ...
    protected boolean isTargetParasite(EntityLivingBase target) {
        if (SPConfigSystems.useOneMind && target instanceof EntityParasiteBase) {
            if (((EntityParasiteBase)target).func_70638_az() instanceof EntityParasiteBase) {
                this.attacker.func_70624_b(null);
                return true;
            }
            if (SPPotions.applySense((EntityLivingBase)this.attacker, 200, this.attacker.func_70068_e((Entity)target), SPConfigSystems.oneMinRangeCap)) {
