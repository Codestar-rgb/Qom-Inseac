...
extends EntityAIBase {
    ...
    private boolean teleportTo(double x, double y, double z) {
        ...
        if (flag) {
            this.parent.field_70170_p.func_184148_a((EntityPlayer)null, this.parent.field_70169_q, this.parent.field_70167_r, this.parent.field_70166_s, SPSounds.INFECTEDENDERMAN_PORTAL, this.parent.func_184176_by(), 1.0f, 1.0f);
            this.parent.func_184185_a(SPSounds.INFECTEDENDERMAN_PORTAL, 1.0f, 1.0f);
        }
        return flag;
    }
}
