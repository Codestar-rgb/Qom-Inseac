...
public class SPPacketMeleeRange
implements IMessage {
    private int entityId;

    public SPPacketMeleeRange() {
    }

    public SPPacketMeleeRange(int parEntityId) {
    ...
    implements IMessageHandler<SPPacketMeleeRange, IMessage> {
        public IMessage onMessage(final SPPacketMeleeRange message, MessageContext ctx) {
