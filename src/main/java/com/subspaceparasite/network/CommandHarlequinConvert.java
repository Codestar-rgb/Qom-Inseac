...
import com.subspaceparasite.util.convert.HarlequinBlockConverter;
...
extends CommandBase {
    ...
    public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        HarlequinBlockConverter.Config cfg = new HarlequinBlockConverter.Config(SPBlocks.HarleskinnBlock, SPBlocks.HarlequinnGrass, SPBlocks.Alveoli, SPBlocks.AlveoliGrowth, SPBlocks.LipomaMass, SPBlocks.TressesHair, SPBlocks.HirsuteHair);
        int changed = 0;
