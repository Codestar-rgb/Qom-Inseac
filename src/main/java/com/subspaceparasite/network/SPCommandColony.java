...
public class SPCommandColony
implements ICommand {
    private final List aliases = new ArrayList();

    public SPCommandColony() {
    ...
    public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] argString) throws CommandException {
        ...
        if (!world.field_72995_K) {
            ...
            if (argString[0].equals("resetglobaladaptation")) {
                ...
                sender.func_145747_a((ITextComponent)new TextComponentString("Global adaptation has been reset"));
                return;
            }
            ...
            if (argString[0].equals("setcolony")) {
                switch (ParasiteEventWorld.placeColonyInWorld(world, new BlockPos(x, y, z))) {
                    ...
                    case 4: {
                        sender.func_145747_a((ITextComponent)new TextComponentString("Evolution Phase or UD level is not high enough to place a Colony"));
                        break;
                    }
                    case 5: {
