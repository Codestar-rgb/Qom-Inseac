...
extends CommandBase {
    ...
    private static boolean isGoodGround(WorldServer w, BlockPos pos) {
        ...
        return b.getRegistryName() != null && ((id = b.getRegistryName().toString()).equals("subspaceparasite:harlequinn_grass") || id.equals("subspaceparasite:harleskinn_block"));
    }
    ...
    public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        block16: for (int i = 0; i < tries; ++i) {
            ...
            if (b != SPBiomes.biomeHarlequin || !CommandHarlequinScatter.isGoodGround(w, surf.func_177977_b()) || CommandHarlequinScatter.isBadTop(w, surf)) continue;
            switch (type) {
                case "rock": {
                ...
                case "bush": {
                    ...
                    for (int k = 0; k < c; ++k) {
                        ...
                        if (w.func_180494_b(s2) != SPBiomes.biomeHarlequin || !CommandHarlequinScatter.isGoodGround(w, s2.func_177977_b()) || CommandHarlequinScatter.isBadTop(w, s2) || !CommandHarlequinScatter.flatEnough(w, s2, 3, 3) || !this.placeTemplate(w, s2, CommandHarlequinScatter.pick(BUSHES, rand), rand)) continue;
                        ++placed;
                    }
                    continue block16;
                }
                ...
                case "both": {
                    ...
                    for (int k2 = 0; k2 < bc; ++k2) {
                        ...
                        if (w.func_180494_b(s3) != SPBiomes.biomeHarlequin || !CommandHarlequinScatter.isGoodGround(w, s3.func_177977_b()) || CommandHarlequinScatter.isBadTop(w, s3) || !CommandHarlequinScatter.flatEnough(w, s3, 3, 3) || !this.placeTemplate(w, s3, CommandHarlequinScatter.pick(BUSHES, rand), rand)) continue;
                        ++placed;
                    }
                    continue block16;
                }
                case "all": {
                    ...
                    if (w.func_180494_b(tpos = CommandHarlequinScatter.surfaceAt(w, surf.func_177982_a(rand.nextInt(9) - 4, 0, rand.nextInt(9) - 4))) == SPBiomes.biomeHarlequin && CommandHarlequinScatter.isGoodGround(w, tpos.func_177977_b()) && !CommandHarlequinScatter.isBadTop(w, tpos) && CommandHarlequinScatter.flatEnough(w, tpos, 6, 3) && this.placeTemplate(w, tpos, CommandHarlequinScatter.pick(TREES, rand), rand)) {
                        ++placed;
                    }
                    if (w.func_180494_b(rpos = CommandHarlequinScatter.surfaceAt(w, surf.func_177982_a(rand.nextInt(17) - 8, 0, rand.nextInt(17) - 8))) == SPBiomes.biomeHarlequin && CommandHarlequinScatter.isGoodGround(w, rpos.func_177977_b()) && !CommandHarlequinScatter.isBadTop(w, rpos) && CommandHarlequinScatter.flatEnough(w, rpos, 10, 4) && this.placeTemplate(w, rpos.func_177979_c(rand.nextBoolean() ? 1 : 0), CommandHarlequinScatter.pick(RUINS, rand), rand)) {
                        ++placed;
                    }
                    ...
                    for (int k3 = 0; k3 < bc2; ++k3) {
                        ...
                        if (w.func_180494_b(bpos) != SPBiomes.biomeHarlequin || !CommandHarlequinScatter.isGoodGround(w, bpos.func_177977_b()) || CommandHarlequinScatter.isBadTop(w, bpos) || !CommandHarlequinScatter.flatEnough(w, bpos, 3, 3) || !this.placeTemplate(w, bpos, CommandHarlequinScatter.pick(BUSHES, rand), rand)) continue;
                        ++placed;
                    }
                    continue block16;
                }
    ...
    private boolean placeTemplate(WorldServer w, BlockPos at, String name, Random rand) {
        ...
        Template tpl = mgr.func_186237_a(w.func_73046_m(), new ResourceLocation("subspaceparasite", name));
        if (tpl == null) {
            return false;
        }
