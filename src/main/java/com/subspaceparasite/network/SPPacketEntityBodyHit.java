...
public class SPPacketEntityBodyHit
implements IMessage {
    private int targetId;
    private int partId;

    public SPPacketEntityBodyHit() {
    }

    public SPPacketEntityBodyHit(int target, int part) {
    ...
    implements IMessageHandler<SPPacketEntityBodyHit, IMessage> {
        public IMessage onMessage(final SPPacketEntityBodyHit message, MessageContext ctx) {
