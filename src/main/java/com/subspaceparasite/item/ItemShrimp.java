...
extends ItemFood {
    ...
    public void func_77624_a(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFormatting.WHITE + I18n.func_135052_a((String)"tooltip.subspaceparasite.shrimp.desc", (Object[])new Object[0]));
        tooltip.add(TextFormatting.GRAY + I18n.func_135052_a((String)"tooltip.subspaceparasite.shrimp.arrow", (Object[])new Object[0]));
        tooltip.add(TextFormatting.DARK_AQUA + I18n.func_135052_a((String)"tooltip.subspaceparasite.shrimp.ariral", (Object[])new Object[0]));
    }

    protected void func_77849_c(ItemStack stack, World worldIn, EntityPlayer player) {
        super.func_77849_c(stack, worldIn, player);
        if (!worldIn.field_72995_K && player != null) {
            worldIn.func_184148_a(null, player.field_70165_t, player.field_70163_u, player.field_70161_v, SPSounds.SHRIMP_EAT, SoundCategory.PLAYERS, 0.8f, 0.95f + worldIn.field_73012_v.nextFloat() * 0.1f);
        }
    }
