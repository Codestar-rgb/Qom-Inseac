...
extends ItemBase {
    ...
    public ItemStack func_77654_b(ItemStack stack, World world, EntityLivingBase eater) {
        if (eater instanceof EntityPlayer) {
            ...
            p.func_70690_d(new PotionEffect(SPPotions.COTH_E, 4800, 1, false, false));
        }
        return stack;
    }
    ...
    public void func_77624_a(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(I18n.func_135052_a((String)"tooltip.subspaceparasite.fishlin", (Object[])new Object[0]));
    }
}
