...
public final class VengeanceGrappleHandler {
    ...
    public static void start(EntityPlayer player, EntityLivingBase target) {
        ...
        ws.func_184148_a(null, player.field_70165_t, player.field_70163_u, player.field_70161_v, SPSounds.VENGEANCE_PAPER, SoundCategory.PLAYERS, 2.0f, 1.0f);
    }
    ...
    private static void applyVengeanceDebuffs(EntityLivingBase ent) {
        ...
        int dur = 100;
        if (SPPotions.DOD_SMOKE_TRAIL_E != null) {
            ent.func_70690_d(new PotionEffect(SPPotions.DOD_SMOKE_TRAIL_E, 100, 0, false, true));
        }
        if (SPPotions.BLEED_E != null) {
            ent.func_70690_d(new PotionEffect(SPPotions.BLEED_E, 100, 0, false, true));
        }
        if (SPPotions.DEBAR_E != null) {
            ent.func_70690_d(new PotionEffect(SPPotions.DEBAR_E, 100, 0, false, true));
        }
    }
        ...
        while (it.hasNext()) {
            ...
            switch (d.stage) {
                case WINDUP: {
                    ...
                    --d.timer;
                    if (d.timer > 0) break;
                    ws.func_184148_a(null, target.field_70165_t, target.field_70163_u + (double)target.field_70131_O * 0.5, target.field_70161_v, SPSounds.VENGEANCE_CHAIN_IMPACT, SoundCategory.PLAYERS, 1.0f, 1.0f);
                    d.stage = Stage.PULL;
                    d.ticks = 0;
                    break;
                }
    ...
    private static void impact1(WorldServer ws, EntityPlayer player, EntityLivingBase target, GrappleData d) {
        ws.func_184148_a(null, target.field_70165_t, target.field_70163_u, target.field_70161_v, SPSounds.VENGEANCE_IMPACT, SoundCategory.PLAYERS, 1.0f, 1.0f);
        ws.func_184148_a(null, target.field_70165_t, target.field_70163_u, target.field_70161_v, SPSounds.VENGEANCE_ROCK, SoundCategory.PLAYERS, 0.9f, 0.9f);
        ...
        for (EntityLivingBase ent : list) {
            ...
            if (SPSounds.VENGEANCE_WHOOSH != null) {
                ws.func_184148_a(null, ent.field_70165_t, ent.field_70163_u, ent.field_70161_v, SPSounds.VENGEANCE_WHOOSH, SoundCategory.PLAYERS, 0.8f, 1.2f);
            }
