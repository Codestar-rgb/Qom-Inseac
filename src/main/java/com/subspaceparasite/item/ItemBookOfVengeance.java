...
extends Item {
    ...
    public ItemBookOfVengeance() {
        ...
        this.func_77655_b("subspaceparasite.book_of_vengeance");
    ...
    private static void doKnockbackBurst(WorldServer ws, EntityPlayer player) {
        ws.func_184148_a(null, player.field_70165_t, player.field_70163_u, player.field_70161_v, SPSounds.VENGEANCE_CHAIN_IMPACT, SoundCategory.PLAYERS, 1.0f, 1.0f);
        ws.func_184148_a(null, player.field_70165_t, player.field_70163_u, player.field_70161_v, SPSounds.VENGEANCE_IMPACT, SoundCategory.PLAYERS, 1.0f, 1.0f);
