...
public class ItemFalseApple
extends ItemBase {
    private static final int HUNGER = 4;
    private static final float SATURATION = 0.3f;
    private static final int BUGLIN_COUNT = 5;
    private static final ResourceLocation BUGLIN_ID = new ResourceLocation("subspaceparasite", "buglin");
    ...
    public void func_77624_a(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(I18n.func_135052_a((String)"tooltip.subspaceparasite.false_apple", (Object[])new Object[0]));
    }
    ...
    public ItemStack func_77654_b(ItemStack stack, World world, EntityLivingBase eater) {
        if (eater instanceof EntityPlayer) {
            ...
            world.func_184148_a(null, player.field_70165_t, player.field_70163_u, player.field_70161_v, SoundEvents.field_187739_dZ, SoundCategory.PLAYERS, 0.8f, 1.0f);
            ...
            if (!world.field_72995_K) {
                for (int i = 0; i < 5; ++i) {
                    Entity e = EntityList.func_188429_b((ResourceLocation)BUGLIN_ID, (World)world);
                    if (e == null) continue;
    ...
    public String func_77658_a() {
        return "item.subspaceparasite." + this.getRegistryName().func_110623_a();
    }
}
