...
extends ItemBase {
    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        playerIn.func_184185_a(SPSounds.ADAPTED_V, 3.5f, 1.0f);
    ...
    public void onUsingTick(ItemStack stack, EntityLivingBase living, int count) {
        ...
        if (SPPotions.RAGE_E != null) {
            player.func_70690_d(new PotionEffect(SPPotions.RAGE_E, 6, 0, false, false));
        }
        if (count == 1 && !player.getEntityData().func_74767_n(NBT_ADAPT_PLAYED)) {
            player.func_184185_a(SPSounds.ADAPTATION_P, 3.5f, 1.0f);
    ...
    public void func_77615_a(ItemStack stack, World worldIn, EntityLivingBase living, int timeLeft) {
        if (!worldIn.field_72995_K && living instanceof EntityPlayerMP) {
            ...
            if (SPPotions.RAGE_E != null) {
                p.func_184589_d(SPPotions.RAGE_E);
            }
        }
    }
    ...
    public ItemStack func_77654_b(ItemStack stack, World worldIn, EntityLivingBase living) {
        ...
        p.func_184185_a(SPSounds.ALAFHA_SHOOTING, 3.5f, 1.0f);
        p.func_184185_a(SPSounds.ALAFHA_HURT, 3.5f, 1.0f);
    ...
    private static void spawnReplacement(World world, EntityPlayer player) {
        ...
        if (!SPConfigWorld.boughSpawnReplacement) {
            return;
        }
        String raw = SPConfigWorld.boughReplacementMobId;
        if (raw == null) {
            return;
        }
        ...
        try {
            id = raw.indexOf(58) >= 0 ? new ResourceLocation(raw) : new ResourceLocation("subspaceparasite", raw);
        }
        catch (Exception e) {
            id = new ResourceLocation("subspaceparasite", "sim_adventurer");
        }
        Entity ent = EntityList.func_188429_b((ResourceLocation)id, (World)world);
        if (ent == null && (ent = EntityList.func_188429_b((ResourceLocation)(id = new ResourceLocation("subspaceparasite", "sim_adventurer")), (World)world)) == null) {
            return;
        }
    ...
    private static void grantSepekuAdvancement(EntityPlayerMP p) {
        ...
        ResourceLocation id = new ResourceLocation("subspaceparasite", "sepeku");
    ...
    public void func_77624_a(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFormatting.YELLOW + I18n.func_135052_a((String)"tooltip.subspaceparasite.bough.line1", (Object[])new Object[0]));
        tooltip.add(TextFormatting.GOLD + I18n.func_135052_a((String)"tooltip.subspaceparasite.bough.line2", (Object[])new Object[0]));
    }
}
