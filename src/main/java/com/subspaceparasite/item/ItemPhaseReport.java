...
import com.subspaceparasite.bestiary.client.gui.GuiPhaseReport;
...
extends ItemBase {
    ...
    public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(TextFormatting.GRAY + net.minecraft.client.resources.I18n.func_135052_a((String)"tooltip.subspaceparasite.phase_report", (Object[])new Object[0]));
        NBTTagCompound tag = stack.func_77978_p();
        if (tag != null && tag.func_74764_b(NBT_PRINT_DAY)) {
            int day = tag.func_74762_e(NBT_PRINT_DAY);
            int time = tag.func_74762_e(NBT_PRINT_TIME);
            tooltip.add(TextFormatting.DARK_GRAY + net.minecraft.client.resources.I18n.func_135052_a((String)"tooltip.subspaceparasite.printed", (Object[])new Object[]{day, time}));
        }
    }

    public String func_77653_i(ItemStack stack) {
        return I18n.func_74838_a((String)"item.subspaceparasite.phase_report.name");
    }
}
