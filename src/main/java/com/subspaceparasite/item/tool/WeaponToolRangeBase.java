...
extends ItemBow {
                ...
                if ((double)(f = WeaponToolRangeBase.func_185059_b((int)i)) >= 0.1) {
                    ...
                    if (!worldIn.field_72995_K) {
                        ...
                        if (entityarrow instanceof EntityTippedArrow) {
                            ...
                            tipped.func_184558_a(new PotionEffect(SPPotions.BLEED_E, 200, 0, false, true));
                            tipped.func_184558_a(new PotionEffect(SPPotions.DOD_SMOKE_TRAIL_E, 200, 0, false, true));
                        }
    ...
    public void func_77624_a(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFormatting.YELLOW + I18n.func_135052_a((String)("tootip.subspaceparasite.weaponr." + this.idTool), (Object[])new Object[0]));
        tooltip.add(TextFormatting.RED + I18n.func_135052_a((String)("tootip.subspaceparasite.weaponr." + this.idTool * 10), (Object[])new Object[0]));
        if (this.calling && SPConfigSystems.useScent) {
            tooltip.add(TextFormatting.BLACK + I18n.func_135052_a((String)("tootip.subspaceparasite.weaponr." + this.idTool * 100), (Object[])new Object[0]));
        }
    }
}
