...
extends WeaponToolMeleeBase {
    ...
    @Override
    public Item getNext() {
        if (this == SPItems.weapon_maul) {
            return SPItems.weapon_maulSentient;
        }
        return null;
    }
    ...
    private void doMaulSlam(World world, EntityPlayer player, ItemStack stack) {
        ...
        world.func_184148_a(null, player.field_70165_t, player.field_70163_u, player.field_70161_v, SPSounds.VENGEANCE_ROCK, SoundCategory.PLAYERS, 0.9f, 0.9f);
