...
public class WeaponMeleeSword
extends WeaponToolMeleeBase {
    public WeaponMeleeSword(Item.ToolMaterial material, String name, double attackspeed, float range, float attackD, boolean fear, byte id) {
    ...
    @Override
    public Item getNext() {
        if (this == SPItems.weapon_sword) {
            return SPItems.weapon_swordSentient;
        }
        return null;
    }
    ...
    public boolean func_77644_a(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (flag) {
            ...
            if (attacker.field_70170_p.field_73012_v.nextDouble() < chance) {
                SPPotions.applyStackPotion(SPPotions.BLEED_E, target, 100, amp);
            }
        }
        return flag;
    }
