...
public class WeaponMeleeAxe
extends WeaponToolMeleeBase {
    public WeaponMeleeAxe(Item.ToolMaterial material, String name, double attackspeed, float range, float attackD, boolean fear, byte id) {
    ...
    @Override
    public Item getNext() {
        if (this == SPItems.weapon_axe) {
            return SPItems.weapon_axeSentient;
        }
        return null;
    }
    ...
    public boolean func_77644_a(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (flag) {
            ...
            if (attacker.field_70170_p.field_73012_v.nextDouble() < chance) {
                SPPotions.applyStackPotion(SPPotions.CORRO_E, target, 100, amp);
            }
        }
        return flag;
    }
