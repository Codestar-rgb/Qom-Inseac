...
public class TileEntityInfuserFurnace
...
ISidedInventory {
    ...
    public void func_73660_a() {
        ...
        if (!this.isBurning() && (this.canSmelt() || this.canInfuse(r)) && (fuelBurn = TileEntityFurnace.func_145952_a((ItemStack)(fuel = (ItemStack)this.items.get(1)))) > 0) {
            ...
            if (fuel.func_190926_b()) {
                ...
                this.items.set(1, (Object)(container != null ? new ItemStack(container) : ItemStack.field_190927_a));
            }
        }
    ...
    private void doSmelt() {
        ...
        ItemStack out = (ItemStack)this.items.get(2);
        this.items.set(2, (Object)this.pushToOutput(out, result));
        in.func_190918_g(1);
    }
    ...
    private boolean canInfuse(InfuserFurnaceRecipe r) {
        ...
        if (!TileEntityInfuserFurnace.canMerge(this.func_70301_a(4), r.infusedOut)) {
            return false;
        }
        return TileEntityInfuserFurnace.canMerge(this.func_70301_a(5), r.bottleOut);
    }
    ...
    private boolean canOutputStack(ItemStack existing, ItemStack toAdd) {
        ...
        if (!existing.func_77969_a(toAdd)) {
            return false;
        }
    ...
    private static boolean canMerge(ItemStack slotStack, ItemStack add) {
        ...
        if (!ItemStack.func_179545_c((ItemStack)slotStack, (ItemStack)add)) {
            return false;
        }
        if (!ItemStack.func_77970_a((ItemStack)slotStack, (ItemStack)add)) {
            return false;
        }
        return slotStack.func_190916_E() + add.func_190916_E() <= slotStack.func_77976_d();
    }
    ...
    public String func_174875_k() {
        return "subspaceparasite:infuser_furnace";
    }
    ...
    public void func_145839_a(NBTTagCompound compound) {
        ...
        for (int i = 0; i < list.func_74745_c(); ++i) {
            ...
            this.items.set(slot, (Object)new ItemStack(c));
        }
