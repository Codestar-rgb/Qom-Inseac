...
public class TileEntityInfestedFurnace
extends TileEntity
...
IInteractionObject {
        ...
        if (!this.field_145850_b.field_72995_K) {
            ...
            if (this.isBurning() || !fuel.func_190926_b() && !input.func_190926_b()) {
                if (!this.isBurning() && this.canSmelt()) {
                    this.currentItemBurnTime = this.furnaceBurnTime = TileEntityInfestedFurnace.getItemBurnTime(fuel);
                    if (this.isBurning()) {
                        dirty = true;
                        if (!fuel.func_190926_b()) {
                            ...
                            if (fuel.func_190926_b()) {
                                this.furnaceItemStacks.set(1, (Object)container);
                            }
                        }
                    }
                }
    ...
    private void smeltItem() {
        ...
        ItemStack output = (ItemStack)this.furnaceItemStacks.get(2);
        if (output.func_190926_b()) {
            this.furnaceItemStacks.set(2, (Object)result.func_77946_l());
    ...
    public void func_70299_a(int index, ItemStack stack) {
        ...
        boolean same = !stack.func_190926_b() && stack.func_77969_a(prev) && ItemStack.func_77970_a((ItemStack)stack, (ItemStack)prev);
    ...
    public String func_70005_c_() {
        return this.func_145818_k_() ? this.customName : "tile.subspaceparasite.infested_furnace.name";
    }
    ...
    public ITextComponent func_145748_c_() {
        return this.func_145818_k_() ? new TextComponentString(this.customName) : new TextComponentTranslation("tile.subspaceparasite.infested_furnace.name", new Object[0]);
    }
    ...
    public boolean func_70300_a(EntityPlayer player) {
        ...
        if (te != this) {
            if (DEBUG) {
                System.out.println("Infested Furnace: isUsableByPlayer FAILED pos=" + this.field_174879_c + " worldTE=" + (te == null ? "null" : te.getClass().getName()) + " this=" + ((Object)((Object)this)).getClass().getName());
            }
            return false;
        }
