...
public final class BeckonStage4DetectedAdvancement {
    private static final ResourceLocation ADV_ID = new ResourceLocation("subspaceparasite", "monument");
    private static final String CRITERION = "detected_beckon_siv";
    private static final double RANGE_SQ = 65536.0;

    public static void register() {
        MinecraftForge.EVENT_BUS.register((Object)new BeckonStage4DetectedAdvancement());
    }
    ...
    public void onEntityJoinWorld(EntityJoinWorldEvent e) {
        ...
        for (EntityPlayerMP p : ws.func_73046_m().func_184103_al().func_181057_v()) {
            Advancement adv;
            boolean granted;
            if (p.field_70170_p.field_73011_w.getDimension() != ws.field_73011_w.getDimension() || p.func_70068_e(ent) > 65536.0 || !(granted = (adv = p.func_184102_h().func_191949_aK().func_192778_a(ADV_ID)) != null && p.func_192039_O().func_192750_a(adv, CRITERION))) continue;
            SoundEvent se = SPSounds.DISLO_11;
            if (se != null) {
