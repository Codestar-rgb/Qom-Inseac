...
import com.subspaceparasite.world.biome.BiomeParasiteShrouded;
...
public class SPBiomes {
    ...
    private static void register(RegistryEvent.Register<Biome> event, Biome biome, BiomeManager.BiomeType type, String name, int weight, BiomeDictionary.Type ... biomeDictTypes) {
        biome.setRegistryName(new ResourceLocation("subspaceparasite", name));
    ...
    public static class RegistrationHandler {
        ...
        public static void onEvent(RegistryEvent.Register<Biome> event) {
            if (SPConfigWorld.biomeRegster) {
                SPBiomes.register((RegistryEvent.Register<Biome>)event, biomeShrouded, BiomeManager.BiomeType.COOL, "biomeparasite_shrouded", SPConfigWorld.biomeOneWeight, new BiomeDictionary.Type[]{BiomeDictionary.Type.SPOOKY});
                SPBiomes.register((RegistryEvent.Register<Biome>)event, biomeHarlequin, BiomeManager.BiomeType.COOL, "biomeparasite_harlequin", SPConfigWorld.biomeThreeWeight, new BiomeDictionary.Type[]{BiomeDictionary.Type.SPOOKY});
            }
        }
    }
}
