...
public class SPPotions {
    public static final Potion COTH_E = new SPEffectBase("coth", false, 894258, 0, 0);
    public static final Potion DOD_SMOKE_TRAIL_E = new EffectDodSmokeTrail();
    public static final Potion THORNSHADE_THORNS_E = new SPEffectBase("thornshade_thorns", false, 5148468, 1, 0);
    public static final Potion FEAR_E = new SPEffectBase("fear", false, 894257, 0, 0);
    public static final Potion RES_E = new SPEffectBase("antimall", true, 894257, 0, 0);
    public static final Potion BLEED_E = new PotionBleed("bleed", true, 894257, 0, 0);
    public static final Potion CORRO_E = new PotionCorrosion("corrosive", true, 894257, 0, 0);
    public static final Potion VIRA_E = new SPEffectBase("viral", true, 894257, 0, 0);
    public static final Potion VOMIT_E = new SPEffectBase("vomit", false, 8323126, 0, 0).func_111184_a(SharedMonsterAttributes.field_111265_b, UUID.randomUUID().toString(), 0.9, 2);
    public static final Potion RAGE_E = new SPEffectBase("rage", false, 894257, 0, 0).func_111184_a(SharedMonsterAttributes.field_111263_d, UUID.randomUUID().toString(), SPConfigSystems.rageSpeed, 2).func_111184_a(SharedMonsterAttributes.field_111264_e, UUID.randomUUID().toString(), SPConfigSystems.rageDamage, 2);
    public static final Potion EPEL_E = new SPEffectBase("repel", false, 894257, 0, 0);
    public static final Potion SENS_E = new SPEffectBase("senses", false, 894257, 0, 0).func_111184_a(SharedMonsterAttributes.field_111265_b, UUID.randomUUID().toString(), 0.1, 2);
    public static final Potion PREY_E = new PotionPrey("prey", true, 894257, 0, 0);
    public static final Potion DEBAR_E = new SPEffectBase("debar", false, 894258, 0, 0);
    public static final Potion DLER_E = new PotionNeedler("needler", false, 894258, 0, 0);
    public static final Potion FOSTER_E = new PotionFoster("foster", false, 894258, 0, 0);
    public static final Potion LINK_E = new SPEffectBase("link", false, 894258, 0, 0);
    public static final Potion PIVOT_E = new SPEffectBase("pivot", false, 894258, 0, 0);
    public static final Potion JUGG_E = new SPEffectBase("jugg", false, 894258, 0, 0);
    public static final Potion PARATE_E = new SPEffectBase("parate", false, 894258, 0, 0);
    public static final Potion KILLPRI_E = new SPEffectBase("primitive", false, 894258, 0, 0);
    public static final Potion KILLADA_E = new SPEffectBase("adapted", false, 894258, 0, 0);
    ...
    public static final Potion KILLFER_E = new SPEffectBase("feral", false, 894258, 0, 0);
    public static final Potion KILLNEX_E = new SPEffectBase("nexus", false, 894258, 0, 0);
    public static final Potion SPOT_E = new PotionSpotted("spotted", false, 894258, 0, 0);
    public static final Potion BRAINING_E = new SPEffectBase("braining", false, 894258, 0, 0);
    public static final Potion NOVISION_E = new SPEffectBase("novision", false, 894258, 0, 0);
    public static final Potion INDEAF_E = new SPEffectBase("indeaf", false, 894258, 0, 0);
    public static final Potion OVERHEATING_E = new PotionOverheat("overheating", true, 894258, 0, 0);
    public static final Potion CONTA_E = new PotionContamination("conta", true, 894258, 0, 0);
    public static final Potion MUSCLEOUT_E = new SPEffectBase("muscleout", true, 894258, 0, 0);
    public static final Potion EFFECTPOS_E = new SPEffectBase("effectpos", true, 894258, 0, 0);
    public static final Potion EFFECTNEG_E = new SPEffectBase("effectneg", true, 894258, 0, 0);
