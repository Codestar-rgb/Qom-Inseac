...
import com.subspaceparasite.bestiary.client.gui.BlocksPage;
import com.subspaceparasite.bestiary.client.gui.CelestialEventsPage;
import com.subspaceparasite.bestiary.client.gui.GuiBestiary;
import com.subspaceparasite.bestiary.client.gui.GuiDistortionHelper;
import com.subspaceparasite.bestiary.client.gui.StatusEffectsPage;
import com.subspaceparasite.bestiary.client.gui.SystemsPage;
...
extends GuiScreen {
    private static final ResourceLocation TEX_BG = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/background.png");
    private static final ResourceLocation TEX_LABEL_BG = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/label_background.png");
    private static final ResourceLocation TEX_MODEL_BG = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/model_background.png");
    private static final ResourceLocation TEX_STATS_BG = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/stats_background.png");
    private static final ResourceLocation TEX_NAME_BG = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/name_background.png");
    private static final ResourceLocation TEX_LORE_BG = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/lore_background.png");
    private static final ResourceLocation TEX_DROP_BG = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/drop_background.png");
    private static final ResourceLocation TEX_WARNING_SHEET = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/warning_sheet.png");
    ...
    private File getMobsCfgFile() {
        return new File(this.field_146297_k.field_71412_D, "config/subspaceparasite/SPParasitesMobs.cfg");
    }
    ...
    private static String loreKeyFromMobId(String mobId) {
        ResourceLocation rl = mobId.indexOf(58) >= 0 ? new ResourceLocation(mobId) : new ResourceLocation("subspaceparasite", mobId);
        ...
        switch (this.page) {
            ...
            case MOB_LIST: {
                ...
                if (prog != null && this.selectedTier != null) {
                    for (BestiaryEntry e : SPBestiaryRegistry.all()) {
    ...
    public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
        ...
        String title = this.distort(I18n.func_135052_a((String)"item.subspaceparasite.srp_field_guide.name", (Object[])new Object[0]));
    ...
    private void drawTierPreview(ParasiteTier tier, int x, int y) {
        ...
        for (BestiaryEntry e : SPBestiaryRegistry.all()) {
            ...
            float scale = SPBestiaryRegistry.getRenderScale(e.mobId);
    ...
    private void drawMobListWithRenders(List<BestiaryEntry> mobs, int xRight) {
        ...
        for (BestiaryEntry e : mobs) {
            ...
            if (rowBot > this.LIST_VIEW_TOP() && rowTop < this.LIST_BOTTOM()) {
                ...
                float rs = SPBestiaryRegistry.getRenderScale(e.mobId);
    ...
    private void loadDropCacheIfNeeded() {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader((InputStream)new FileInputStream(f), StandardCharsets.UTF_8));){
            ...
            System.out.println("[SP][BESTIARY][DROPS] Failed reading cfg: " + ex);
            this.dropsByCategory.clear();
            this.knownCategories.clear();
        }
    }
    ...
    private void drawMobDetail(BestiaryEntry e, int x, int y, int mouseX, int mouseY, float partialTicks) {
        ...
        String label = this.distort(I18n.func_135052_a((String)"lore.subspaceparasite.compendium", (Object[])new Object[0]));
    ...
    private void renderEntityPreview(String mobId, int cx, int cy, int boxW, int boxH, float yawDeg, float pitchDeg, int marginPx, float extraShrink) {
        ...
        scale *= SPBestiaryRegistry.getRenderScale(mobId);
        if (extraShrink > 0.0f) {
            scale *= extraShrink;
        }
        GlStateManager.func_179094_E();
    ...
    static {
        ...
        TIER_ICONS.put(ParasiteTier.INBORN, byId.apply("subspaceparasite:lurecomponent1"));
        TIER_ICONS.put(ParasiteTier.ASSIMILATED, byId.apply("subspaceparasite:lurecomponent3"));
        TIER_ICONS.put(ParasiteTier.HIJACKED, byId.apply("subspaceparasite:hijacked_drop"));
        TIER_ICONS.put(ParasiteTier.FERAL, byId.apply("subspaceparasite:lurecomponent2"));
        TIER_ICONS.put(ParasiteTier.CRUDE, byId.apply("subspaceparasite:itemmobspawner_host"));
        TIER_ICONS.put(ParasiteTier.PRIMITIVE, byId.apply("subspaceparasite:ada_reeker_drop"));
        TIER_ICONS.put(ParasiteTier.ADAPTED, byId.apply("subspaceparasite:ada_longarms_drop"));
        TIER_ICONS.put(ParasiteTier.NEXUS, byId.apply("subspaceparasite:beckon_drop"));
        TIER_ICONS.put(ParasiteTier.DETERRENT, byId.apply("subspaceparasite:dispatcher_drop"));
        TIER_ICONS.put(ParasiteTier.PURE, byId.apply("subspaceparasite:living_core"));
        TIER_ICONS.put(ParasiteTier.PREEMINENT, byId.apply("subspaceparasite:itemthrow"));
        TIER_ICONS.put(ParasiteTier.ANCIENT, byId.apply("subspaceparasite:itemmobspawner_oronco"));
        TIER_ICONS.put(ParasiteTier.ABOMINATION, byId.apply("subspaceparasite:ada_vermin_drop"));
        TIER_ICONS.put(ParasiteTier.ASSIMARA, byId.apply("subspaceparasite:ada_viscera_drop"));
        TIER_ICONS.put(ParasiteTier.DERIVED, byId.apply("subspaceparasite:alveoligrowth"));
        TIER_ICONS.put(ParasiteTier.WALKING_HEAD, byId.apply("subspaceparasite:assimilated_flesh"));
        Item it = Item.func_111206_d((String)"subspaceparasite:itemtab");
