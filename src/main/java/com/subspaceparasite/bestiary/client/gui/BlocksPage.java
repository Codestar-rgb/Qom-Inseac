...
extends GuiScreen {
    ...
    private static final ResourceLocation TEX_BACKGROUND = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/blocks_background.png");
    private static final ResourceLocation TEX_SLOT = new ResourceLocation("subspaceparasite", "textures/gui/bestiary/slot.png");
