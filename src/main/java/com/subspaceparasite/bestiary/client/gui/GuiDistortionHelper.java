...
public final class GuiDistortionHelper {
    public static final String PLAYER_DISABLE_TAG = "SPGuiDistortionDisabled";
    public static final String PLAYER_CREATIVE_OVERRIDE_TAG = "SPGuiDistortionCreativeOverride";
    ...
    private static Set<String> getConfiguredMobIds() {
        ...
        if (SPConfigSystems.guiDistortionMobList == null || SPConfigSystems.guiDistortionMobList.length == 0) {
            ids.add("subspaceparasite:kirin");
            ids.add("subspaceparasite:draconite");
            return ids;
        }
        for (String s : SPConfigSystems.guiDistortionMobList) {
    ...
    public static boolean isDistortionActive(Minecraft mc) {
        if (!SPConfigSystems.guiDistortionEnabled) {
            return false;
        }
        ...
        int range = SPConfigSystems.guiDistortionRange > 0 ? SPConfigSystems.guiDistortionRange : 100;
    ...
    private static boolean isProtectedFromDistortion(Minecraft mc) {
        return mc != null && mc.field_71439_g != null && mc.field_71439_g.func_70644_a(SPPotions.THE_SIGN_E);
    }
    ...
    public static boolean isExtendedWorldTextDistortionActive(Minecraft mc) {
        if (!SPConfigSystems.guiDistortionAffectsWorldText) {
            return false;
        }
    ...
    public static boolean shouldDistortChat(Minecraft mc) {
        ...
        if (!SPConfigSystems.guiDistortionAffectsChat) {
            return false;
        }
        return GuiDistortionHelper.isDistortionActive(mc);
    }
    ...
    public static boolean shouldDistortItemTooltips(Minecraft mc) {
        if (!SPConfigSystems.guiDistortionAffectsItemTooltips) {
            return false;
        }
        return GuiDistortionHelper.isDistortionActive(mc);
    }
    ...
    public static boolean shouldDistortPotionHud(Minecraft mc) {
        if (!SPConfigSystems.guiDistortionAffectsPotionHud) {
            return false;
        }
        return GuiDistortionHelper.isDistortionActive(mc);
    }
    ...
    public static boolean shouldDistortSigns(Minecraft mc) {
        ...
        if (!SPConfigSystems.guiDistortionAffectsSigns) {
            return false;
        }
        return GuiDistortionHelper.isDistortionActive(mc);
    }
    ...
    public static boolean shouldDistortItemHighlight(Minecraft mc) {
        ...
        if (!SPConfigSystems.guiDistortionAffectsItemHighlight) {
            return false;
        }
        return GuiDistortionHelper.isDistortionActive(mc);
    }
    ...
    public static boolean shouldDistortSubtitles(Minecraft mc) {
        ...
        if (!SPConfigSystems.guiDistortionAffectsSubtitles) {
            return false;
        }
        return GuiDistortionHelper.isDistortionActive(mc);
    }
