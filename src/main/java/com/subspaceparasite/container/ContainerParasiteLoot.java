...
extends Container {
                ...
                this.func_75146_a(new Slot(te, idx++, 8 + c * 18, 30 + r * 18){
                    ...
                    public ItemStack func_190901_a(EntityPlayer p, ItemStack stack) {
                        ...
                        if (!p.field_70170_p.field_72995_K) {
                            ...
                            if (SPConfigWorld.parasiteLootDamageOnTake && dmg > 0.0f) {
        ...
        if (slot != null && slot.func_75216_d()) {
            ...
            if (index < 27) {
                ...
                if (!playerIn.field_70170_p.field_72995_K) {
                    float dmg;
                    if (SPConfigWorld.parasiteLootDamageOnTake && (dmg = 0.5f + 7.5f * (1.0f - fBefore)) > 0.0f) {
                    ...
                    if (fBefore < 1.0f) {
                        ...
                        playerIn.func_70690_d(new PotionEffect(SPPotions.CORRO_E, corrosDur, corrosAmp, false, false));
                        SPPotions.applyStackPotion(SPPotions.VIRA_E, (EntityLivingBase)playerIn, viralDur, viralAmp);
                    }
    ...
    private void applyParasiteEffects(EntityPlayer p, float fullness) {
        ...
        p.func_70690_d(new PotionEffect(SPPotions.CORRO_E, corrosDur, corrosAmp, false, false));
        SPPotions.applyStackPotion(SPPotions.VIRA_E, (EntityLivingBase)p, viralDur, viralAmp);
    }
