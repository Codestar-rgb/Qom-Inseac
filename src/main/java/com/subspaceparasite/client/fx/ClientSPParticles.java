...
public final class ClientSPParticles {
    ...
    public static void onTextureStitch(TextureStitchEvent.Pre e) {
        ClientSPParticles.INFESTED_LEAF_SPRITES[0] = INFESTED_LEAF_SPRITE = e.getMap().func_174942_a(new ResourceLocation("subspaceparasite:particle/infested_leaves"));
        ClientSPParticles.INFESTED_LEAF_SPRITES[1] = e.getMap().func_174942_a(new ResourceLocation("subspaceparasite:particle/infested_leaves2"));
        ClientSPParticles.INFESTED_LEAF_SPRITES[2] = e.getMap().func_174942_a(new ResourceLocation("subspaceparasite:particle/infested_leaves3"));
        ClientSPParticles.INFESTED_LEAF_SPRITES[3] = e.getMap().func_174942_a(new ResourceLocation("subspaceparasite:particle/infested_leaves4"));
    }
