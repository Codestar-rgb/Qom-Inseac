 ...
 */
package com.subspaceparasite.client.sky;
...
public final class SkyFlashRenderer {
    private static final ResourceLocation TEX = new ResourceLocation("subspaceparasite:textures/entity/monster/sky_flash.png");
