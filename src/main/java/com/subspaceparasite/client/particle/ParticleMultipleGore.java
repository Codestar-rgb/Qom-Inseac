...
extends Particle {
    public static final ResourceLocation PARTICLES_TEXTUREINFECTED = new ResourceLocation("subspaceparasite", "particle/splashi");
    public static final ResourceLocation PARTICLES_TEXTURESPIDER = new ResourceLocation("subspaceparasite", "particle/splashd");
    public static final ResourceLocation PARTICLES_TEXTUREPRIMITIVE = new ResourceLocation("subspaceparasite", "particle/splashp");
    public static final ResourceLocation PARTICLES_TEXTUREADAPTED = new ResourceLocation("subspaceparasite", "particle/splasha");
    public static final ResourceLocation PARTICLES_TEXTUREVOMIT = new ResourceLocation("subspaceparasite", "particle/splashv");
