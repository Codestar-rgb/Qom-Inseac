...
extends GuiScreen {
    ...
    private static final ResourceLocation TEX_ROW_ONE = new ResourceLocation("subspaceparasite", "textures/gui/dislo_report_row_gui_one.png");
    private static final ResourceLocation TEX_ROW_TWO = new ResourceLocation("subspaceparasite", "textures/gui/dislo_report_row_gui_two.png");
    private static final ResourceLocation TEX_ROW_THREE = new ResourceLocation("subspaceparasite", "textures/gui/dislo_report_row_gui_three.png");
    private static final ResourceLocation TEX_ROW_UNKNOWN = new ResourceLocation("subspaceparasite", "textures/gui/dislo_report_row_gui_unknown.png");
    ...
    public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
        ...
        String title = this.distort(I18n.func_135052_a((String)"gui.subspaceparasite.dislodgement.title", (Object[])new Object[0]));
    ...
    private void drawEntriesList() {
        ...
        for (int i = 0; i < this.entries.size(); ++i) {
            ...
            String line1Plain = I18n.func_135052_a((String)"gui.subspaceparasite.dislodgement.entry.head", (Object[])new Object[]{e.dim, e.event, timeStr});
            String line2Plain = GuiDislodgementReport.formatMeaning(e.event, e.value);
            String line3Plain = I18n.func_135052_a((String)"gui.subspaceparasite.dislodgement.entry.value", (Object[])new Object[]{e.value});
        ...
        if (this.entries.isEmpty()) {
            String none = this.distort(I18n.func_135052_a((String)"gui.subspaceparasite.dislodgement.none", (Object[])new Object[0]));
