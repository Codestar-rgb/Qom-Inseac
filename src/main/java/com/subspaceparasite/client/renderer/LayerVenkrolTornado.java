...
implements LayerRenderer<EntityVenkrolSIV> {
    ...
    private static final ResourceLocation TORNADO_TEX = new ResourceLocation("subspaceparasite", "textures/particle/fog1.png");
    private static final ResourceLocation TORNADO_OUTER_TEX = new ResourceLocation("subspaceparasite", "textures/particle/fog1_outer.png");
    ...
    extends MovingSound {
        ...
        VenkrolVortexLoopSound(EntityVenkrolSIV entity) {
            super(SPSounds.BECKON_VORTEX, SoundCategory.HOSTILE);
            this.entity = entity;
