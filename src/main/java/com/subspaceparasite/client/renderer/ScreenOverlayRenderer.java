...
public class ScreenOverlayRenderer {
    private static final ResourceLocation VIRAL = new ResourceLocation("subspaceparasite:textures/gui/screen_viral.png");
    private static final ResourceLocation BLEED = new ResourceLocation("subspaceparasite:textures/gui/screen_bleed.png");
    private static final ResourceLocation VOMIT = new ResourceLocation("subspaceparasite:textures/gui/screen_vomit.png");
    private static final ResourceLocation VISION = new ResourceLocation("subspaceparasite:textures/gui/screen_novision.png");
    ...
    public void renderOverlay(RenderGameOverlayEvent.Post event) {
        ...
        if (mc.field_71439_g.func_70644_a(SPPotions.VIRA_E)) {
            this.screenEffectViral(mc, VIRAL, screenWidth, screenHeight);
        }
        if (mc.field_71439_g.func_70644_a(SPPotions.BLEED_E)) {
            this.screenEffectBleed(mc, BLEED, screenWidth, screenHeight);
        }
        if (mc.field_71439_g.func_70644_a(SPPotions.NOVISION_E)) {
            this.screenEffectVision(mc, VISION, screenWidth, screenHeight);
        }
        if (mc.field_71439_g.func_70644_a(SPPotions.VOMIT_E)) {
