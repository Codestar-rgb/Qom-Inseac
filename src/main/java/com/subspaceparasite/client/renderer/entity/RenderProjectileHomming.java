...
import com.subspaceparasite.client.model.entity.ModelProjectileHomming;
...
extends Render<EntityProjectileHomming> {
    private static final ResourceLocation EVOKER_ILLAGER_FANGS = new ResourceLocation("subspaceparasite:textures/entity/projectile/projectileh.png");
