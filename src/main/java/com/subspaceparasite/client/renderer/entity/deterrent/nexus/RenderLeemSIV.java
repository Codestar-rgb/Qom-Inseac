...
import com.subspaceparasite.client.model.entity.deterrent.nexus.ModelLeemSIV;
...
extends RenderMalleable<EntityLeemSIV> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/leemsiv.png");
