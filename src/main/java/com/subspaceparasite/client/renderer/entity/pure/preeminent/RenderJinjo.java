...
import com.subspaceparasite.client.model.entity.pure.preeminent.ModelJinjo;
...
public class RenderJinjo
extends RenderMalleable<EntityJinjo> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/jinjo.png");
