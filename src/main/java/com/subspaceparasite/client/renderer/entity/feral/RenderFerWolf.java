...
import com.subspaceparasite.client.model.entity.feral.ModelFerWolf;
...
extends RenderSP<EntityFerWolf> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/ferwolf.png");
