...
import com.subspaceparasite.client.model.entity.infected.ModelInfPig;
...
extends RenderSP<EntityInfPig> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/pig.png");
