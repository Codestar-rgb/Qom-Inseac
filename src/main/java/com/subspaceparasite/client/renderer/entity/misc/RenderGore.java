...
import com.subspaceparasite.client.model.entity.misc.ModelGore;
...
extends Render<EntityGore> {
    ...
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/gore.png");
