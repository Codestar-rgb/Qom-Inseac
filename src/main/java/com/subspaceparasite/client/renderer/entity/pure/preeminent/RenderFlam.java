...
import com.subspaceparasite.client.model.entity.pure.preeminent.ModelFlam;
...
extends RenderMalleable<EntityFlam> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/flam.png");
