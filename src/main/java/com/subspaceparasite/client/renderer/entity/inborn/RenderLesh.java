...
import com.subspaceparasite.client.model.entity.inborn.ModelLesh;
...
extends RenderLiving<EntityLesh> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/lesh.png");
