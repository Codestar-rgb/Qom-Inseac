...
import com.subspaceparasite.client.model.entity.pure.preeminent.ModelElvia;
...
extends RenderMalleable<EntityElvia> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/elvia.png");
