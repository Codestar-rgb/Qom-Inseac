...
import com.subspaceparasite.client.model.entity.infected.ModelInfBear;
...
extends RenderSP<EntityInfBear> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/infbear.png");
    ...
    protected void preRenderCallback(EntityInfBear entitylivingbaseIn, float partialTickTime) {
        ...
        GlStateManager.func_179152_a((float)(1.2f * f2), (float)(1.2f * ff * f3), (float)(1.2f * f2));
    }
