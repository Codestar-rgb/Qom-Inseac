...
import com.subspaceparasite.client.model.entity.infected.ModelInfEnderman;
...
extends RenderSP<EntityInfEnderman> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/infenderman.png");
    public static final ResourceLocation TEXTURE_1 = new ResourceLocation("subspaceparasite:textures/entity/monster/infenderman1.png");
    public static final ResourceLocation TEXTURE_ARIRAL = new ResourceLocation("subspaceparasite:textures/entity/monster/infenderman_ariral.png");
