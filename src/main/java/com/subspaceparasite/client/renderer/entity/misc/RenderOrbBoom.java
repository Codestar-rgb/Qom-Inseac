...
public class RenderOrbBoom
extends Render<EntityOrbBoom> {
    protected ModelSP mainModel2 = new ModelOrbScary();
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/orbboom.png");
    private static final ResourceLocation LIGHTNING_TEX = new ResourceLocation("subspaceparasite:textures/entity/monster/orbboom_armor.png");
    ...
    protected void renderModelCosmical(EntityOrbBoom e, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, float partialTicks) {
        boolean flag1;
        boolean flag = false;
