...
import com.subspaceparasite.client.model.entity.infected.ModelInfHorse;
...
extends RenderSP<EntityInfHorse> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/infhorse.png");
