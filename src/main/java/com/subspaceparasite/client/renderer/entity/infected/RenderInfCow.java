...
import com.subspaceparasite.client.model.entity.infected.ModelInfCow;
...
public class RenderInfCow
extends RenderSRP<EntityInfCow> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/cow.png");
