...
import com.subspaceparasite.client.model.entity.feral.ModelFerPig;
...
extends RenderSP<EntityFerPig> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/ferpig.png");
