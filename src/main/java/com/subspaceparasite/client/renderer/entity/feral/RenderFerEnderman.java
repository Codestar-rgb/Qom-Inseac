...
import com.subspaceparasite.client.model.entity.feral.ModelFerEnderman;
...
public class RenderFerEnderman
extends RenderSRP<EntityFerEnderman> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/ferenderman.png");
