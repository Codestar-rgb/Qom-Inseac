...
import com.subspaceparasite.client.model.entity.pure.ModelGanro;
...
extends RenderMalleable<EntityGanro> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/ganro.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/ganroh.png");
