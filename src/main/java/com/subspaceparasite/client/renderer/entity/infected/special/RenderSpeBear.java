...
import com.subspaceparasite.client.model.entity.infected.special.ModelSpeBear;
...
extends RenderSP<EntitySpeBear> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/spebear.png");
    private static final ResourceLocation GUARDIAN_BEAM_TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/test.png");
    ...
    protected void preRenderCallback(EntitySpeBear entitylivingbaseIn, float partialTickTime) {
        ...
        GlStateManager.func_179152_a((float)(f2 * 1.3f), (float)(f3 * 1.3f), (float)(f2 * 1.3f));
    }
