...
extends Render<EntityOrbVoid> {
    ...
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/orbvoid.png");
    private static final ResourceLocation LIGHTNING_TEX = new ResourceLocation("subspaceparasite:textures/entity/monster/orbvoid_armor.png");
    ...
    public boolean shouldRender(EntityOrbVoid livingEntity, ICamera camera, double camX, double camY, double camZ) {
        return true;
    }
