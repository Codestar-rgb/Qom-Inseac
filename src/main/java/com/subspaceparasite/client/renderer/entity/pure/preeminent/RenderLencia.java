...
import com.subspaceparasite.client.model.entity.pure.preeminent.ModelLencia;
...
extends RenderMalleable<EntityLencia> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/lencia.png");
