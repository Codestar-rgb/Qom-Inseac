...
import com.subspaceparasite.client.model.entity.misc.ModelBiomassPod;
import com.subspaceparasite.client.model.entity.misc.ModelBiomassVenkrol;
...
extends RenderSP<EntityBiomass> {
    protected static ModelBase modelV = new ModelBiomassVenkrol();
    protected static ModelBase modelP = new ModelBiomassPod();
    public static final ResourceLocation TEXTUREV = new ResourceLocation("subspaceparasite:textures/entity/monster/biomassvenkrol.png");
    public static final ResourceLocation TEXTUREP = new ResourceLocation("subspaceparasite:textures/entity/monster/biomasspod.png");
