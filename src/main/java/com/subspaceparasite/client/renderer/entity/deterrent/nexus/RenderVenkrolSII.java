...
import com.subspaceparasite.client.model.entity.deterrent.nexus.ModelVenkrolSII;
...
extends RenderMalleable<EntityVenkrolSII> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/venkrolsii.png");
