...
import com.subspaceparasite.client.model.entity.pure.ModelAnged;
...
extends RenderMalleable<EntityAnged> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/anged.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/angedh.png");
