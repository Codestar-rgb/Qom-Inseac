...
import com.subspaceparasite.client.model.entity.misc.ModelMeteor;
...
extends Render<EntityMeteor> {
    protected ModelSP mainModel2 = new ModelMeteor();
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/projectile/meteor.png");
