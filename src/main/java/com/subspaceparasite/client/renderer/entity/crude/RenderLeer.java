...
import com.subspaceparasite.client.model.entity.crude.ModelLeer;
...
extends RenderSRP<EntityLeer> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/leer.png");
