...
import com.subspaceparasite.client.model.entity.primitive.ModelGim;
...
extends RenderMalleable<EntityGim> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/gim.png");
    public static final ResourceLocation FROZEN_TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/snowvariants/primitiveviscerafrozen.png");
