...
import com.subspaceparasite.client.model.entity.feral.ModelFerCow;
...
extends RenderSP<EntityFerCow> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/fercow.png");
