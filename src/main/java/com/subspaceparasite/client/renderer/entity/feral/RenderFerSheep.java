...
import com.subspaceparasite.client.model.entity.feral.ModelFerSheep;
...
extends RenderSP<EntityFerSheep> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/fersheep.png");
