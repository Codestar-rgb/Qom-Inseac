...
import com.subspaceparasite.client.model.entity.adapted.ModelIkiAdapted;
...
extends RenderMalleable<EntityIkiAdapted> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/ikia.png");
