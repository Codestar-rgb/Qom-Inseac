...
import com.subspaceparasite.client.model.entity.deterrent.nexus.ModelVenkrolSV;
...
extends RenderMalleable<EntityVenkrolSV> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/venkrolsv.png");
