...
import com.subspaceparasite.client.model.entity.adapted.ModelEmanaAdapted;
...
extends RenderMalleable<EntityEmanaAdapted> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/emanaa.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/emanaah.png");
