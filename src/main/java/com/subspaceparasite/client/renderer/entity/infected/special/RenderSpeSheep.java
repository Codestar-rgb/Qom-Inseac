...
import com.subspaceparasite.client.model.entity.infected.special.ModelSpeSheep;
...
extends RenderSP<EntitySpeSheep> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/spesheep.png");
