...
import com.subspaceparasite.client.model.entity.pure.ModelOrch;
...
public class RenderOrch
extends RenderMalleable<EntityOrch> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/orch.png");
    public static final ResourceLocation TEXTURESP = new ResourceLocation("subspaceparasite:textures/entity/monster/orchsp1.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/orchh.png");
