...
import com.subspaceparasite.client.model.entity.primitive.ModelZaa;
...
public class RenderZaa
extends RenderMalleable<EntityZaa> {
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/zaa.png");
    public static final ResourceLocation FROZEN_TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/snowvariants/primitiveburrowerfrozen.png");
