...
import com.subspaceparasite.client.model.entity.pure.preeminent.ModelPheon;
...
extends RenderMalleable<EntityPheon> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/pheon.png");
    public static final ResourceLocation TEXTURESP = new ResourceLocation("subspaceparasite:textures/entity/monster/pheonsp1.png");
