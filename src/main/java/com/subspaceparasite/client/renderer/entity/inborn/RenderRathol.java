...
import com.subspaceparasite.client.model.entity.inborn.ModelRathol;
...
extends RenderLiving<EntityRathol> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/rathol.png");
    public static final ResourceLocation TEXTURES1 = new ResourceLocation("subspaceparasite:textures/entity/monster/ratholone.png");
    public static final ResourceLocation STEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/srathol.png");
