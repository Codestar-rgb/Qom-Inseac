...
import com.subspaceparasite.client.model.entity.misc.ModelNade;
...
extends Render<EntityNade> {
    protected ModelSP mainModel2 = new ModelNade();
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/nade.png");
