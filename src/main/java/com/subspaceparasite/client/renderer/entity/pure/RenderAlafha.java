...
import com.subspaceparasite.client.model.entity.pure.ModelAlafha;
...
extends RenderMalleable<EntityAlafha> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/alafha.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/alafhah.png");
