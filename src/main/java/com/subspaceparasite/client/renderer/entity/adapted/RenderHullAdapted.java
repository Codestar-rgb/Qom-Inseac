...
import com.subspaceparasite.client.model.entity.adapted.ModelHullAdapted;
...
extends RenderMalleable<EntityHullAdapted> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/hulla_old.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/hullah_old.png");
