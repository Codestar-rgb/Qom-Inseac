...
import com.subspaceparasite.client.model.entity.feral.ModelFerVillager;
...
extends RenderSP<EntityFerVillager> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/fervillager.png");
