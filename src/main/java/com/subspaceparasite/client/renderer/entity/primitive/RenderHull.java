...
import com.subspaceparasite.client.model.entity.primitive.ModelHull;
...
extends RenderMalleable<EntityHull> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/hull.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/hullh.png");
    private float secShadow = 0.8f;
    public static final ResourceLocation STEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/shull.png");
    public static final ResourceLocation FROZEN_TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/snowvariants/primitivemanducatorfrozen.png");
