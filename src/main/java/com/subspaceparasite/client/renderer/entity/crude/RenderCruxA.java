...
import com.subspaceparasite.client.model.entity.crude.ModelCruxA;
...
extends RenderSP<EntityCruxA> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/cruxa.png");
