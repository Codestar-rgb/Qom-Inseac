...
import com.subspaceparasite.client.model.entity.adapted.ModelZaaAdapted;
...
extends RenderMalleable<EntityZaaAdapted> {
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/zaaa.png");
