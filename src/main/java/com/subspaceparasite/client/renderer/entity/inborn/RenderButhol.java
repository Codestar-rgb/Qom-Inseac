...
import com.subspaceparasite.client.model.entity.inborn.ModelButhol;
...
extends RenderLiving<EntityButhol> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/buthol.png");
    public static final ResourceLocation TEXTURES1 = new ResourceLocation("subspaceparasite:textures/entity/monster/butholone.png");
    public static final ResourceLocation STEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/sbuthol.png");
