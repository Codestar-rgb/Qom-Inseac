...
import com.subspaceparasite.client.model.entity.primitive.ModelRanrac;
...
public class RenderRanrac
extends RenderMalleable<EntityRanrac> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/ranrac.png");
    public static final ResourceLocation TEXTUREV = new ResourceLocation("subspaceparasite:textures/entity/monster/ranracv.png");
    public static final ResourceLocation TEXTUREB = new ResourceLocation("subspaceparasite:textures/entity/monster/ranracb.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/ranrach.png");
    private static final ResourceLocation GUARDIAN_BEAM_TEXTURE = new ResourceLocation("textures/entity/guardian_beam.png");
    public static final ResourceLocation STEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/sranrac.png");
    public static final ResourceLocation FROZEN_TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/snowvariants/primitivearacfrozen.png");

    public RenderRanrac(RenderManager manager) {
        super(manager, new ModelRanrac(), 0.9f);
    }

    protected void preRenderCallback(EntityRanrac entitylivingbaseIn, float partialTickTime) {
    ...
    protected ResourceLocation getEntityTexture(EntityRanrac entity) {
    ...
    protected void applyRotations(EntityRanrac entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
        super.func_77043_a((EntityLivingBase)entityLiving, ageInTicks, rotationYaw, partialTicks);
    }

    @Override
    public boolean shouldRender(EntityRanrac livingEntity, ICamera camera, double camX, double camY, double camZ) {
        return super.shouldRender(livingEntity, camera, camX, camY, camZ);
    }

    public void doRender(EntityRanrac entity, double x, double y, double z, float entityYaw, float partialTicks) {
