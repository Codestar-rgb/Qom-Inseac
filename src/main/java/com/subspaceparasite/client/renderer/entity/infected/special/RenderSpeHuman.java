...
import com.subspaceparasite.client.model.entity.infected.special.ModelSpeHuman;
...
public class RenderSpeHuman
extends RenderSRP<EntitySpeHuman> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/spehuman.png");
