...
import com.subspaceparasite.client.model.entity.adapted.ModelGimAdapted;
...
extends RenderMalleable<EntityGimAdapted> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/gima.png");
