...
import com.subspaceparasite.client.model.entity.adapted.ModelCanraAdapted;
...
public class RenderCanraAdapted
extends RenderMalleable<EntityCanraAdapted> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/canraa.png");
    public static final ResourceLocation TEXTUREV = new ResourceLocation("subspaceparasite:textures/entity/monster/canraav.png");
    public static final ResourceLocation TEXTUREB = new ResourceLocation("subspaceparasite:textures/entity/monster/canraab.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/canraah.png");
