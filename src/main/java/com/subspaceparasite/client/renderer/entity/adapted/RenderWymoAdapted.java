...
import com.subspaceparasite.client.model.entity.adapted.ModelWymoAdapted;
...
extends RenderMalleable<EntityWymoAdapted> {
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/wymoa.png");
