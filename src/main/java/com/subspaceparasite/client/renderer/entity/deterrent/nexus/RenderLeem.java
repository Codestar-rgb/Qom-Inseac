...
import com.subspaceparasite.client.model.entity.deterrent.nexus.ModelLeem;
...
extends RenderMalleable<EntityLeem> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/leem.png");
