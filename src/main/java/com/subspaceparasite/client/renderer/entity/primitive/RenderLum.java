...
import com.subspaceparasite.client.model.entity.primitive.ModelLum;
...
extends RenderMalleable<EntityLum> {
    public static final ResourceLocation TEXTURES = new ResourceLocation("subspaceparasite:textures/entity/monster/lum.png");
    public static final ResourceLocation TEXTUREH = new ResourceLocation("subspaceparasite:textures/entity/monster/lumh.png");
    public static final ResourceLocation STEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/slum.png");
    public static final ResourceLocation FROZEN_TEXTURE = new ResourceLocation("subspaceparasite:textures/entity/monster/snowvariants/primitivedevourerfrozen.png");
