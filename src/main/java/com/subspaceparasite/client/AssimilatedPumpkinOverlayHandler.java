...
public class AssimilatedPumpkinOverlayHandler {
    private static final ResourceLocation OVERLAY_TEX = new ResourceLocation("subspaceparasite", "textures/gui/assimilated_pumpkin_overlay.png");
    ...
    public void onRenderHelmet(RenderGameOverlayEvent.Pre event) {
        ...
        Item a = Item.func_150898_a((Block)SPBlocks.AssimilatedPumpkin);
        Item b = Item.func_150898_a((Block)SPBlocks.AssimilatedJackOLantern);
        if (item != a && item != b) {
            return;
        }
