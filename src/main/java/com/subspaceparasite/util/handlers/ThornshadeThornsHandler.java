...
public class ThornshadeThornsHandler {
    ...
    public static void onPotionApplicable(PotionEvent.PotionApplicableEvent event) {
        ...
        if (incoming == null || incoming.func_188419_a() != SPPotions.THORNSHADE_THORNS_E) {
            return;
        }
        ...
        if (living.func_70644_a(SPPotions.THORNSHADE_THORNS_E)) {
            event.setResult(Event.Result.DENY);
            return;
        }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        PotionEffect eff = target.func_70660_b(SPPotions.THORNSHADE_THORNS_E);
        if (eff == null) {
            return;
        }
    ...
    private static void scheduleExplosion(EntityLivingBase living, NBTTagCompound data) {
        ...
        World world = living.field_70170_p;
        world.func_184148_a(null, living.field_70165_t, living.field_70163_u, living.field_70161_v, SPSounds.ADAPTATION_P, SoundCategory.PLAYERS, 1.5f, 0.8f + world.field_73012_v.nextFloat() * 0.4f);
    }
    ...
    private static void doExplosion(EntityLivingBase center) {
        ...
        if (center instanceof EntityPlayerMP && (adv = (player = (EntityPlayerMP)center).func_71121_q().func_73046_m().func_191949_aK().func_192778_a(new ResourceLocation("subspaceparasite", "thornshade_self_destruct"))) != null) {
        ...
        world.func_184148_a(null, x, y, z, SPSounds.BUTHOL_BOOM, SoundCategory.PLAYERS, 2.0f, 1.0f);
        ...
        for (EntityLivingBase other : world.func_72872_a(EntityLivingBase.class, innerBox)) {
            NBTTagCompound data;
            if (other == center || !other.func_70089_S() || other instanceof EntityParasiteBase || (distSq = other.func_70092_e(x, y, z)) > (double)(innerRadius * innerRadius) || !other.func_70644_a(SPPotions.THORNSHADE_THORNS_E) || other.func_110138_aP() > 120.0f || (data = ThornshadeThornsHandler.getThornshadeData(other)).func_74767_n(TAG_HAS_EXPLODED) || data.func_74764_b(TAG_EXPLODE_DELAY)) continue;
        ...
        for (EntityLivingBase other : world.func_72872_a(EntityLivingBase.class, outerBox)) {
            if (other == center || !other.func_70089_S() || other instanceof EntityParasiteBase || (distSq = other.func_70092_e(x, y, z)) <= (double)(innerRadius * innerRadius) || other.func_110138_aP() > 120.0f || other.func_70644_a(SPPotions.THORNSHADE_THORNS_E)) continue;
            other.func_70690_d(new PotionEffect(SPPotions.THORNSHADE_THORNS_E, 600, 0, false, true));
