...
public class PotionContamination
extends SPEffectBase {
    ...
    public void func_76394_a(EntityLivingBase entity, int amplifier) {
        ...
        if (entity.field_70173_aa % 40 == 0) {
            ...
            int dur = entity.func_70660_b(SPPotions.CONTA_E).func_76459_b();
            AxisAlignedBB axisalignedbb = new AxisAlignedBB(entity.field_70165_t, entity.field_70163_u, entity.field_70161_v, entity.field_70165_t + 1.0, entity.field_70163_u + 1.0, entity.field_70161_v + 1.0).func_72314_b(4.0, 3.0, 4.0);
            List moblist = entity.field_70170_p.func_72872_a(EntityLivingBase.class, axisalignedbb);
            for (EntityLivingBase mob : moblist) {
                SPPotions.applyStackPotion(SPPotions.CONTA_E, mob, dur, amplifier);
            }
        }
    }
}
