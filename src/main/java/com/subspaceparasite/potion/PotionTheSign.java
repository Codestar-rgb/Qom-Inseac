...
extends SPEffectBase {
    private static final ResourceLocation ICON = new ResourceLocation("subspaceparasite", "textures/gui/the_sign.png");

    public PotionTheSign() {
        super("the_sign", false, 8970751, 0, 0);
        this.func_76390_b("mob_effect.subspaceparasite.the_sign");
    }
