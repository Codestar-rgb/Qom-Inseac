 ...
 */
package com.subspaceparasite.events;
...
public final class SignEffectHandler {
    ...
    private static final String CHARM_ID = "subspaceparasite:the_sign_charm";
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent e) {
        ...
        if (hasCharm) {
            p.func_70690_d(new PotionEffect(SPPotions.THE_SIGN_E, 40, 0, false, false));
        }
    }
