...
public class EvoPhase {
    ...
    public EvoPhase(int phaseNumber, int pointThreshold, int originCount, int phaseOriginBonusHealth, int phaseOriginPenalty, int phaseScentBonus, int pointGainDelay, String[] phaseSpawnEntries, String phaseWarningMessage) {
    ...
    public static class Builder {
        ...
        public Builder setPhaseNumber(int phaseNumber) {
            this.phaseNumber = phaseNumber;
            return this;
        }

        public Builder setPointThreshold(int pointThreshold) {
            this.pointThreshold = pointThreshold;
            return this;
        }

        public Builder setOriginCount(int originCount) {
            this.originCount = originCount;
            return this;
        }

        public Builder setPhaseOriginPenalty(int phaseOriginPenalty) {
            this.phaseOriginPenalty = phaseOriginPenalty;
            return this;
        }

        public Builder setPhaseScentBonus(int phaseScentBonus) {
            this.phaseScentBonus = phaseScentBonus;
            return this;
        }

        public Builder setPointGainDelay(int pointGainDelay) {
            this.pointGainDelay = pointGainDelay;
            return this;
        }

        public Builder setPhaseSpawnEntries(String[] phaseSpawnEntries) {
            this.phaseSpawnEntries = phaseSpawnEntries;
            return this;
        }

        public Builder setPhaseWarningMessage(String phaseWarningMessage) {
            this.phaseWarningMessage = phaseWarningMessage;
            return this;
        }

        public Builder setPhaseOriginBonusHealth(int phaseOriginBonusHealth) {
            this.phaseOriginBonusHealth = phaseOriginBonusHealth;
            return this;
        }

        public EvoPhase build() {
            return new EvoPhase(this.phaseNumber, this.pointThreshold, this.originCount, this.phaseOriginBonusHealth, this.phaseOriginPenalty, this.phaseScentBonus, this.pointGainDelay, this.phaseSpawnEntries, this.phaseWarningMessage);
        }
    }
}
