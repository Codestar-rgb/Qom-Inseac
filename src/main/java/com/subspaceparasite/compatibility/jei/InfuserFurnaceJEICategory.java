...
implements IRecipeCategory<InfuserFurnaceJEIRecipe> {
    public static final String UID = "subspaceparasite.infuser_furnace";
    private static final ResourceLocation BG = new ResourceLocation("subspaceparasite", "textures/gui/infuser_furnace.png");
