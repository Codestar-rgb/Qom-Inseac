...
public class ModCompatibility {
    ...
    public static void postInit() {
        if (modCompatModules.get("REID").booleanValue() && SPConfigWorld.biomeRegster && SPConfigWorld.nodesActivated) {
            SPMain.logger.error("[MOD COMPATIBILITY] Subspace Parasite is NOT compatible with Roughly Enough IDs or Just Enough IDs. Nodes and biome spread will not function properly as a consequence.");
        }
