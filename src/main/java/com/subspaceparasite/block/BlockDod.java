...
implements ITileEntityProvider {
    ...
    private void pushAndHit(World worldIn, BlockPos hitPos, EntityPlayer player) {
        ...
        worldIn.func_184133_a(null, hitPos, SPSounds.ADAPTATION_P, SoundCategory.BLOCKS, 1.0f, 1.0f);
        player.func_70690_d(new PotionEffect(SPPotions.DOD_SMOKE_TRAIL_E, 20, 0, false, false));
    }
