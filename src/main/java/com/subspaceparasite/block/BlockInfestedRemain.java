...
import com.subspaceparasite.util.SPResidueFireManager;
...
extends BlockBush {
    ...
    public static final PropertyBool INFESTED_BASE = PropertyBool.func_177716_a((String)"infested_base");
    ...
    public BlockInfestedRemain(String name) {
        ...
        this.func_180632_j(this.field_176227_L.func_177621_b().func_177226_a((IProperty)SOURCE, (Comparable)Integer.valueOf(0)).func_177226_a((IProperty)INFESTED_BASE, (Comparable)Boolean.FALSE));
    ...
    protected boolean func_185514_i(IBlockState state) {
        return state.func_177230_c() == SPBlocks.optionalDirt || state.func_177230_c() == SPBlocks.optionalRub;
    }
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        boolean bl = offIsShovel = !off.func_190926_b() && off.func_77973_b().getToolClasses(off).contains("shovel");
    ...
    private void scheduleInclineNeighbors(World world, BlockPos pos) {
        ...
        for (EnumFacing f : new EnumFacing[]{EnumFacing.NORTH, EnumFacing.SOUTH, EnumFacing.EAST, EnumFacing.WEST}) {
            ...
            if (world.func_180495_p(pSame).func_177230_c() == this) {
                world.func_175684_a(pSame, (Block)this, 1);
            }
            if (world.func_180495_p(pSame).func_185917_h() && world.func_180495_p(pUp).func_177230_c() == this) {
                world.func_175684_a(pUp, (Block)this, 1);
            }
            if (world.func_180495_p(pDown).func_177230_c() != this) continue;
            world.func_175684_a(pDown, (Block)this, 1);
        }
    }

    public void func_180650_b(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (!worldIn.field_72995_K) {
            if (SPConfigWorld.residueFlammableWave && (worldIn.func_180495_p(pos.func_177978_c()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177968_d()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177974_f()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177976_e()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177984_a()).func_177230_c() == Blocks.field_150480_ab || worldIn.func_180495_p(pos.func_177977_b()).func_177230_c() == Blocks.field_150480_ab)) {
                worldIn.func_180501_a(pos, Blocks.field_150480_ab.func_176223_P(), 3);
                SPResidueFireManager.lightAndTrack(worldIn, pos, 6);
                ...
                if (worldIn instanceof WorldServer) {
                    ((WorldServer)worldIn).func_175739_a(EnumParticleTypes.SMOKE_NORMAL, (double)pos.func_177958_n() + 0.5, (double)pos.func_177956_o() + 0.6, (double)pos.func_177952_p() + 0.5, 1, 0.0, 0.02, 0.0, 0.0, new int[0]);
                }
                return;
            }
            ...
            for (int x = 0; x < serverList.size(); ++x) {
                if (!(serverList.get(x) instanceof EntityPBeckon) || ++count <= SPConfig.nexusVenkrolCap && !(this.getDistanceSq(pos, (Entity)serverList.get(x)) < (double)(SPConfig.nexusVenkrolDis * SPConfig.nexusVenkrolDis))) continue;
                return;
            }
            if (SPConfigSystems.rsResidueY <= pos.func_177956_o()) {
                if (SPConfigSystems.useEvolution) {
                    int chance = this.getEvoResidue(SPSaveData.get(worldIn, 5).getEvolutionPhase(worldIn.field_73011_w.getDimension()));
                    if (chance <= 0) {
                        return;
                    }
                    if (rand.nextInt(chance) == 0) {
                        if (SPConfigSystems.rsSkyResidue && !worldIn.func_175678_i(new BlockPos((double)pos.func_177958_n() + 0.5, (double)pos.func_177956_o() + 0.5, (double)pos.func_177952_p() + 0.5))) {
                            return;
                        }
                    ...
                    if (SPConfigSystems.rsVenkrolChance <= 0) {
                        return;
                    }
                    if (rand.nextInt(SPConfigSystems.rsVenkrolChance) == 0) {
                        if (SPConfigSystems.rsSkyResidue && !worldIn.func_175678_i(new BlockPos((double)pos.func_177958_n() + 0.5, (double)pos.func_177956_o() + 0.5, (double)pos.func_177952_p() + 0.5))) {
                            return;
                        }
                        this.spawnVenkorl(pos, worldIn);
    ...
    public boolean isFlammable(IBlockAccess world, BlockPos pos, EnumFacing face) {
        return SPConfigWorld.residueFlammableWave;
    }

    public int getFlammability(IBlockAccess world, BlockPos pos, EnumFacing face) {
        return SPConfigWorld.residueFlammableWave ? 200 : 0;
    }

    public int getFireSpreadSpeed(IBlockAccess world, BlockPos pos, EnumFacing face) {
        return SPConfigWorld.residueFlammableWave ? 300 : 0;
    }
    ...
    private void spawnVenkorl(BlockPos pos, World worldIn) {
        ...
        if (SPConfigSystems.rsSounds) {
            if (SPConfigSystems.disloGrowlNoise) {
                if (SPSaveData.get(entityOut.field_70170_p, 7).getCurrentCode(entityOut.field_70170_p.field_73011_w.getDimension(), 15) == 0) {
                    entityOut.func_184185_a(SPSounds.VENKROLSI, 4.0f, 1.0f);
                }
            } else {
                entityOut.func_184185_a(SPSounds.VENKROLSI, 4.0f, 1.0f);
            }
    ...
    private boolean anyNeighborIsFire(World world, BlockPos pos) {
        return world.func_180495_p(pos.func_177978_c()).func_177230_c() == Blocks.field_150480_ab || world.func_180495_p(pos.func_177968_d()).func_177230_c() == Blocks.field_150480_ab || world.func_180495_p(pos.func_177974_f()).func_177230_c() == Blocks.field_150480_ab || world.func_180495_p(pos.func_177976_e()).func_177230_c() == Blocks.field_150480_ab || world.func_180495_p(pos.func_177984_a()).func_177230_c() == Blocks.field_150480_ab || world.func_180495_p(pos.func_177977_b()).func_177230_c() == Blocks.field_150480_ab;
    }
    ...
    private void igniteShort(World world, BlockPos pos) {
        int TTL = 5;
        SPResidueFireManager.lightAndTrack(world, pos.func_177984_a(), 5);
    }
    ...
    public void func_189540_a(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos neighborPos) {
        ...
        if (!SPConfigWorld.residueFlammableWave) {
            return;
        }
    ...
    private int getEvoResidue(byte in) {
        ...
        switch (in) {
            case 1: {
                q = SPConfigSystems.phaseResidueOne;
                break;
            }
            case 2: {
                q = SPConfigSystems.phaseResidueTwo;
                break;
            }
            case 3: {
                q = SPConfigSystems.phaseResidueThree;
                break;
            }
            case 4: {
                q = SPConfigSystems.phaseResidueFour;
                break;
            }
            case 5: {
                q = SPConfigSystems.phaseResidueFive;
                break;
            }
            case 6: {
                q = SPConfigSystems.phaseResidueSix;
                break;
            }
            case 7: {
                q = SPConfigSystems.phaseResidueSeven;
                break;
            }
            case 8: {
                q = SPConfigSystems.phaseResidueEight;
            }
        }
        return q;
    }
    ...
    public IBlockState func_176221_a(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        if (rl != null) {
            ...
            boolean idMatch = "subspaceparasite".equals(domain) && path.startsWith("infested");
        ...
        return state.func_177226_a((IProperty)INFESTED_BASE, (Comparable)Boolean.valueOf(underIsInfestedNormal));
    }
    ...
    protected BlockStateContainer func_180661_e() {
        return new BlockStateContainer((Block)this, new IProperty[]{SOURCE, INFESTED_BASE});
    }
