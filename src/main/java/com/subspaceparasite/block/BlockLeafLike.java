...
import com.subspaceparasite.client.fx.ClientSPParticles;
import com.subspaceparasite.client.fx.ParticleInfestedLeaf;
...
implements IShearable {
    ...
    public BlockLeafLike(String regName) {
        ...
        this.func_149663_c("subspaceparasite." + regName);
    ...
    public void func_180650_b(World world, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (this.touchingAnySP(world, pos)) {
    ...
    public void func_180655_c(IBlockState state, World world, BlockPos pos, Random rand) {
        ...
        ClientSPParticles.fx().func_78873_a((Particle)p);
        ClientSPParticles.onSpawn();
    }

    private boolean touchingAnySP(World world, BlockPos pos) {
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        if (rand.nextInt(chance) == 0) {
            drops.add((Object)new ItemStack(SPItems.falseapple));
        }
    }
