...
extends Block {
    ...
    private static boolean isSP(Block b) {
        ResourceLocation id = b.getRegistryName();
        return id != null && "subspaceparasite".equals(id.func_110624_b());
    }
    ...
    private static boolean canAttachTo(World world, BlockPos pos, EnumFacing attachSide) {
        ...
        return BlockGothshroom.isSP(support.func_177230_c()) && support.isSideSolid((IBlockAccess)world, supportPos, attachSide);
    }
