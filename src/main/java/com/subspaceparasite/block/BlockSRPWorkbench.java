...
public class BlockSPWorkbench
extends BlockWorkbench {
    public BlockSPWorkbench(String name, float hardness, boolean creative, float resistance) {
    ...
    public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        player.openGui((Object)SPMain.instance, 102, world, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
        return true;
    }
}
