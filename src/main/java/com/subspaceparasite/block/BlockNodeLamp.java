...
import com.subspaceparasite.util.LangHelper;
...
extends BlockBase {
    ...
    public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        player.func_145747_a((ITextComponent)new TextComponentTranslation("message.subspaceparasite.node_lamp.strength", new Object[]{strengthLabel}));
        player.func_145747_a((ITextComponent)new TextComponentTranslation("message.subspaceparasite.node_lamp.distance", new Object[]{distanceLabel}));
        return true;
    }
}
