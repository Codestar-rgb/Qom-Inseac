...
extends BlockBase {
    ...
    public void func_180663_b(World worldIn, BlockPos pos, IBlockState state) {
        Entity ent;
        if (!worldIn.field_72995_K && worldIn.func_175697_a(pos, 1) && worldIn.func_175659_aa() != EnumDifficulty.PEACEFUL && (ent = EntityList.func_188429_b((ResourceLocation)new ResourceLocation("subspaceparasite", "buglin"), (World)worldIn)) != null) {
