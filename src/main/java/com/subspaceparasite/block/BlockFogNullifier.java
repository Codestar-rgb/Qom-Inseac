...
implements ITileEntityProvider {
    ...
    public void func_180633_a(World w, BlockPos p, IBlockState s, EntityLivingBase placer, ItemStack stack) {
        if (!w.field_72995_K) {
            ...
            if (te instanceof TileEntityFogNullifier) {
                ...
                int uses = from >= 0 ? from : Math.max(0, SPConfigWorld.fogNullifierMaxUses);
    ...
    private boolean isParasiteFog(World w, BlockPos p) {
        ...
        try {
            if (SPBlocks.ParasiteFog != null && b == SPBlocks.ParasiteFog) {
                return true;
            }
        }
        ...
        return "subspaceparasite:parasitefog".equals(id) || "subspaceparasite:parasitefog".equals(id);
    }
