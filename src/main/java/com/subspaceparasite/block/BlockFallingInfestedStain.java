...
import com.subspaceparasite.block.BlockFallingBase;
...
extends BlockFallingBase {
    ...
    public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer player, boolean willHarvest) {
        ...
        if (SPConfigSystems.useEvolution && this.func_176201_c(state) > 0) {
            ...
            data.setTotalKills(world.field_73011_w.getDimension(), -SPConfigSystems.valueLossBlockStain, true, world, false, 33);
        }
        return flag;
    }
