...
extends Block {
        ...
        if (!world.field_72995_K) {
            if (this.isStructureComplete(world, pos)) {
                ...
                for (EntityLiving mob : hostileMobs) {
                    ...
                    if (rl == null || !"subspaceparasite".equals(rl.func_110624_b())) continue;
    ...
    private void tryFormRelay(World world, BlockPos pos, @Nullable EntityLivingBase placer) {
        ...
        for (BlockPos mid : candidateMiddles = new BlockPos[]{pos, pos.func_177984_a(), pos.func_177977_b()}) {
            ...
            if (sBottom.func_177230_c() != SPBlocks.RelayBase || sMiddle.func_177230_c() != SPBlocks.RelayMiddle || sTop.func_177230_c() != SPBlocks.RelayRoof) continue;
            EnumFacing facing = EnumFacing.NORTH;
            IBlockState controllerState = SPBlocks.RELAY_CONTROLLER.func_176223_P().func_177226_a((IProperty)BlockRelayController.FACING, (Comparable)facing);
            world.func_175655_b(mid, false);
            world.func_175655_b(top, false);
            world.func_180501_a(bottom, controllerState, 2);
            ((BlockRelayController)SPBlocks.RELAY_CONTROLLER).func_180633_a(world, bottom, controllerState, placer, ItemStack.field_190927_a);
            return;
        }
    }
    ...
    private boolean isStructureComplete(World world, BlockPos pos) {
        ...
        Block base = SPBlocks.RelayBase;
        Block middle = SPBlocks.RelayMiddle;
        Block roof = SPBlocks.RelayRoof;
