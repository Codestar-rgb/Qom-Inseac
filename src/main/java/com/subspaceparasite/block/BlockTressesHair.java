...
extends BlockDoublePlant {
    ...
    protected boolean func_185514_i(IBlockState stateBelow) {
        return this.isSPBlock(stateBelow);
    }

    private boolean isSPBlock(IBlockState s) {
        if (s == null) {
            return false;
        }
        Block b = s.func_177230_c();
        return b.getRegistryName() != null && "subspaceparasite".equals(b.getRegistryName().func_110624_b());
    }
