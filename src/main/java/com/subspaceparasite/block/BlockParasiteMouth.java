...
public class BlockParasiteMouth
extends BlockBase {
    ...
    private boolean isOnTop(BlockPos pos, Entity e) {
        return e.func_174813_aQ().field_72338_b >= (double)pos.func_177956_o() + 0.999 && e.field_70165_t >= (double)pos.func_177958_n() && e.field_70165_t < (double)(pos.func_177958_n() + 1) && e.field_70161_v >= (double)pos.func_177952_p() && e.field_70161_v < (double)(pos.func_177952_p() + 1);
    }
    ...
    private void tryAffect(World world, BlockPos pos, Entity entity) {
        ...
        if (now < (nextAllowed = mob.getEntityData().func_74763_f(NBT_KEY_NEXT_APPLY))) {
            return;
        }
        mob.getEntityData().func_74772_a(NBT_KEY_NEXT_APPLY, now + 10L);
        mob.func_70097_a(SRC_PARASITE_MOUTH, 1.0f);
        mob.func_70690_d(new PotionEffect(SPPotions.CORRO_E, 100, 0, false, false));
        SPPotions.applyStackPotion(SPPotions.VIRA_E, mob, 200, 1);
    }
}
