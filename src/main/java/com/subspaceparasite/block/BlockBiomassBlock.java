...
extends Block {
    ...
    private void tryAffect(World world, BlockPos pos, Entity entity) {
        ...
        mob.func_184589_d(SPPotions.CORRO_E);
        mob.func_70690_d(new PotionEffect(SPPotions.CORRO_E, 100, 0, false, true));
        mob.func_70690_d(new PotionEffect(SPPotions.COTH_E, 1000, 3, false, true));
