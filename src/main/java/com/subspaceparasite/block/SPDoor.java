...
extends BlockDoor {
    ...
    public SPDoor(Material material, String regName) {
        super(material);
        this.regName = regName;
        this.setRegistryName("subspaceparasite", regName);
        ...
        door.func_77655_b("subspaceparasite." + regName);
        door.func_77637_a((CreativeTabs)SPMain.SP_CREATIVETAB);
        SPItems.SP_ITEMS.add((Item)door);
        this.doorItem = door;
    }
