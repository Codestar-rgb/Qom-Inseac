...
public class BlockAssimilatedPumpkin
extends Block {
    ...
    public BlockAssimilatedPumpkin(String regName, boolean glowing) {
        ...
        SPItems.SP_ITEMS.add((Item)new ItemAssimilatedPumpkin(this).setRegistryName(this.getRegistryName()));
    }
    ...
    public static class ItemAssimilatedPumpkin
    extends ItemBlock {
        ...
        public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {
            if (!world.field_72995_K) {
                player.func_70690_d(new PotionEffect(SPPotions.COTH_E, 40, 3, false, false));
            }
        }
