...
implements ITickable {
    ...
    public void func_73660_a() {
        ...
        List list = this.field_145850_b.func_175647_a(Entity.class, search, this::isSP);
        if (list.isEmpty()) {
    ...
    private void clearCrossFactionAggroIfTargetInside(EntityLiving attacker, int[] bb) {
        ...
        boolean attackerIsSP = this.isSP((Entity)attacker);
        boolean targetIsSP = this.isSP((Entity)tgt);
        if (attackerIsSP || targetIsSP) {
