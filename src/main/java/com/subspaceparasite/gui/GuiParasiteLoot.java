...
extends GuiContainer {
    private static final ResourceLocation BG = new ResourceLocation("subspaceparasite", "textures/gui/parasite_loot.png");
    private static final ResourceLocation BUBBLE_TEX = new ResourceLocation("subspaceparasite", "textures/gui/blood_bubble.png");
