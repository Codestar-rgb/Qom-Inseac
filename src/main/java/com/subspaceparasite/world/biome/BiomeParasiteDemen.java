...
extends BiomeParasiteBase {
    ...
    public BiomeParasiteDemen() {
        super(new Biome.BiomeProperties("Parasite Biome Demen").func_185398_c(0.13f).func_185400_d(0.5f));
    ...
    public int func_76731_a(float currentTemperature) {
        return SPConfigWorld.biomeFourSkyColor;
    }

    @SideOnly(value=Side.CLIENT)
    public int func_180627_b(BlockPos blockPos) {
        return SPConfigWorld.biomeFourGrassColor;
    }

    @SideOnly(value=Side.CLIENT)
    public int func_180625_c(BlockPos blockPos) {
        return SPConfigWorld.biomeFourFoliageColor;
    }

    public int getWaterColorMultiplier() {
        return SPConfigWorld.biomeFourWaterColor;
    }

    @Override
    public float getRedValue() {
        return SPConfigWorld.biomeFourFogRed / 255.0f;
    }

    @Override
    public float getGreenValue() {
        return SPConfigWorld.biomeFourFogGreen / 255.0f;
    }

    @Override
    public float getBlueValue() {
        return SPConfigWorld.biomeFourFogBlue / 255.0f;
    }
