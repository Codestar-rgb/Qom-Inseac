...
extends BiomeParasiteBase {
    ...
    public BiomeParasiteHarlequin() {
        super(new Biome.BiomeProperties("Parasite Biome Harlequin").func_185398_c(0.13f).func_185400_d(0.5f).func_185410_a(0.0f).func_185395_b(0.5f).func_185411_b());
    ...
    public int func_76731_a(float currentTemperature) {
        return SPConfigWorld.biomeThreeSkyColor;
    }

    @SideOnly(value=Side.CLIENT)
    public int func_180627_b(BlockPos blockPos) {
        return SPConfigWorld.biomeThreeGrassColor;
    }

    @SideOnly(value=Side.CLIENT)
    public int func_180625_c(BlockPos blockPos) {
        return SPConfigWorld.biomeThreeFoliageColor;
    }

    public int getWaterColorMultiplier() {
        return SPConfigWorld.biomeThreeWaterColor;
    }

    @Override
    public float getRedValue() {
        return SPConfigWorld.biomeThreeFogRed / 255.0f;
    }

    @Override
    public float getGreenValue() {
        return SPConfigWorld.biomeThreeFogGreen / 255.0f;
    }

    @Override
    public float getBlueValue() {
        return SPConfigWorld.biomeThreeFogBlue / 255.0f;
    }

    @Override
    public String[] getBlockList() {
        return SPConfigWorld.biomeThreeBlockList;
    }

    @Override
    public String getDirt() {
        return "subspaceparasite:harlequinn_grass:0";
    }

    @Override
    public String getGravel() {
        return "subspaceparasite:infestedsand:0";
    }
    ...
    public String getStone() {
        return "subspaceparasite:harleskinn_block:0";
    }
    ...
    public String getLeaves() {
        return "subspaceparasite:alveoli:0";
    }

    @Override
    public String getLeavesG() {
        return "subspaceparasite:alveoli_growth:0";
    }
