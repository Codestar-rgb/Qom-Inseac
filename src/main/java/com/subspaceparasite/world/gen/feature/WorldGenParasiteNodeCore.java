...
extends WorldGenParasiteGenAbstract {
                    ...
                    for (yyy = 0; yyy <= 0; ++yyy) {
                        for (xs = -1; xs <= 1; ++xs) {
                            for (zs = -1; zs <= 1; ++zs) {
                                ...
                                this.placeTrunk(worldIn, helperTwo);
                                for (z = 0; z <= 3; ++z) {
                                    if (worldIn.func_180495_p(this.directionToGrow(helperTwo, z, false)).func_177230_c() == SPBlocks.ParasiteRubbleDense) continue;
    ...
    private void placeTen(World worldIn, BlockPos pos) {
        this.func_175903_a(worldIn, pos, SPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.FEELER)));
    }

    private void placeTrunk(World worldIn, BlockPos pos) {
        this.func_175903_a(worldIn, pos, SPBlocks.ParasiteRubbleDense.func_176223_P().func_177226_a(BlockParasiteRubbleDense.VARIANT, (Comparable)((Object)BlockParasiteRubbleDense.EnumType.BIOME)));
    }

    private void placeCore(World worldIn, BlockPos pos, int stage) {
        this.func_175903_a(worldIn, pos, SPBlocks.BiomeHeart.func_176223_P().func_177226_a((IProperty)BlockBiomeCore.ACTIVE, (Comparable)Integer.valueOf(stage)));
    }

    private void placeDirt(World worldIn, BlockPos pos) {
        this.func_175903_a(worldIn, pos, SPBlocks.ParasiteStain.func_176223_P());
    }

    private void placeLiquid(World worldIn, BlockPos pos) {
        this.func_175903_a(worldIn, pos, SPBlocks.DeadBlood.func_176223_P());
    }
