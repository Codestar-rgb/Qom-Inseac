...
extends WorldGenParasiteColonyBase {
    ...
    public boolean func_180709_b(World worldIn, Random rand, BlockPos posss) {
        ...
        this.generateDNAHelix(SPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.FLESH)), worldIn, worldIn.field_73012_v, he.func_177979_c(3), aa - 2, 2, 11 + bonusH);
