...
public class WorldGenParasiteColonyBS4
extends WorldGenParasiteColonyBase {
    ...
    public boolean func_180709_b(World worldIn, Random rand, BlockPos posss) {
        ...
        this.generateDNAHelix(Blocks.field_189880_di.func_176223_P(), worldIn, worldIn.field_73012_v, he.func_177979_c(3), aa - 2, 2, 11 + bonusH);
        return true;
    }
}
