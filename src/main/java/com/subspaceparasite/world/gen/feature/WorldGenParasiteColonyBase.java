...
extends WorldGenParasiteGenAbstract {
    protected int type;
    protected IBlockState floor = SPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.DIRT));
    protected IBlockState tacle = SPBlocks.ParasiteStain.func_176223_P().func_177226_a(BlockParasiteStain.VARIANT, (Comparable)((Object)BlockParasiteStain.EnumType.FEELER));
    protected IBlockState wall = SPBlocks.ParasiteRubbleDense.func_176223_P().func_177226_a(BlockParasiteRubbleDense.VARIANT, (Comparable)((Object)BlockParasiteRubbleDense.EnumType.WALL));
    protected IBlockState floorColony = SPBlocks.ParasiteRubble.func_176223_P().func_177226_a(BlockParasiteRubble.VARIANT, (Comparable)((Object)BlockParasiteRubble.EnumType.FLESH));
    ...
    protected void placeVine(World worldIn, BlockPos pos) {
        this.func_175903_a(worldIn, pos, SPBlocks.ParasiteBush.func_176223_P().func_177226_a(BlockParasiteBush.VARIANT, (Comparable)((Object)BlockParasiteBush.EnumType.BINE)));
    }
    ...
    protected void genFloorFloor(World worldIn, BlockPos position, int range, boolean fill) {
        if (fill) {
            ...
            while ((worldIn.func_180495_p(filler).func_177230_c() == Blocks.field_150350_a || worldIn.func_180495_p(filler).func_177230_c() == SPBlocks.ParasiteBush || worldIn.func_180495_p(filler).func_177230_c() instanceof BlockLeaves || worldIn.func_180495_p(filler).func_177230_c() instanceof BlockBush) && range > 0) {
            ...
            for (int x = -radiusX; x <= radiusX; ++x) {
                for (int z = -radiusZ; z <= radiusZ; ++z) {
                    ...
                    if ((x == radiusX || z == radiusZ || x == -radiusX || z == -radiusZ || x + 1 == radiusX || z + 1 == radiusZ || x - 1 == -radiusX || z - 1 == -radiusZ) && rand.nextInt(60) == 0) {
                        if (rand.nextInt(4) == 0) {
                            if (flagAir) continue;
                            world.func_175656_a(newBlockPos, SPBlocks.DeadBlood.func_176223_P());
                            if (veins <= 0) continue;
                        ...
                        if (rand.nextInt(10) == 0) {
                            this.placeLoot(world, newBlockPos, SPConfigWorld.blockLootRare, SPBlocks.ParasiteLoot.func_176223_P().func_177226_a(BlockParasiteLoot.VARIANT, (Comparable)((Object)BlockParasiteLoot.EnumType.RARE)));
                        } else if (rand.nextInt(4) == 0) {
                            this.placeLoot(world, newBlockPos, SPConfigWorld.blockLootUncommon, SPBlocks.ParasiteLoot.func_176223_P().func_177226_a(BlockParasiteLoot.VARIANT, (Comparable)((Object)BlockParasiteLoot.EnumType.UNCOMMON)));
                        } else {
                            this.placeLoot(world, newBlockPos, SPConfigWorld.blockLootCommon, SPBlocks.ParasiteLoot.func_176223_P().func_177226_a(BlockParasiteLoot.VARIANT, (Comparable)((Object)BlockParasiteLoot.EnumType.COMMON)));
                        }
                        if (veins <= 0) continue;
                        this.addVines(world, newBlockPos.func_177977_b(), rand, veins);
                        continue;
    ...
    public void generateFilledVerticalDisk(World world, BlockPos center, int radius, boolean useXZPlane) {
        ...
        for (int dx = -radius; dx <= radius; ++dx) {
            for (int dy = -radius; dy <= radius; ++dy) {
                BlockPos target;
                if (dx * dx + dy * dy > rSq || world.func_180495_p(target = useXZPlane ? center.func_177982_a(dx, dy, 0) : center.func_177982_a(0, dy, dx)).func_177230_c() == SPBlocks.DeadBlood || world.func_180495_p(target).func_177230_c() == SPBlocks.ParasiteBush) continue;
