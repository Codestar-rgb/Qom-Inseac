...
extends WorldGenAbstractTree {
    ...
    public boolean isReplaceable(World world, BlockPos pos) {
        ...
        return state.func_177230_c().isAir(state, (IBlockAccess)world, pos) || state.func_177230_c().isLeaves(state, (IBlockAccess)world, pos) || state.func_177230_c().isWood((IBlockAccess)world, pos) || this.func_150523_a(state.func_177230_c()) || state.func_177230_c() == SPBlocks.ParasiteBush;
    }
}
