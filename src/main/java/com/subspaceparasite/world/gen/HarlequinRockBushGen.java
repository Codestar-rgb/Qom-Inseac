 ...
 */
package com.subspaceparasite.world.gen;
...
implements IWorldGenerator {
    ...
    public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if (ws.func_180494_b(base) != SPBiomes.biomeHarlequin) {
            return;
        }
    ...
    private void tryPlaceTemplateSurface(WorldServer ws, BlockPos near, String name, Random rand) {
        ...
        Template tpl = this.getTemplate(ws, new ResourceLocation("subspaceparasite", name));
        if (tpl == null) {
            return;
        }
